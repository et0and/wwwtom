      ...
      <div className="pb-26 md:pb-36">
        <Layout>
            ...
            <LocalizedLink href="/products/astrid-curve">
              ...
              <div className="flex justify-between">
                <div>
                  ...
                  <p className="text-grayscale-500 text-xs">Scandinavian Simplicity</p>
                </div>
                <div>
          ...
          <LayoutColumn start={1} end={{ base: 13, md: 8 }}>
            ...
            <div className="md:text-md max-md:mb-16 max-w-135">
              <p>
                Perfect for those who seek comfort with a clean and understated aesthetic. This
                collection brings the essence of Scandinavian elegance to your living room.
              </p>
            </div>
          </LayoutColumn>
          <LayoutColumn start={{ base: 1, md: 9 }} end={13}>
            <LocalizedLink href="/products/nordic-haven" className="mb-8 md:mb-16 inline-block">
              <Image
        ...
        <Layout>
          <LayoutColumn start={1} end={{ base: 13, md: 8 }}>
            ...
            <div className="md:text-md max-md:mb-16 max-w-135">
              <p>
                Whether you&apos;re looking for bold statement pieces or subtle elegance, this
                collection elevates your home with a touch of glamour, sophistication, and unmatched
                coziness.
              </p>
            </div>
          </LayoutColumn>
