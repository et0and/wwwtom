...
import { useCartPaymentMethods, useGetPaymentMethod, useSetPaymentMethod } from "hooks/cart";
...
const Payment = ({ cart }: { cart: StoreCart }) => {
  ...
  const { data: availablePaymentMethods } = useCartPaymentMethods(cart?.region?.id ?? "");
