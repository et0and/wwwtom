    ...
    <div className="sm:max-w-65 w-full flex-1">
      ...
      {!!discount_total && (
        <div className="flex justify-between gap-4 mb-2">
          ...
          <div className="self-end">
            <p>- {convertToLocale({ amount: discount_total ?? 0, currency_code })}</p>
          </div>
        </div>
      )}
      <div className="flex justify-between gap-4 mb-2">
      ...
      {!!gift_card_total && (
        <div className="flex justify-between gap-4 mb-2">
          ...
          <div className="self-end">
            <p>- {convertToLocale({ amount: gift_card_total ?? 0, currency_code })}</p>
          </div>
        </div>
      )}
      ...
      <p className="text-xs text-grayscale-500">
        Including {convertToLocale({ amount: tax_total ?? 0, currency_code })} tax
      </p>
    </div>
  );
};
