...
export const UiCheckbox: React.FC<ReactAria.CheckboxProps> = ({ className, ...props }) => (
  <ReactAria.Checkbox
    {...props}
    className={twMerge("flex gap-2 group cursor-pointer items-center", className as string)}
  />
);
...
export const UiCheckboxIcon: React.FC<Omit<IconProps, "name"> & { name?: IconNames }> = ({
  name = "check",
  className,
  ...props
}) => (
...
export const UiCheckboxLabel: React.FC<React.ComponentPropsWithoutRef<"span">> = ({
  className,
  ...props
