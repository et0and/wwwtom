...
export class CheckoutPage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    this.shippingAddressSelect = this.container.getByTestId("shipping-address-select");
    this.shippingAddressOptions = this.container.getByTestId("shipping-address-options");
    this.shippingAddressOption = this.container.getByTestId("shipping-address-option");
    this.billingAddressCheckbox = this.container.getByTestId("billing-address-checkbox");
    ...
    this.billingFirstNameInput = this.container.getByTestId("billing-first-name-input");
    ...
    this.shippingFirstNameInput = this.container.getByTestId("shipping-first-name-input");
    this.shippingLastNameInput = this.container.getByTestId("shipping-last-name-input");
    this.shippingPhoneInput = this.container.getByTestId("shipping-phone-input");
    this.shippingPostalCodeInput = this.container.getByTestId("shipping-postal-code-input");
    this.shippingProvinceInput = this.container.getByTestId("shipping-province-input");

    this.billingCountrySelect = this.container.getByTestId("billing-country-select");
    this.shippingCountrySelect = this.container.getByTestId("shipping-country-select");

    this.shippingAddressSummary = this.container.getByTestId("shipping-address-summary");
    this.shippingContactSummary = this.container.getByTestId("shipping-contact-summary");
    this.billingAddressSummary = this.container.getByTestId("billing-address-summary");
    ...
    this.deliveryOptionsContainer = this.container.getByTestId("delivery-options-container");
    this.deliveryOptionRadio = this.container.getByTestId("delivery-option-radio");
    this.deliveryOptionErrorMessage = this.container.getByTestId("delivery-option-error-message");
    this.submitDeliveryOptionButton = this.container.getByTestId("submit-delivery-option-button");
    this.deliveryOptionSummary = this.container.getByTestId("delivery-option-summary");

    this.paymentMethodSummary = this.container.getByTestId("payment-method-summary");
    this.paymentDetailsSummary = this.container.getByTestId("payment-details-summary");
    this.paymentMethodErrorMessage = this.container.getByTestId("payment-method-error-message");
    this.submitPaymentButton = this.container.getByTestId("submit-payment-button");
    this.stripePaymentErrorMessage = this.container.getByTestId("stripe-payment-error-message");
    this.paypalPaymentErrorMessage = this.container.getByTestId("paypal-payment-error-message");
    this.manualPaymentErrorMessage = this.container.getByTestId("manual-payment-error-message");
    ...
    this.itemUnitOriginalPrice = this.container.getByTestId("item-unit-original-price");
