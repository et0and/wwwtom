...
export class ProfilePage extends AccountPage {
  ...
  constructor(page: Page) {
    ...
    this.accountPasswordEditor = this.container.getByTestId("account-password-editor");
    this.accountBillingAddressEditor = this.container.getByTestId("account-billing-address-editor");
    ...
    this.billingAddressEditButton = this.accountBillingAddressEditor.getByTestId("edit-button");
    ...
    this.billingAddressSaveButton = this.accountBillingAddressEditor.getByTestId("save-button");
    ...
    this.savedBillingAddress = this.accountBillingAddressEditor.getByTestId("current-info");
    ...
    this.passwordSuccessMessage = this.accountPasswordEditor.getByTestId("success-message");
    ...
    this.passwordErrorMessage = this.accountPasswordEditor.getByTestId("error-message");
    this.billingAddressErrorMessage = this.accountBillingAddressEditor.getByTestId("error-message");
