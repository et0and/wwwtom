...
export class OrderPage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    this.shippingMethodSummary = this.container.getByTestId("shipping-method-summary");
    ...
    this.productUnitOriginalPrice = this.container.getByTestId("product-unit-original-price");
