...
export class ProductPage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    this.mobileAddToCartButton = this.mobileActionsContainer.getByTestId("mobile-actions-button");
    this.mobileActionsButton = this.mobileActionsContainer.getByTestId("mobile-actions-select");
  }
