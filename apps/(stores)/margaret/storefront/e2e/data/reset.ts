...
function getEnv() {
  return {
    ...
    port: process.env.TEST_POSTGRES_HOST ? Number(process.env.TEST_POSTGRES_HOST) : 5432,
    user: process.env.TEST_POSTGRES_USER || "test_medusa_user",
    testDatabase: process.env.TEST_POSTGRES_DATABASE || "test_medusa_db",
    testDatabaseTemplate: process.env.TEST_POSTGRES_DATABASE_TEMPLATE || "test_medusa_db_template",
