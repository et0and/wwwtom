...
import { FormProvider, useForm, UseFormProps, DefaultValues, UseFormReturn } from "react-hook-form";
import { z } from "zod";
import { zodResolver } from "@hookform/resolvers/zod";

export type FormProps<T extends z.ZodType<any, any>> = UseFormProps<z.infer<T>> & {
  schema: T;
