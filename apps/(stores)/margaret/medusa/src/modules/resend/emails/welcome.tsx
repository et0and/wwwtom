...
const UnorderedListItem: React.FC<{
  ...
  return (
    <ul
      role="presentation"
      className={["list-disc mt-0 mb-0 p-0", className].filter(Boolean).join(" ")}
    >
...
export default function WelcomeEmail({ customer, ...emailLayoutProps }: Props & EmailLayoutProps) {
  return (
    <EmailLayout {...emailLayoutProps}>
      <Heading className="text-2xl mt-0 mb-10 font-medium">Welcome to Sofa Society!</Heading>
      <Text className="text-md !mb-8">
        Welcome to Sofa Society! We're excited to have you join our community of comfort
        enthusiasts. With our carefully crafted sofas, you&apos;re just steps away from adding
