...
export default function OrderUpdateEmail({
  ...
  return (
    <EmailLayout {...emailLayoutProps}>
      <Heading className="text-2xl mt-0 mb-10 font-medium">Shipping update</Heading>
      <Text className="text-md !mb-8">
        Great news! Your order #{order.display_id} is now on its way to you.
        <br />
        Here are the shipping details.
      </Text>
      <Text className="text-md !mb-10">You can track your package by clicking below:</Text>
      <Button
        href={`${
      ...
      <Text className="text-md m-0">
        Thank you for choosing Sofa Society. We&apos;re excited for your new sofa to find its home
        with you!
      </Text>
    </EmailLayout>
  );
