...
This collection brings the essence of Scandinavian elegance to your living room.`,
            ...
            product_page_cta_link: "See more out of ‘Scandinavian Simplicity’ collection",
          },
        },
        {
          title: "Modern Luxe",
          ...
          metadata: {
            ...
            collection_page_heading: "Modern Luxe: Where modern design meets luxurious living",
...
Perfect for creating a warm, inviting atmosphere that never goes out of style.`,
            ...
            product_page_cta_link: "See more out of ‘Timeless Classics’ collection",
          },
        },
      ],
    },
      ...
      products: [
        {
          ...
          category_ids: [categoryResult.find((cat) => cat.name === "Three seater").id],
      ...
      products: [
        {
          ...
          category_ids: [categoryResult.find((cat) => cat.name === "Two seater").id],
          collection_id: collections.find((c) => c.handle === "timeless-classics").id,
          type_id: productTypes.find((pt) => pt.value === "Sofas").id,
          status: ProductStatus.PUBLISHED,
      ...
      products: [
        {
          ...
          category_ids: [categoryResult.find((cat) => cat.name === "One seater").id],
          collection_id: collections.find((c) => c.handle === "timeless-classics").id,
      ...
      products: [
        {
          ...
          category_ids: [categoryResult.find((cat) => cat.name === "One seater").id],
          collection_id: collections.find((c) => c.handle === "scandinavian-simplicity").id,
          type_id: productTypes.find((pt) => pt.value === "Arm Chairs").id,
          status: ProductStatus.PUBLISHED,
