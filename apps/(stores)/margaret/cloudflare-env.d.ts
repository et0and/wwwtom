/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: a249723ec84a647a3b76993f39e0392c)
...
declare namespace Cloudflare {
  interface Env {
    ...
    D1: D1Database;
    ASSETS: Fetcher;
    NEXT_PUBLIC_SERVER_URL: "https://grandmahope.yufugumi.com";
    PAYLOAD_SECRET: string;
    STRIPE_SECRET_KEY: string;
    STRIPE_NZ_SHIPPING_RATE_ID: string;
    RESEND_API: string;
  }
}
