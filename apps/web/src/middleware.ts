...
import { readCloudflareEnv, type CloudflareEnv } from "@tom/utils/services";
...
export default createMiddleware({
  onRequest: async (event) => {
    const context = event.nativeEvent.context as {
      ...
      effectLayer?: ReturnType<typeof createServicesLayer>;
    };
    ...
    context.effectLayer = createServicesLayer(env);
  },
});
