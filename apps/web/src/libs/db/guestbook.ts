...
import { DatabaseConnectionError, GuestbookValidationError, OAuthSessionError } from "@tom/types";
import type { Database } from "@tom/types";
...
export const getGuestbookEntries = (params: { page?: number; page_size?: number }) =>
  Effect.gen(function* () {
    const db = yield* getKyselyConnection();
