    ...
    <PageLayout title="Guestbook" description="Sign my guestbook">
      ...
      <div class="mx-auto">
          ...
          fallback={
            <div class="mb-8">
              ...
              <p class="mb-3 text-sm">
                Enter your full Fediverse handle (e.g., user@mastodon.social or user@fosstodon.org).
              </p>
        ...
        <div class="space-y-4">
          ...
          <Show when={entries() && entries()!.length > 0} fallback={<Spinner />}>
            <For each={entries()}>
              {(entry) => (
                  ...
                  <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1">
                      <div class="flex items-baseline gap-2 mb-1">
                        ...
                        <span class="text-sm text-gray-500">{entry.fediverse_username}</span>
                      </div>
