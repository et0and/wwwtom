/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 5fe16ce064ed2230739265638fe58a56)
// Runtime types generated with workerd@1.20260317.1 2025-08-15 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		D1: D1Database;
		ASSETS: Fetcher;
		NEXT_PUBLIC_SERVER_URL: "https://cms.tom.so";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SERVER_URL" | "CDN_URL" | "TOM_SECRETS">> {}
}
