...
export function Nav() {
  ...
  return (
    <nav class="relative md:sticky md:top-0 tracking-tighter px-6 py-4 flex-shrink-0 view-transition-header bg-white dark:bg-[#0a0a0a] md:border-b md:border-tomui-line z-50">
