 ...
 * Source: @phosphor-icons/core record. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const RecordPaths: IconPathData = {
  thin: [
    {
...
/** Record icon in six Phosphor weights. Defaults to regular weight. */
export function RecordIcon(props: IconProps): JSX.Element {
  return <IconBase paths={RecordPaths} {...props} />;
}

export const Record = RecordIcon;
