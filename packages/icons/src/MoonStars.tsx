 ...
 * Source: @phosphor-icons/core moon-stars. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MoonStarsPaths: IconPathData = {
  thin: [
    {
...
/** MoonStars icon in six Phosphor weights. Defaults to regular weight. */
export function MoonStarsIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MoonStarsPaths} {...props} />;
}

export const MoonStars = MoonStarsIcon;
