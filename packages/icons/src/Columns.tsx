 ...
 * Source: @phosphor-icons/core columns. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ColumnsPaths: IconPathData = {
  thin: [
    {
...
/** Columns icon in six Phosphor weights. Defaults to regular weight. */
export function ColumnsIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ColumnsPaths} {...props} />;
}
