 ...
 * Source: @phosphor-icons/core faders-horizontal. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FadersHorizontalPaths: IconPathData = {
  thin: [
    {
...
/** FadersHorizontal icon in six Phosphor weights. Defaults to regular weight. */
export function FadersHorizontalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FadersHorizontalPaths} {...props} />;
}

export const FadersHorizontal = FadersHorizontalIcon;
