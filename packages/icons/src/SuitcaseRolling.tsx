 ...
 * Source: @phosphor-icons/core suitcase-rolling. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SuitcaseRollingPaths: IconPathData = {
  thin: [
    {
...
/** SuitcaseRolling icon in six Phosphor weights. Defaults to regular weight. */
export function SuitcaseRollingIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SuitcaseRollingPaths} {...props} />;
}

export const SuitcaseRolling = SuitcaseRollingIcon;
