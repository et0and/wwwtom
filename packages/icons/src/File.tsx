 ...
 * Source: @phosphor-icons/core file. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** File icon in six Phosphor weights. Defaults to regular weight. */
export function FileIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FilePaths} {...props} />;
}
