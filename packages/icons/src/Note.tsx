 ...
 * Source: @phosphor-icons/core note. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Note icon in six Phosphor weights. Defaults to regular weight. */
export function NoteIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NotePaths} {...props} />;
}
