 ...
 * Source: @phosphor-icons/core speaker-simple-none. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SpeakerSimpleNonePaths: IconPathData = {
  thin: [
    {
...
/** SpeakerSimpleNone icon in six Phosphor weights. Defaults to regular weight. */
export function SpeakerSimpleNoneIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SpeakerSimpleNonePaths} {...props} />;
}

export const SpeakerSimpleNone = SpeakerSimpleNoneIcon;
