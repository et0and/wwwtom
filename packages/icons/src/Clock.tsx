 ...
 * Source: @phosphor-icons/core clock. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Clock icon in six Phosphor weights. Defaults to regular weight. */
export function ClockIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ClockPaths} {...props} />;
}
