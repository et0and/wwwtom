 ...
 * Source: @phosphor-icons/core battery-vertical-empty. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BatteryVerticalEmptyPaths: IconPathData = {
  thin: [
    {
...
/** BatteryVerticalEmpty icon in six Phosphor weights. Defaults to regular weight. */
export function BatteryVerticalEmptyIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BatteryVerticalEmptyPaths} {...props} />;
}

export const BatteryVerticalEmpty = BatteryVerticalEmptyIcon;
