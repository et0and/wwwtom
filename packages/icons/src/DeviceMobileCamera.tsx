 ...
 * Source: @phosphor-icons/core device-mobile-camera. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DeviceMobileCameraPaths: IconPathData = {
  thin: [
    {
...
/** DeviceMobileCamera icon in six Phosphor weights. Defaults to regular weight. */
export function DeviceMobileCameraIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DeviceMobileCameraPaths} {...props} />;
}

export const DeviceMobileCamera = DeviceMobileCameraIcon;
