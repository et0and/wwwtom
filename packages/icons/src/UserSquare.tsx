 ...
 * Source: @phosphor-icons/core user-square. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const UserSquarePaths: IconPathData = {
  thin: [
    {
...
/** UserSquare icon in six Phosphor weights. Defaults to regular weight. */
export function UserSquareIcon(props: IconProps): JSX.Element {
  return <IconBase paths={UserSquarePaths} {...props} />;
}
