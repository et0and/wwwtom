 ...
 * Source: @phosphor-icons/core instagram-logo. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const InstagramLogoPaths: IconPathData = {
  thin: [
    {
...
/** InstagramLogo icon in six Phosphor weights. Defaults to regular weight. */
export function InstagramLogoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={InstagramLogoPaths} {...props} />;
}

export const InstagramLogo = InstagramLogoIcon;
