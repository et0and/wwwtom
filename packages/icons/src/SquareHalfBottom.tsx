 ...
 * Source: @phosphor-icons/core square-half-bottom. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SquareHalfBottomPaths: IconPathData = {
  thin: [
    {
...
/** SquareHalfBottom icon in six Phosphor weights. Defaults to regular weight. */
export function SquareHalfBottomIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SquareHalfBottomPaths} {...props} />;
}

export const SquareHalfBottom = SquareHalfBottomIcon;
