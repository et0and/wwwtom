 ...
 * Source: @phosphor-icons/core cloud. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Cloud icon in six Phosphor weights. Defaults to regular weight. */
export function CloudIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CloudPaths} {...props} />;
}
