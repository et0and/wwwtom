 ...
 * Source: @phosphor-icons/core currency-rub. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CurrencyRubPaths: IconPathData = {
  thin: [
    {
...
/** CurrencyRub icon in six Phosphor weights. Defaults to regular weight. */
export function CurrencyRubIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CurrencyRubPaths} {...props} />;
}

export const CurrencyRub = CurrencyRubIcon;
