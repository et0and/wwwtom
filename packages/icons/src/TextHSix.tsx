 ...
 * Source: @phosphor-icons/core text-h-six. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TextHSixPaths: IconPathData = {
  thin: [
    {
...
/** TextHSix icon in six Phosphor weights. Defaults to regular weight. */
export function TextHSixIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TextHSixPaths} {...props} />;
}

export const TextHSix = TextHSixIcon;
