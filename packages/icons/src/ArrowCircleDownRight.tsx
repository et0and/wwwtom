 ...
 * Source: @phosphor-icons/core arrow-circle-down-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowCircleDownRightPaths: IconPathData = {
  thin: [
    {
...
/** ArrowCircleDownRight icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowCircleDownRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowCircleDownRightPaths} {...props} />;
}
