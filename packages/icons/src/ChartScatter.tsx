 ...
 * Source: @phosphor-icons/core chart-scatter. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChartScatterPaths: IconPathData = {
  thin: [
    {
...
/** ChartScatter icon in six Phosphor weights. Defaults to regular weight. */
export function ChartScatterIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChartScatterPaths} {...props} />;
}
