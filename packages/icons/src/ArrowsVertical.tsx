 ...
 * Source: @phosphor-icons/core arrows-vertical. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowsVerticalPaths: IconPathData = {
  thin: [
    {
...
/** ArrowsVertical icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowsVerticalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowsVerticalPaths} {...props} />;
}

export const ArrowsVertical = ArrowsVerticalIcon;
