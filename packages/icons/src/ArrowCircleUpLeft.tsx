 ...
 * Source: @phosphor-icons/core arrow-circle-up-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowCircleUpLeftPaths: IconPathData = {
  thin: [
    {
...
/** ArrowCircleUpLeft icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowCircleUpLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowCircleUpLeftPaths} {...props} />;
}
