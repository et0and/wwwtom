 ...
 * Source: @phosphor-icons/core drop-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DropSimplePaths: IconPathData = {
  thin: [
    {
...
/** DropSimple icon in six Phosphor weights. Defaults to regular weight. */
export function DropSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DropSimplePaths} {...props} />;
}

export const DropSimple = DropSimpleIcon;
