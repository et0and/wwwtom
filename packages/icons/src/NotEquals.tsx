 ...
 * Source: @phosphor-icons/core not-equals. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NotEqualsPaths: IconPathData = {
  thin: [
    {
...
/** NotEquals icon in six Phosphor weights. Defaults to regular weight. */
export function NotEqualsIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NotEqualsPaths} {...props} />;
}

export const NotEquals = NotEqualsIcon;
