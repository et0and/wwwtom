 ...
 * Source: @phosphor-icons/core currency-eur. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CurrencyEurPaths: IconPathData = {
  thin: [
    {
...
/** CurrencyEur icon in six Phosphor weights. Defaults to regular weight. */
export function CurrencyEurIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CurrencyEurPaths} {...props} />;
}

export const CurrencyEur = CurrencyEurIcon;
