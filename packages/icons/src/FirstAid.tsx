 ...
 * Source: @phosphor-icons/core first-aid. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FirstAidPaths: IconPathData = {
  thin: [
    {
...
/** FirstAid icon in six Phosphor weights. Defaults to regular weight. */
export function FirstAidIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FirstAidPaths} {...props} />;
}
