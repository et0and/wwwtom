 ...
 * Source: @phosphor-icons/core building-office. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BuildingOfficePaths: IconPathData = {
  thin: [
    {
...
/** BuildingOffice icon in six Phosphor weights. Defaults to regular weight. */
export function BuildingOfficeIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BuildingOfficePaths} {...props} />;
}
