 ...
 * Source: @phosphor-icons/core music-notes-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MusicNotesSimplePaths: IconPathData = {
  thin: [
    {
...
/** MusicNotesSimple icon in six Phosphor weights. Defaults to regular weight. */
export function MusicNotesSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MusicNotesSimplePaths} {...props} />;
}

export const MusicNotesSimple = MusicNotesSimpleIcon;
