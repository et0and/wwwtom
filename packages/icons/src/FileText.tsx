 ...
 * Source: @phosphor-icons/core file-text. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FileTextPaths: IconPathData = {
  thin: [
    {
...
/** FileText icon in six Phosphor weights. Defaults to regular weight. */
export function FileTextIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FileTextPaths} {...props} />;
}
