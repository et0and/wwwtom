 ...
 * Source: @phosphor-icons/core floppy-disk. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FloppyDiskPaths: IconPathData = {
  thin: [
    {
...
/** FloppyDisk icon in six Phosphor weights. Defaults to regular weight. */
export function FloppyDiskIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FloppyDiskPaths} {...props} />;
}
