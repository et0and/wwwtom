 ...
 * Source: @phosphor-icons/core cross. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Cross icon in six Phosphor weights. Defaults to regular weight. */
export function CrossIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CrossPaths} {...props} />;
}
