 ...
 * Source: @phosphor-icons/core arrows-in-line-vertical. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowsInLineVerticalPaths: IconPathData = {
  thin: [
    {
...
/** ArrowsInLineVertical icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowsInLineVerticalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowsInLineVerticalPaths} {...props} />;
}

export const ArrowsInLineVertical = ArrowsInLineVerticalIcon;
