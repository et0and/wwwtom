 ...
 * Source: @phosphor-icons/core caret-circle-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CaretCircleDownPaths: IconPathData = {
  thin: [
    {
...
/** CaretCircleDown icon in six Phosphor weights. Defaults to regular weight. */
export function CaretCircleDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CaretCircleDownPaths} {...props} />;
}
