 ...
 * Source: @phosphor-icons/core circle-notch. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CircleNotchPaths: IconPathData = {
  thin: [
    {
...
/** CircleNotch icon in six Phosphor weights. Defaults to regular weight. */
export function CircleNotchIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CircleNotchPaths} {...props} />;
}

export const CircleNotch = CircleNotchIcon;
