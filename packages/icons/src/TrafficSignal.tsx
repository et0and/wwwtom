 ...
 * Source: @phosphor-icons/core traffic-signal. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TrafficSignalPaths: IconPathData = {
  thin: [
    {
...
/** TrafficSignal icon in six Phosphor weights. Defaults to regular weight. */
export function TrafficSignalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TrafficSignalPaths} {...props} />;
}

export const TrafficSignal = TrafficSignalIcon;
