 ...
 * Source: @phosphor-icons/core vault. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Vault icon in six Phosphor weights. Defaults to regular weight. */
export function VaultIcon(props: IconProps): JSX.Element {
  return <IconBase paths={VaultPaths} {...props} />;
}
