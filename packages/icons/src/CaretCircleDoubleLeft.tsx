 ...
 * Source: @phosphor-icons/core caret-circle-double-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CaretCircleDoubleLeftPaths: IconPathData = {
  thin: [
    {
...
/** CaretCircleDoubleLeft icon in six Phosphor weights. Defaults to regular weight. */
export function CaretCircleDoubleLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CaretCircleDoubleLeftPaths} {...props} />;
}

export const CaretCircleDoubleLeft = CaretCircleDoubleLeftIcon;
