 ...
 * Source: @phosphor-icons/core arrows-merge. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowsMergePaths: IconPathData = {
  thin: [
    {
...
/** ArrowsMerge icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowsMergeIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowsMergePaths} {...props} />;
}

export const ArrowsMerge = ArrowsMergeIcon;
