 ...
 * Source: @phosphor-icons/core plus-circle. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PlusCirclePaths: IconPathData = {
  thin: [
    {
...
/** PlusCircle icon in six Phosphor weights. Defaults to regular weight. */
export function PlusCircleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PlusCirclePaths} {...props} />;
}
