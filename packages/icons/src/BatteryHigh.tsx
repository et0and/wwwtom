 ...
 * Source: @phosphor-icons/core battery-high. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BatteryHighPaths: IconPathData = {
  thin: [
    {
...
/** BatteryHigh icon in six Phosphor weights. Defaults to regular weight. */
export function BatteryHighIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BatteryHighPaths} {...props} />;
}

export const BatteryHigh = BatteryHighIcon;
