 ...
 * Source: @phosphor-icons/core battery-full. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BatteryFullPaths: IconPathData = {
  thin: [
    {
...
/** BatteryFull icon in six Phosphor weights. Defaults to regular weight. */
export function BatteryFullIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BatteryFullPaths} {...props} />;
}
