 ...
 * Source: @phosphor-icons/core currency-inr. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CurrencyInrPaths: IconPathData = {
  thin: [
    {
...
/** CurrencyInr icon in six Phosphor weights. Defaults to regular weight. */
export function CurrencyInrIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CurrencyInrPaths} {...props} />;
}

export const CurrencyInr = CurrencyInrIcon;
