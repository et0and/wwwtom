 ...
 * Source: @phosphor-icons/core greater-than-or-equal. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const GreaterThanOrEqualPaths: IconPathData = {
  thin: [
    {
...
/** GreaterThanOrEqual icon in six Phosphor weights. Defaults to regular weight. */
export function GreaterThanOrEqualIcon(props: IconProps): JSX.Element {
  return <IconBase paths={GreaterThanOrEqualPaths} {...props} />;
}

export const GreaterThanOrEqual = GreaterThanOrEqualIcon;
