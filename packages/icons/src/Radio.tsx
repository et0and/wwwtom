 ...
 * Source: @phosphor-icons/core radio. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Radio icon in six Phosphor weights. Defaults to regular weight. */
export function RadioIcon(props: IconProps): JSX.Element {
  return <IconBase paths={RadioPaths} {...props} />;
}
