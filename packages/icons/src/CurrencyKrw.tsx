 ...
 * Source: @phosphor-icons/core currency-krw. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CurrencyKrwPaths: IconPathData = {
  thin: [
    {
...
/** CurrencyKrw icon in six Phosphor weights. Defaults to regular weight. */
export function CurrencyKrwIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CurrencyKrwPaths} {...props} />;
}

export const CurrencyKrw = CurrencyKrwIcon;
