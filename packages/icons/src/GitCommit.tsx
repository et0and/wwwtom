 ...
 * Source: @phosphor-icons/core git-commit. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const GitCommitPaths: IconPathData = {
  thin: [
    {
...
/** GitCommit icon in six Phosphor weights. Defaults to regular weight. */
export function GitCommitIcon(props: IconProps): JSX.Element {
  return <IconBase paths={GitCommitPaths} {...props} />;
}
