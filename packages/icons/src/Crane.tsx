 ...
 * Source: @phosphor-icons/core crane. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Crane icon in six Phosphor weights. Defaults to regular weight. */
export function CraneIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CranePaths} {...props} />;
}

export const Crane = CraneIcon;
