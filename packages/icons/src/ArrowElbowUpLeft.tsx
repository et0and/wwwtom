 ...
 * Source: @phosphor-icons/core arrow-elbow-up-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowElbowUpLeftPaths: IconPathData = {
  thin: [
    {
...
/** ArrowElbowUpLeft icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowElbowUpLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowElbowUpLeftPaths} {...props} />;
}

export const ArrowElbowUpLeft = ArrowElbowUpLeftIcon;
