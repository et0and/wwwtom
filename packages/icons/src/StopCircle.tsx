 ...
 * Source: @phosphor-icons/core stop-circle. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const StopCirclePaths: IconPathData = {
  thin: [
    {
...
/** StopCircle icon in six Phosphor weights. Defaults to regular weight. */
export function StopCircleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={StopCirclePaths} {...props} />;
}
