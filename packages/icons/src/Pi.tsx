 ...
 * Source: @phosphor-icons/core pi. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Pi icon in six Phosphor weights. Defaults to regular weight. */
export function PiIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PiPaths} {...props} />;
}
