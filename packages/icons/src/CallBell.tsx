 ...
 * Source: @phosphor-icons/core call-bell. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CallBellPaths: IconPathData = {
  thin: [
    {
...
/** CallBell icon in six Phosphor weights. Defaults to regular weight. */
export function CallBellIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CallBellPaths} {...props} />;
}

export const CallBell = CallBellIcon;
