 ...
 * Source: @phosphor-icons/core number-square-four. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NumberSquareFourPaths: IconPathData = {
  thin: [
    {
...
/** NumberSquareFour icon in six Phosphor weights. Defaults to regular weight. */
export function NumberSquareFourIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NumberSquareFourPaths} {...props} />;
}

export const NumberSquareFour = NumberSquareFourIcon;
