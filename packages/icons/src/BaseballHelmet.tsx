 ...
 * Source: @phosphor-icons/core baseball-helmet. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BaseballHelmetPaths: IconPathData = {
  thin: [
    {
...
/** BaseballHelmet icon in six Phosphor weights. Defaults to regular weight. */
export function BaseballHelmetIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BaseballHelmetPaths} {...props} />;
}

export const BaseballHelmet = BaseballHelmetIcon;
