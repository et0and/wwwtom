 ...
 * Source: @phosphor-icons/core notification. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NotificationPaths: IconPathData = {
  thin: [
    {
...
/** Notification icon in six Phosphor weights. Defaults to regular weight. */
export function NotificationIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NotificationPaths} {...props} />;
}
