 ...
 * Source: @phosphor-icons/core arrow-bend-down-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowBendDownLeftPaths: IconPathData = {
  thin: [
    {
...
/** ArrowBendDownLeft icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowBendDownLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowBendDownLeftPaths} {...props} />;
}

export const ArrowBendDownLeft = ArrowBendDownLeftIcon;
