 ...
 * Source: @phosphor-icons/core battery-vertical-high. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BatteryVerticalHighPaths: IconPathData = {
  thin: [
    {
...
/** BatteryVerticalHigh icon in six Phosphor weights. Defaults to regular weight. */
export function BatteryVerticalHighIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BatteryVerticalHighPaths} {...props} />;
}

export const BatteryVerticalHigh = BatteryVerticalHighIcon;
