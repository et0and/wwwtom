 ...
 * Source: @phosphor-icons/core music-notes-plus. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MusicNotesPlusPaths: IconPathData = {
  thin: [
    {
...
/** MusicNotesPlus icon in six Phosphor weights. Defaults to regular weight. */
export function MusicNotesPlusIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MusicNotesPlusPaths} {...props} />;
}

export const MusicNotesPlus = MusicNotesPlusIcon;
