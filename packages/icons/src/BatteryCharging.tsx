 ...
 * Source: @phosphor-icons/core battery-charging. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BatteryChargingPaths: IconPathData = {
  thin: [
    {
...
/** BatteryCharging icon in six Phosphor weights. Defaults to regular weight. */
export function BatteryChargingIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BatteryChargingPaths} {...props} />;
}
