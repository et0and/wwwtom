 ...
 * Source: @phosphor-icons/core gender-neuter. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const GenderNeuterPaths: IconPathData = {
  thin: [
    {
...
/** GenderNeuter icon in six Phosphor weights. Defaults to regular weight. */
export function GenderNeuterIcon(props: IconProps): JSX.Element {
  return <IconBase paths={GenderNeuterPaths} {...props} />;
}

export const GenderNeuter = GenderNeuterIcon;
