 ...
 * Source: @phosphor-icons/core dresser. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DresserPaths: IconPathData = {
  thin: [
    {
...
/** Dresser icon in six Phosphor weights. Defaults to regular weight. */
export function DresserIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DresserPaths} {...props} />;
}

export const Dresser = DresserIcon;
