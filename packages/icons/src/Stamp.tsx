 ...
 * Source: @phosphor-icons/core stamp. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Stamp icon in six Phosphor weights. Defaults to regular weight. */
export function StampIcon(props: IconProps): JSX.Element {
  return <IconBase paths={StampPaths} {...props} />;
}
