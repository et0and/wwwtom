 ...
 * Source: @phosphor-icons/core circles-three-plus. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CirclesThreePlusPaths: IconPathData = {
  thin: [
    {
...
/** CirclesThreePlus icon in six Phosphor weights. Defaults to regular weight. */
export function CirclesThreePlusIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CirclesThreePlusPaths} {...props} />;
}

export const CirclesThreePlus = CirclesThreePlusIcon;
