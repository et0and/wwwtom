 ...
 * Source: @phosphor-icons/core gender-female. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const GenderFemalePaths: IconPathData = {
  thin: [
    {
...
/** GenderFemale icon in six Phosphor weights. Defaults to regular weight. */
export function GenderFemaleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={GenderFemalePaths} {...props} />;
}

export const GenderFemale = GenderFemaleIcon;
