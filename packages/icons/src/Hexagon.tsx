 ...
 * Source: @phosphor-icons/core hexagon. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const HexagonPaths: IconPathData = {
  thin: [
    {
...
/** Hexagon icon in six Phosphor weights. Defaults to regular weight. */
export function HexagonIcon(props: IconProps): JSX.Element {
  return <IconBase paths={HexagonPaths} {...props} />;
}
