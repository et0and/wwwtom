 ...
 * Source: @phosphor-icons/core equals. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const EqualsPaths: IconPathData = {
  thin: [
    {
...
/** Equals icon in six Phosphor weights. Defaults to regular weight. */
export function EqualsIcon(props: IconProps): JSX.Element {
  return <IconBase paths={EqualsPaths} {...props} />;
}
