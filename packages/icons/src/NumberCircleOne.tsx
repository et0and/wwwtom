 ...
 * Source: @phosphor-icons/core number-circle-one. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NumberCircleOnePaths: IconPathData = {
  thin: [
    {
...
/** NumberCircleOne icon in six Phosphor weights. Defaults to regular weight. */
export function NumberCircleOneIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NumberCircleOnePaths} {...props} />;
}

export const NumberCircleOne = NumberCircleOneIcon;
