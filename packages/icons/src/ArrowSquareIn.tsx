 ...
 * Source: @phosphor-icons/core arrow-square-in. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowSquareInPaths: IconPathData = {
  thin: [
    {
...
/** ArrowSquareIn icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowSquareInIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowSquareInPaths} {...props} />;
}

export const ArrowSquareIn = ArrowSquareInIcon;
