 ...
 * Source: @phosphor-icons/core dice-two. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DiceTwoPaths: IconPathData = {
  thin: [
    {
...
/** DiceTwo icon in six Phosphor weights. Defaults to regular weight. */
export function DiceTwoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DiceTwoPaths} {...props} />;
}

export const DiceTwo = DiceTwoIcon;
