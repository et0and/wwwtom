 ...
 * Source: @phosphor-icons/core elevator. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ElevatorPaths: IconPathData = {
  thin: [
    {
...
/** Elevator icon in six Phosphor weights. Defaults to regular weight. */
export function ElevatorIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ElevatorPaths} {...props} />;
}

export const Elevator = ElevatorIcon;
