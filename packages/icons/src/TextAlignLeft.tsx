 ...
 * Source: @phosphor-icons/core text-align-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TextAlignLeftPaths: IconPathData = {
  thin: [
    {
...
/** TextAlignLeft icon in six Phosphor weights. Defaults to regular weight. */
export function TextAlignLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TextAlignLeftPaths} {...props} />;
}
