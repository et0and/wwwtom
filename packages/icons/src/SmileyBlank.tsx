 ...
 * Source: @phosphor-icons/core smiley-blank. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SmileyBlankPaths: IconPathData = {
  thin: [
    {
...
/** SmileyBlank icon in six Phosphor weights. Defaults to regular weight. */
export function SmileyBlankIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SmileyBlankPaths} {...props} />;
}

export const SmileyBlank = SmileyBlankIcon;
