 ...
 * Source: @phosphor-icons/core shuffle-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ShuffleSimplePaths: IconPathData = {
  thin: [
    {
...
/** ShuffleSimple icon in six Phosphor weights. Defaults to regular weight. */
export function ShuffleSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ShuffleSimplePaths} {...props} />;
}

export const ShuffleSimple = ShuffleSimpleIcon;
