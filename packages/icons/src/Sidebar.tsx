 ...
 * Source: @phosphor-icons/core sidebar. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SidebarPaths: IconPathData = {
  thin: [
    {
...
/** Sidebar icon in six Phosphor weights. Defaults to regular weight. */
export function SidebarIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SidebarPaths} {...props} />;
}
