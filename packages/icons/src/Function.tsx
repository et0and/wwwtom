 ...
 * Source: @phosphor-icons/core function. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FunctionPaths: IconPathData = {
  thin: [
    {
...
/** Function icon in six Phosphor weights. Defaults to regular weight. */
export function FunctionIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FunctionPaths} {...props} />;
}
