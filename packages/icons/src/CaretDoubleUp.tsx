 ...
 * Source: @phosphor-icons/core caret-double-up. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CaretDoubleUpPaths: IconPathData = {
  thin: [
    {
...
/** CaretDoubleUp icon in six Phosphor weights. Defaults to regular weight. */
export function CaretDoubleUpIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CaretDoubleUpPaths} {...props} />;
}
