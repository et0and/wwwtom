 ...
 * Source: @phosphor-icons/core caret-circle-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CaretCircleRightPaths: IconPathData = {
  thin: [
    {
...
/** CaretCircleRight icon in six Phosphor weights. Defaults to regular weight. */
export function CaretCircleRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CaretCircleRightPaths} {...props} />;
}
