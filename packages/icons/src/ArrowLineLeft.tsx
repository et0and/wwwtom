 ...
 * Source: @phosphor-icons/core arrow-line-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowLineLeftPaths: IconPathData = {
  thin: [
    {
...
/** ArrowLineLeft icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowLineLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowLineLeftPaths} {...props} />;
}

export const ArrowLineLeft = ArrowLineLeftIcon;
