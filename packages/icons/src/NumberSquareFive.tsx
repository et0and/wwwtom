 ...
 * Source: @phosphor-icons/core number-square-five. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NumberSquareFivePaths: IconPathData = {
  thin: [
    {
...
/** NumberSquareFive icon in six Phosphor weights. Defaults to regular weight. */
export function NumberSquareFiveIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NumberSquareFivePaths} {...props} />;
}

export const NumberSquareFive = NumberSquareFiveIcon;
