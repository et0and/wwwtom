 ...
 * Source: @phosphor-icons/core hard-drive. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const HardDrivePaths: IconPathData = {
  thin: [
    {
...
/** HardDrive icon in six Phosphor weights. Defaults to regular weight. */
export function HardDriveIcon(props: IconProps): JSX.Element {
  return <IconBase paths={HardDrivePaths} {...props} />;
}
