 ...
 * Source: @phosphor-icons/core arrow-u-down-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowUDownLeftPaths: IconPathData = {
  thin: [
    {
...
/** ArrowUDownLeft icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowUDownLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowUDownLeftPaths} {...props} />;
}

export const ArrowUDownLeft = ArrowUDownLeftIcon;
