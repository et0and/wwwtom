 ...
 * Source: @phosphor-icons/core gif. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Gif icon in six Phosphor weights. Defaults to regular weight. */
export function GifIcon(props: IconProps): JSX.Element {
  return <IconBase paths={GifPaths} {...props} />;
}

export const Gif = GifIcon;
