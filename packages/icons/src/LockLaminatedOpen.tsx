 ...
 * Source: @phosphor-icons/core lock-laminated-open. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const LockLaminatedOpenPaths: IconPathData = {
  thin: [
    {
...
/** LockLaminatedOpen icon in six Phosphor weights. Defaults to regular weight. */
export function LockLaminatedOpenIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LockLaminatedOpenPaths} {...props} />;
}

export const LockLaminatedOpen = LockLaminatedOpenIcon;
