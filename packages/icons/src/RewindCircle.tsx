 ...
 * Source: @phosphor-icons/core rewind-circle. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const RewindCirclePaths: IconPathData = {
  thin: [
    {
...
/** RewindCircle icon in six Phosphor weights. Defaults to regular weight. */
export function RewindCircleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={RewindCirclePaths} {...props} />;
}

export const RewindCircle = RewindCircleIcon;
