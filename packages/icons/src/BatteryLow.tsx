 ...
 * Source: @phosphor-icons/core battery-low. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BatteryLowPaths: IconPathData = {
  thin: [
    {
...
/** BatteryLow icon in six Phosphor weights. Defaults to regular weight. */
export function BatteryLowIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BatteryLowPaths} {...props} />;
}
