 ...
 * Source: @phosphor-icons/core arrow-line-down-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowLineDownLeftPaths: IconPathData = {
  thin: [
    {
...
/** ArrowLineDownLeft icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowLineDownLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowLineDownLeftPaths} {...props} />;
}

export const ArrowLineDownLeft = ArrowLineDownLeftIcon;
