 ...
 * Source: @phosphor-icons/core user. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** User icon in six Phosphor weights. Defaults to regular weight. */
export function UserIcon(props: IconProps): JSX.Element {
  return <IconBase paths={UserPaths} {...props} />;
}
