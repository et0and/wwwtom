 ...
 * Source: @phosphor-icons/core toggle-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ToggleRightPaths: IconPathData = {
  thin: [
    {
...
/** ToggleRight icon in six Phosphor weights. Defaults to regular weight. */
export function ToggleRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ToggleRightPaths} {...props} />;
}
