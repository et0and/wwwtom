 ...
 * Source: @phosphor-icons/core paint-brush-broad. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PaintBrushBroadPaths: IconPathData = {
  thin: [
    {
...
/** PaintBrushBroad icon in six Phosphor weights. Defaults to regular weight. */
export function PaintBrushBroadIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PaintBrushBroadPaths} {...props} />;
}

export const PaintBrushBroad = PaintBrushBroadIcon;
