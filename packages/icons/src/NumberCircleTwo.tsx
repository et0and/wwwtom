 ...
 * Source: @phosphor-icons/core number-circle-two. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NumberCircleTwoPaths: IconPathData = {
  thin: [
    {
...
/** NumberCircleTwo icon in six Phosphor weights. Defaults to regular weight. */
export function NumberCircleTwoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NumberCircleTwoPaths} {...props} />;
}

export const NumberCircleTwo = NumberCircleTwoIcon;
