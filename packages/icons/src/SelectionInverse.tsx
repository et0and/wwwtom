 ...
 * Source: @phosphor-icons/core selection-inverse. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SelectionInversePaths: IconPathData = {
  thin: [
    {
...
/** SelectionInverse icon in six Phosphor weights. Defaults to regular weight. */
export function SelectionInverseIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SelectionInversePaths} {...props} />;
}

export const SelectionInverse = SelectionInverseIcon;
