 ...
 * Source: @phosphor-icons/core medal-military. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MedalMilitaryPaths: IconPathData = {
  thin: [
    {
...
/** MedalMilitary icon in six Phosphor weights. Defaults to regular weight. */
export function MedalMilitaryIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MedalMilitaryPaths} {...props} />;
}

export const MedalMilitary = MedalMilitaryIcon;
