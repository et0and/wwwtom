 ...
 * Source: @phosphor-icons/core calendar-blank. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CalendarBlankPaths: IconPathData = {
  thin: [
    {
...
/** CalendarBlank icon in six Phosphor weights. Defaults to regular weight. */
export function CalendarBlankIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CalendarBlankPaths} {...props} />;
}

export const CalendarBlank = CalendarBlankIcon;
