 ...
 * Source: @phosphor-icons/core text-b. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** TextB icon in six Phosphor weights. Defaults to regular weight. */
export function TextBIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TextBPaths} {...props} />;
}

export const TextB = TextBIcon;
