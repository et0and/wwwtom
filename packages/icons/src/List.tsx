 ...
 * Source: @phosphor-icons/core list. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** List icon in six Phosphor weights. Defaults to regular weight. */
export function ListIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ListPaths} {...props} />;
}
