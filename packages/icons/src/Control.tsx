 ...
 * Source: @phosphor-icons/core control. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ControlPaths: IconPathData = {
  thin: [
    {
...
/** Control icon in six Phosphor weights. Defaults to regular weight. */
export function ControlIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ControlPaths} {...props} />;
}

export const Control = ControlIcon;
