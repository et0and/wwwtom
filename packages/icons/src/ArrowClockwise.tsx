 ...
 * Source: @phosphor-icons/core arrow-clockwise. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowClockwisePaths: IconPathData = {
  thin: [
    {
...
/** ArrowClockwise icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowClockwiseIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowClockwisePaths} {...props} />;
}
