 ...
 * Source: @phosphor-icons/core device-tablet-camera. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DeviceTabletCameraPaths: IconPathData = {
  thin: [
    {
...
/** DeviceTabletCamera icon in six Phosphor weights. Defaults to regular weight. */
export function DeviceTabletCameraIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DeviceTabletCameraPaths} {...props} />;
}

export const DeviceTabletCamera = DeviceTabletCameraIcon;
