 ...
 * Source: @phosphor-icons/core arrow-circle-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowCircleDownPaths: IconPathData = {
  thin: [
    {
...
/** ArrowCircleDown icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowCircleDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowCircleDownPaths} {...props} />;
}
