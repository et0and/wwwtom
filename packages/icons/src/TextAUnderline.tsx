 ...
 * Source: @phosphor-icons/core text-a-underline. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TextAUnderlinePaths: IconPathData = {
  thin: [
    {
...
/** TextAUnderline icon in six Phosphor weights. Defaults to regular weight. */
export function TextAUnderlineIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TextAUnderlinePaths} {...props} />;
}

export const TextAUnderline = TextAUnderlineIcon;
