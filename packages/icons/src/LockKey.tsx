 ...
 * Source: @phosphor-icons/core lock-key. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const LockKeyPaths: IconPathData = {
  thin: [
    {
...
/** LockKey icon in six Phosphor weights. Defaults to regular weight. */
export function LockKeyIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LockKeyPaths} {...props} />;
}

export const LockKey = LockKeyIcon;
