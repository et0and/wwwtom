 ...
 * Source: @phosphor-icons/core stool. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Stool icon in six Phosphor weights. Defaults to regular weight. */
export function StoolIcon(props: IconProps): JSX.Element {
  return <IconBase paths={StoolPaths} {...props} />;
}

export const Stool = StoolIcon;
