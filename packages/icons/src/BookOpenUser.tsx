 ...
 * Source: @phosphor-icons/core book-open-user. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BookOpenUserPaths: IconPathData = {
  thin: [
    {
...
/** BookOpenUser icon in six Phosphor weights. Defaults to regular weight. */
export function BookOpenUserIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BookOpenUserPaths} {...props} />;
}

export const BookOpenUser = BookOpenUserIcon;
