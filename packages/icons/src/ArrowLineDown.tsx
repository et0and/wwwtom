 ...
 * Source: @phosphor-icons/core arrow-line-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowLineDownPaths: IconPathData = {
  thin: [
    {
...
/** ArrowLineDown icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowLineDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowLineDownPaths} {...props} />;
}

export const ArrowLineDown = ArrowLineDownIcon;
