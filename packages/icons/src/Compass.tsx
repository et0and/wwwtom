 ...
 * Source: @phosphor-icons/core compass. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CompassPaths: IconPathData = {
  thin: [
    {
...
/** Compass icon in six Phosphor weights. Defaults to regular weight. */
export function CompassIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CompassPaths} {...props} />;
}
