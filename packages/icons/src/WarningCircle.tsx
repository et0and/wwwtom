 ...
 * Source: @phosphor-icons/core warning-circle. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const WarningCirclePaths: IconPathData = {
  thin: [
    {
...
/** WarningCircle icon in six Phosphor weights. Defaults to regular weight. */
export function WarningCircleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={WarningCirclePaths} {...props} />;
}
