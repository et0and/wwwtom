 ...
 * Source: @phosphor-icons/core eject-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const EjectSimplePaths: IconPathData = {
  thin: [
    {
...
/** EjectSimple icon in six Phosphor weights. Defaults to regular weight. */
export function EjectSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={EjectSimplePaths} {...props} />;
}

export const EjectSimple = EjectSimpleIcon;
