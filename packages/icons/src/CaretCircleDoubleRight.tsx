 ...
 * Source: @phosphor-icons/core caret-circle-double-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CaretCircleDoubleRightPaths: IconPathData = {
  thin: [
    {
...
/** CaretCircleDoubleRight icon in six Phosphor weights. Defaults to regular weight. */
export function CaretCircleDoubleRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CaretCircleDoubleRightPaths} {...props} />;
}

export const CaretCircleDoubleRight = CaretCircleDoubleRightIcon;
