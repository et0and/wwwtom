 ...
 * Source: @phosphor-icons/core rows. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Rows icon in six Phosphor weights. Defaults to regular weight. */
export function RowsIcon(props: IconProps): JSX.Element {
  return <IconBase paths={RowsPaths} {...props} />;
}
