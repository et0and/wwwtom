 ...
 * Source: @phosphor-icons/core archive. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArchivePaths: IconPathData = {
  thin: [
    {
...
/** Archive icon in six Phosphor weights. Defaults to regular weight. */
export function ArchiveIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArchivePaths} {...props} />;
}
