 ...
 * Source: @phosphor-icons/core circle-half-tilt. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CircleHalfTiltPaths: IconPathData = {
  thin: [
    {
...
/** CircleHalfTilt icon in six Phosphor weights. Defaults to regular weight. */
export function CircleHalfTiltIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CircleHalfTiltPaths} {...props} />;
}

export const CircleHalfTilt = CircleHalfTiltIcon;
