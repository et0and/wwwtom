 ...
 * Source: @phosphor-icons/core gradient. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const GradientPaths: IconPathData = {
  thin: [
    {
...
/** Gradient icon in six Phosphor weights. Defaults to regular weight. */
export function GradientIcon(props: IconProps): JSX.Element {
  return <IconBase paths={GradientPaths} {...props} />;
}

export const Gradient = GradientIcon;
