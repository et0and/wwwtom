 ...
 * Source: @phosphor-icons/core waveform-slash. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const WaveformSlashPaths: IconPathData = {
  thin: [
    {
...
/** WaveformSlash icon in six Phosphor weights. Defaults to regular weight. */
export function WaveformSlashIcon(props: IconProps): JSX.Element {
  return <IconBase paths={WaveformSlashPaths} {...props} />;
}

export const WaveformSlash = WaveformSlashIcon;
