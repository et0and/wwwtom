 ...
 * Source: @phosphor-icons/core currency-dollar. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CurrencyDollarPaths: IconPathData = {
  thin: [
    {
...
/** CurrencyDollar icon in six Phosphor weights. Defaults to regular weight. */
export function CurrencyDollarIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CurrencyDollarPaths} {...props} />;
}
