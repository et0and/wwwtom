 ...
 * Source: @phosphor-icons/core number-square-seven. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NumberSquareSevenPaths: IconPathData = {
  thin: [
    {
...
/** NumberSquareSeven icon in six Phosphor weights. Defaults to regular weight. */
export function NumberSquareSevenIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NumberSquareSevenPaths} {...props} />;
}

export const NumberSquareSeven = NumberSquareSevenIcon;
