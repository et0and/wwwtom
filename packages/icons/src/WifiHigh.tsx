 ...
 * Source: @phosphor-icons/core wifi-high. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const WifiHighPaths: IconPathData = {
  thin: [
    {
...
/** WifiHigh icon in six Phosphor weights. Defaults to regular weight. */
export function WifiHighIcon(props: IconProps): JSX.Element {
  return <IconBase paths={WifiHighPaths} {...props} />;
}
