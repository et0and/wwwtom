 ...
 * Source: @phosphor-icons/core bell-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BellSimplePaths: IconPathData = {
  thin: [
    {
...
/** BellSimple icon in six Phosphor weights. Defaults to regular weight. */
export function BellSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BellSimplePaths} {...props} />;
}

export const BellSimple = BellSimpleIcon;
