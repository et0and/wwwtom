 ...
 * Source: @phosphor-icons/core dots-three-circle-vertical. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DotsThreeCircleVerticalPaths: IconPathData = {
  thin: [
    {
...
/** DotsThreeCircleVertical icon in six Phosphor weights. Defaults to regular weight. */
export function DotsThreeCircleVerticalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DotsThreeCircleVerticalPaths} {...props} />;
}

export const DotsThreeCircleVertical = DotsThreeCircleVerticalIcon;
