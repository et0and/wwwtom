 ...
 * Source: @phosphor-icons/core arrow-elbow-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowElbowLeftPaths: IconPathData = {
  thin: [
    {
...
/** ArrowElbowLeft icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowElbowLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowElbowLeftPaths} {...props} />;
}

export const ArrowElbowLeft = ArrowElbowLeftIcon;
