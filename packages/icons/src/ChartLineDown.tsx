 ...
 * Source: @phosphor-icons/core chart-line-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChartLineDownPaths: IconPathData = {
  thin: [
    {
...
/** ChartLineDown icon in six Phosphor weights. Defaults to regular weight. */
export function ChartLineDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChartLineDownPaths} {...props} />;
}

export const ChartLineDown = ChartLineDownIcon;
