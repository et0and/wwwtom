 ...
 * Source: @phosphor-icons/core monitor-arrow-up. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MonitorArrowUpPaths: IconPathData = {
  thin: [
    {
...
/** MonitorArrowUp icon in six Phosphor weights. Defaults to regular weight. */
export function MonitorArrowUpIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MonitorArrowUpPaths} {...props} />;
}

export const MonitorArrowUp = MonitorArrowUpIcon;
