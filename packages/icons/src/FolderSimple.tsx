 ...
 * Source: @phosphor-icons/core folder-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FolderSimplePaths: IconPathData = {
  thin: [
    {
...
/** FolderSimple icon in six Phosphor weights. Defaults to regular weight. */
export function FolderSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FolderSimplePaths} {...props} />;
}

export const FolderSimple = FolderSimpleIcon;
