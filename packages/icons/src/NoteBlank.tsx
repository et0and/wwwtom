 ...
 * Source: @phosphor-icons/core note-blank. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NoteBlankPaths: IconPathData = {
  thin: [
    {
...
/** NoteBlank icon in six Phosphor weights. Defaults to regular weight. */
export function NoteBlankIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NoteBlankPaths} {...props} />;
}

export const NoteBlank = NoteBlankIcon;
