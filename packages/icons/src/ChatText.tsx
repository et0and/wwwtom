 ...
 * Source: @phosphor-icons/core chat-text. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChatTextPaths: IconPathData = {
  thin: [
    {
...
/** ChatText icon in six Phosphor weights. Defaults to regular weight. */
export function ChatTextIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChatTextPaths} {...props} />;
}

export const ChatText = ChatTextIcon;
