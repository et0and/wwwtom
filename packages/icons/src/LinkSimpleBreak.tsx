 ...
 * Source: @phosphor-icons/core link-simple-break. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const LinkSimpleBreakPaths: IconPathData = {
  thin: [
    {
...
/** LinkSimpleBreak icon in six Phosphor weights. Defaults to regular weight. */
export function LinkSimpleBreakIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LinkSimpleBreakPaths} {...props} />;
}

export const LinkSimpleBreak = LinkSimpleBreakIcon;
