 ...
 * Source: @phosphor-icons/core text-h-four. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TextHFourPaths: IconPathData = {
  thin: [
    {
...
/** TextHFour icon in six Phosphor weights. Defaults to regular weight. */
export function TextHFourIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TextHFourPaths} {...props} />;
}

export const TextHFour = TextHFourIcon;
