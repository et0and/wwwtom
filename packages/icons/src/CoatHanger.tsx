 ...
 * Source: @phosphor-icons/core coat-hanger. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CoatHangerPaths: IconPathData = {
  thin: [
    {
...
/** CoatHanger icon in six Phosphor weights. Defaults to regular weight. */
export function CoatHangerIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CoatHangerPaths} {...props} />;
}

export const CoatHanger = CoatHangerIcon;
