 ...
 * Source: @phosphor-icons/core arrow-elbow-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowElbowRightPaths: IconPathData = {
  thin: [
    {
...
/** ArrowElbowRight icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowElbowRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowElbowRightPaths} {...props} />;
}

export const ArrowElbowRight = ArrowElbowRightIcon;
