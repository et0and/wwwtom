 ...
 * Source: @phosphor-icons/core arrows-out-line-vertical. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowsOutLineVerticalPaths: IconPathData = {
  thin: [
    {
...
/** ArrowsOutLineVertical icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowsOutLineVerticalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowsOutLineVerticalPaths} {...props} />;
}

export const ArrowsOutLineVertical = ArrowsOutLineVerticalIcon;
