 ...
 * Source: @phosphor-icons/core eyeglasses. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const EyeglassesPaths: IconPathData = {
  thin: [
    {
...
/** Eyeglasses icon in six Phosphor weights. Defaults to regular weight. */
export function EyeglassesIcon(props: IconProps): JSX.Element {
  return <IconBase paths={EyeglassesPaths} {...props} />;
}

export const Eyeglasses = EyeglassesIcon;
