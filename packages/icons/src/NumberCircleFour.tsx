 ...
 * Source: @phosphor-icons/core number-circle-four. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NumberCircleFourPaths: IconPathData = {
  thin: [
    {
...
/** NumberCircleFour icon in six Phosphor weights. Defaults to regular weight. */
export function NumberCircleFourIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NumberCircleFourPaths} {...props} />;
}

export const NumberCircleFour = NumberCircleFourIcon;
