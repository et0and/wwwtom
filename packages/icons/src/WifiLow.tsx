 ...
 * Source: @phosphor-icons/core wifi-low. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const WifiLowPaths: IconPathData = {
  thin: [
    {
...
/** WifiLow icon in six Phosphor weights. Defaults to regular weight. */
export function WifiLowIcon(props: IconProps): JSX.Element {
  return <IconBase paths={WifiLowPaths} {...props} />;
}
