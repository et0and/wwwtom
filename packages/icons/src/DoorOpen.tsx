 ...
 * Source: @phosphor-icons/core door-open. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DoorOpenPaths: IconPathData = {
  thin: [
    {
...
/** DoorOpen icon in six Phosphor weights. Defaults to regular weight. */
export function DoorOpenIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DoorOpenPaths} {...props} />;
}
