 ...
 * Source: @phosphor-icons/core circles-three. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CirclesThreePaths: IconPathData = {
  thin: [
    {
...
/** CirclesThree icon in six Phosphor weights. Defaults to regular weight. */
export function CirclesThreeIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CirclesThreePaths} {...props} />;
}

export const CirclesThree = CirclesThreeIcon;
