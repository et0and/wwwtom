 ...
 * Source: @phosphor-icons/core cloud-arrow-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CloudArrowDownPaths: IconPathData = {
  thin: [
    {
...
/** CloudArrowDown icon in six Phosphor weights. Defaults to regular weight. */
export function CloudArrowDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CloudArrowDownPaths} {...props} />;
}

export const CloudArrowDown = CloudArrowDownIcon;
