 ...
 * Source: @phosphor-icons/core arrow-square-down-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowSquareDownRightPaths: IconPathData = {
  thin: [
    {
...
/** ArrowSquareDownRight icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowSquareDownRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowSquareDownRightPaths} {...props} />;
}

export const ArrowSquareDownRight = ArrowSquareDownRightIcon;
