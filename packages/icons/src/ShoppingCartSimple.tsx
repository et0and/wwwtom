 ...
 * Source: @phosphor-icons/core shopping-cart-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ShoppingCartSimplePaths: IconPathData = {
  thin: [
    {
...
/** ShoppingCartSimple icon in six Phosphor weights. Defaults to regular weight. */
export function ShoppingCartSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ShoppingCartSimplePaths} {...props} />;
}

export const ShoppingCartSimple = ShoppingCartSimpleIcon;
