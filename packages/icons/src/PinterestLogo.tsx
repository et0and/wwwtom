 ...
 * Source: @phosphor-icons/core pinterest-logo. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PinterestLogoPaths: IconPathData = {
  thin: [
    {
...
/** PinterestLogo icon in six Phosphor weights. Defaults to regular weight. */
export function PinterestLogoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PinterestLogoPaths} {...props} />;
}

export const PinterestLogo = PinterestLogoIcon;
