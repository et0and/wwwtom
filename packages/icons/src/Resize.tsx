 ...
 * Source: @phosphor-icons/core resize. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ResizePaths: IconPathData = {
  thin: [
    {
...
/** Resize icon in six Phosphor weights. Defaults to regular weight. */
export function ResizeIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ResizePaths} {...props} />;
}

export const Resize = ResizeIcon;
