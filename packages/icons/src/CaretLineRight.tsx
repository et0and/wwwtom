 ...
 * Source: @phosphor-icons/core caret-line-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CaretLineRightPaths: IconPathData = {
  thin: [
    {
...
/** CaretLineRight icon in six Phosphor weights. Defaults to regular weight. */
export function CaretLineRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CaretLineRightPaths} {...props} />;
}

export const CaretLineRight = CaretLineRightIcon;
