 ...
 * Source: @phosphor-icons/core cloud-arrow-up. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CloudArrowUpPaths: IconPathData = {
  thin: [
    {
...
/** CloudArrowUp icon in six Phosphor weights. Defaults to regular weight. */
export function CloudArrowUpIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CloudArrowUpPaths} {...props} />;
}

export const CloudArrowUp = CloudArrowUpIcon;
