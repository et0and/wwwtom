 ...
 * Source: @phosphor-icons/core arrow-bend-up-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowBendUpLeftPaths: IconPathData = {
  thin: [
    {
...
/** ArrowBendUpLeft icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowBendUpLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowBendUpLeftPaths} {...props} />;
}

export const ArrowBendUpLeft = ArrowBendUpLeftIcon;
