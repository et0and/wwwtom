 ...
 * Source: @phosphor-icons/core play. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Play icon in six Phosphor weights. Defaults to regular weight. */
export function PlayIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PlayPaths} {...props} />;
}
