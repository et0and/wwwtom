 ...
 * Source: @phosphor-icons/core target. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TargetPaths: IconPathData = {
  thin: [
    {
...
/** Target icon in six Phosphor weights. Defaults to regular weight. */
export function TargetIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TargetPaths} {...props} />;
}
