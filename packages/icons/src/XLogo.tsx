 ...
 * Source: @phosphor-icons/core x-logo. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** XLogo icon in six Phosphor weights. Defaults to regular weight. */
export function XLogoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={XLogoPaths} {...props} />;
}

export const XLogo = XLogoIcon;
