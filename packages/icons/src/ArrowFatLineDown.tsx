 ...
 * Source: @phosphor-icons/core arrow-fat-line-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowFatLineDownPaths: IconPathData = {
  thin: [
    {
...
/** ArrowFatLineDown icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowFatLineDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowFatLineDownPaths} {...props} />;
}

export const ArrowFatLineDown = ArrowFatLineDownIcon;
