 ...
 * Source: @phosphor-icons/core text-h-one. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TextHOnePaths: IconPathData = {
  thin: [
    {
...
/** TextHOne icon in six Phosphor weights. Defaults to regular weight. */
export function TextHOneIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TextHOnePaths} {...props} />;
}

export const TextHOne = TextHOneIcon;
