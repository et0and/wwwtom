 ...
 * Source: @phosphor-icons/core kanban. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const KanbanPaths: IconPathData = {
  thin: [
    {
...
/** Kanban icon in six Phosphor weights. Defaults to regular weight. */
export function KanbanIcon(props: IconProps): JSX.Element {
  return <IconBase paths={KanbanPaths} {...props} />;
}
