 ...
 * Source: @phosphor-icons/core desktop. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DesktopPaths: IconPathData = {
  thin: [
    {
...
/** Desktop icon in six Phosphor weights. Defaults to regular weight. */
export function DesktopIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DesktopPaths} {...props} />;
}
