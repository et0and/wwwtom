 ...
 * Source: @phosphor-icons/core arrow-line-down-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowLineDownRightPaths: IconPathData = {
  thin: [
    {
...
/** ArrowLineDownRight icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowLineDownRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowLineDownRightPaths} {...props} />;
}

export const ArrowLineDownRight = ArrowLineDownRightIcon;
