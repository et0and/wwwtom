 ...
 * Source: @phosphor-icons/core music-notes-minus. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MusicNotesMinusPaths: IconPathData = {
  thin: [
    {
...
/** MusicNotesMinus icon in six Phosphor weights. Defaults to regular weight. */
export function MusicNotesMinusIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MusicNotesMinusPaths} {...props} />;
}

export const MusicNotesMinus = MusicNotesMinusIcon;
