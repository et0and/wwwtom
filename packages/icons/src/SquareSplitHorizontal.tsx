 ...
 * Source: @phosphor-icons/core square-split-horizontal. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SquareSplitHorizontalPaths: IconPathData = {
  thin: [
    {
...
/** SquareSplitHorizontal icon in six Phosphor weights. Defaults to regular weight. */
export function SquareSplitHorizontalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SquareSplitHorizontalPaths} {...props} />;
}
