 ...
 * Source: @phosphor-icons/core caret-double-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CaretDoubleDownPaths: IconPathData = {
  thin: [
    {
...
/** CaretDoubleDown icon in six Phosphor weights. Defaults to regular weight. */
export function CaretDoubleDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CaretDoubleDownPaths} {...props} />;
}

export const CaretDoubleDown = CaretDoubleDownIcon;
