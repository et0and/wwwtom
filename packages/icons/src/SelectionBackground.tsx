 ...
 * Source: @phosphor-icons/core selection-background. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SelectionBackgroundPaths: IconPathData = {
  thin: [
    {
...
/** SelectionBackground icon in six Phosphor weights. Defaults to regular weight. */
export function SelectionBackgroundIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SelectionBackgroundPaths} {...props} />;
}

export const SelectionBackground = SelectionBackgroundIcon;
