 ...
 * Source: @phosphor-icons/core arrow-bend-double-up-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowBendDoubleUpRightPaths: IconPathData = {
  thin: [
    {
...
/** ArrowBendDoubleUpRight icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowBendDoubleUpRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowBendDoubleUpRightPaths} {...props} />;
}

export const ArrowBendDoubleUpRight = ArrowBendDoubleUpRightIcon;
