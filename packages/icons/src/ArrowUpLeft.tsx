 ...
 * Source: @phosphor-icons/core arrow-up-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowUpLeftPaths: IconPathData = {
  thin: [
    {
...
/** ArrowUpLeft icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowUpLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowUpLeftPaths} {...props} />;
}
