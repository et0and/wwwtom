 ...
 * Source: @phosphor-icons/core align-bottom. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const AlignBottomPaths: IconPathData = {
  thin: [
    {
...
/** AlignBottom icon in six Phosphor weights. Defaults to regular weight. */
export function AlignBottomIcon(props: IconProps): JSX.Element {
  return <IconBase paths={AlignBottomPaths} {...props} />;
}

export const AlignBottom = AlignBottomIcon;
