 ...
 * Source: @phosphor-icons/core app-store-logo. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const AppStoreLogoPaths: IconPathData = {
  thin: [
    {
...
/** AppStoreLogo icon in six Phosphor weights. Defaults to regular weight. */
export function AppStoreLogoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={AppStoreLogoPaths} {...props} />;
}

export const AppStoreLogo = AppStoreLogoIcon;
