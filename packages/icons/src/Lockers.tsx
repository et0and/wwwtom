 ...
 * Source: @phosphor-icons/core lockers. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const LockersPaths: IconPathData = {
  thin: [
    {
...
/** Lockers icon in six Phosphor weights. Defaults to regular weight. */
export function LockersIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LockersPaths} {...props} />;
}

export const Lockers = LockersIcon;
