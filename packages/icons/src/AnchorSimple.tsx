 ...
 * Source: @phosphor-icons/core anchor-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const AnchorSimplePaths: IconPathData = {
  thin: [
    {
...
/** AnchorSimple icon in six Phosphor weights. Defaults to regular weight. */
export function AnchorSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={AnchorSimplePaths} {...props} />;
}

export const AnchorSimple = AnchorSimpleIcon;
