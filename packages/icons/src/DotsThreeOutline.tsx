 ...
 * Source: @phosphor-icons/core dots-three-outline. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DotsThreeOutlinePaths: IconPathData = {
  thin: [
    {
...
/** DotsThreeOutline icon in six Phosphor weights. Defaults to regular weight. */
export function DotsThreeOutlineIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DotsThreeOutlinePaths} {...props} />;
}

export const DotsThreeOutline = DotsThreeOutlineIcon;
