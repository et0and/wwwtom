 ...
 * Source: @phosphor-icons/core chat-circle-dots. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChatCircleDotsPaths: IconPathData = {
  thin: [
    {
...
/** ChatCircleDots icon in six Phosphor weights. Defaults to regular weight. */
export function ChatCircleDotsIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChatCircleDotsPaths} {...props} />;
}
