 ...
 * Source: @phosphor-icons/core number-square-nine. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NumberSquareNinePaths: IconPathData = {
  thin: [
    {
...
/** NumberSquareNine icon in six Phosphor weights. Defaults to regular weight. */
export function NumberSquareNineIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NumberSquareNinePaths} {...props} />;
}

export const NumberSquareNine = NumberSquareNineIcon;
