 ...
 * Source: @phosphor-icons/core caret-line-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CaretLineLeftPaths: IconPathData = {
  thin: [
    {
...
/** CaretLineLeft icon in six Phosphor weights. Defaults to regular weight. */
export function CaretLineLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CaretLineLeftPaths} {...props} />;
}

export const CaretLineLeft = CaretLineLeftIcon;
