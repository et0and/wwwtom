 ...
 * Source: @phosphor-icons/core caret-line-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CaretLineDownPaths: IconPathData = {
  thin: [
    {
...
/** CaretLineDown icon in six Phosphor weights. Defaults to regular weight. */
export function CaretLineDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CaretLineDownPaths} {...props} />;
}

export const CaretLineDown = CaretLineDownIcon;
