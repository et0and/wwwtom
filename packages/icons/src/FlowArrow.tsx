 ...
 * Source: @phosphor-icons/core flow-arrow. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FlowArrowPaths: IconPathData = {
  thin: [
    {
...
/** FlowArrow icon in six Phosphor weights. Defaults to regular weight. */
export function FlowArrowIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FlowArrowPaths} {...props} />;
}
