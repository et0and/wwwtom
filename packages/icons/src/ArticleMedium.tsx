 ...
 * Source: @phosphor-icons/core article-medium. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArticleMediumPaths: IconPathData = {
  thin: [
    {
...
/** ArticleMedium icon in six Phosphor weights. Defaults to regular weight. */
export function ArticleMediumIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArticleMediumPaths} {...props} />;
}

export const ArticleMedium = ArticleMediumIcon;
