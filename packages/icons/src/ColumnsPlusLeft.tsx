 ...
 * Source: @phosphor-icons/core columns-plus-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ColumnsPlusLeftPaths: IconPathData = {
  thin: [
    {
...
/** ColumnsPlusLeft icon in six Phosphor weights. Defaults to regular weight. */
export function ColumnsPlusLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ColumnsPlusLeftPaths} {...props} />;
}

export const ColumnsPlusLeft = ColumnsPlusLeftIcon;
