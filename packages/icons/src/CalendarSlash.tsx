 ...
 * Source: @phosphor-icons/core calendar-slash. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CalendarSlashPaths: IconPathData = {
  thin: [
    {
...
/** CalendarSlash icon in six Phosphor weights. Defaults to regular weight. */
export function CalendarSlashIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CalendarSlashPaths} {...props} />;
}

export const CalendarSlash = CalendarSlashIcon;
