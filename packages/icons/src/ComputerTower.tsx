 ...
 * Source: @phosphor-icons/core computer-tower. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ComputerTowerPaths: IconPathData = {
  thin: [
    {
...
/** ComputerTower icon in six Phosphor weights. Defaults to regular weight. */
export function ComputerTowerIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ComputerTowerPaths} {...props} />;
}

export const ComputerTower = ComputerTowerIcon;
