 ...
 * Source: @phosphor-icons/core arrow-square-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowSquareDownPaths: IconPathData = {
  thin: [
    {
...
/** ArrowSquareDown icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowSquareDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowSquareDownPaths} {...props} />;
}

export const ArrowSquareDown = ArrowSquareDownIcon;
