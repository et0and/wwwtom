 ...
 * Source: @phosphor-icons/core paint-roller. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PaintRollerPaths: IconPathData = {
  thin: [
    {
...
/** PaintRoller icon in six Phosphor weights. Defaults to regular weight. */
export function PaintRollerIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PaintRollerPaths} {...props} />;
}
