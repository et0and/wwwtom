 ...
 * Source: @phosphor-icons/core circles-four. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CirclesFourPaths: IconPathData = {
  thin: [
    {
...
/** CirclesFour icon in six Phosphor weights. Defaults to regular weight. */
export function CirclesFourIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CirclesFourPaths} {...props} />;
}

export const CirclesFour = CirclesFourIcon;
