 ...
 * Source: @phosphor-icons/core text-align-justify. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TextAlignJustifyPaths: IconPathData = {
  thin: [
    {
...
/** TextAlignJustify icon in six Phosphor weights. Defaults to regular weight. */
export function TextAlignJustifyIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TextAlignJustifyPaths} {...props} />;
}
