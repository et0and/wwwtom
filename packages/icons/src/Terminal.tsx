 ...
 * Source: @phosphor-icons/core terminal. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TerminalPaths: IconPathData = {
  thin: [
    {
...
/** Terminal icon in six Phosphor weights. Defaults to regular weight. */
export function TerminalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TerminalPaths} {...props} />;
}
