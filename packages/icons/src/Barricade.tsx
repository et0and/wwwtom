 ...
 * Source: @phosphor-icons/core barricade. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BarricadePaths: IconPathData = {
  thin: [
    {
...
/** Barricade icon in six Phosphor weights. Defaults to regular weight. */
export function BarricadeIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BarricadePaths} {...props} />;
}

export const Barricade = BarricadeIcon;
