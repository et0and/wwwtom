 ...
 * Source: @phosphor-icons/core map-pin-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MapPinSimplePaths: IconPathData = {
  thin: [
    {
...
/** MapPinSimple icon in six Phosphor weights. Defaults to regular weight. */
export function MapPinSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MapPinSimplePaths} {...props} />;
}

export const MapPinSimple = MapPinSimpleIcon;
