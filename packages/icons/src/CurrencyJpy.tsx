 ...
 * Source: @phosphor-icons/core currency-jpy. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CurrencyJpyPaths: IconPathData = {
  thin: [
    {
...
/** CurrencyJpy icon in six Phosphor weights. Defaults to regular weight. */
export function CurrencyJpyIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CurrencyJpyPaths} {...props} />;
}

export const CurrencyJpy = CurrencyJpyIcon;
