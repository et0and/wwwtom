 ...
 * Source: @phosphor-icons/core handbag-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const HandbagSimplePaths: IconPathData = {
  thin: [
    {
...
/** HandbagSimple icon in six Phosphor weights. Defaults to regular weight. */
export function HandbagSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={HandbagSimplePaths} {...props} />;
}

export const HandbagSimple = HandbagSimpleIcon;
