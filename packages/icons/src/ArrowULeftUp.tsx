 ...
 * Source: @phosphor-icons/core arrow-u-left-up. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowULeftUpPaths: IconPathData = {
  thin: [
    {
...
/** ArrowULeftUp icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowULeftUpIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowULeftUpPaths} {...props} />;
}

export const ArrowULeftUp = ArrowULeftUpIcon;
