 ...
 * Source: @phosphor-icons/core arrow-u-right-up. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowURightUpPaths: IconPathData = {
  thin: [
    {
...
/** ArrowURightUp icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowURightUpIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowURightUpPaths} {...props} />;
}

export const ArrowURightUp = ArrowURightUpIcon;
