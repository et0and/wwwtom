 ...
 * Source: @phosphor-icons/core faders. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FadersPaths: IconPathData = {
  thin: [
    {
...
/** Faders icon in six Phosphor weights. Defaults to regular weight. */
export function FadersIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FadersPaths} {...props} />;
}

export const Faders = FadersIcon;
