 ...
 * Source: @phosphor-icons/core user-circle. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const UserCirclePaths: IconPathData = {
  thin: [
    {
...
/** UserCircle icon in six Phosphor weights. Defaults to regular weight. */
export function UserCircleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={UserCirclePaths} {...props} />;
}
