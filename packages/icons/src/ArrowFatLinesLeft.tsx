 ...
 * Source: @phosphor-icons/core arrow-fat-lines-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowFatLinesLeftPaths: IconPathData = {
  thin: [
    {
...
/** ArrowFatLinesLeft icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowFatLinesLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowFatLinesLeftPaths} {...props} />;
}

export const ArrowFatLinesLeft = ArrowFatLinesLeftIcon;
