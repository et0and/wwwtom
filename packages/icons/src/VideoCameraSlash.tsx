 ...
 * Source: @phosphor-icons/core video-camera-slash. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const VideoCameraSlashPaths: IconPathData = {
  thin: [
    {
...
/** VideoCameraSlash icon in six Phosphor weights. Defaults to regular weight. */
export function VideoCameraSlashIcon(props: IconProps): JSX.Element {
  return <IconBase paths={VideoCameraSlashPaths} {...props} />;
}

export const VideoCameraSlash = VideoCameraSlashIcon;
