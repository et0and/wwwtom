 ...
 * Source: @phosphor-icons/core sim-card. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SimCardPaths: IconPathData = {
  thin: [
    {
...
/** SimCard icon in six Phosphor weights. Defaults to regular weight. */
export function SimCardIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SimCardPaths} {...props} />;
}

export const SimCard = SimCardIcon;
