 ...
 * Source: @phosphor-icons/core chalkboard. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChalkboardPaths: IconPathData = {
  thin: [
    {
...
/** Chalkboard icon in six Phosphor weights. Defaults to regular weight. */
export function ChalkboardIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChalkboardPaths} {...props} />;
}

export const Chalkboard = ChalkboardIcon;
