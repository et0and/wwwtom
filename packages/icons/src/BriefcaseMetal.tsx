 ...
 * Source: @phosphor-icons/core briefcase-metal. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BriefcaseMetalPaths: IconPathData = {
  thin: [
    {
...
/** BriefcaseMetal icon in six Phosphor weights. Defaults to regular weight. */
export function BriefcaseMetalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BriefcaseMetalPaths} {...props} />;
}

export const BriefcaseMetal = BriefcaseMetalIcon;
