 ...
 * Source: @phosphor-icons/core push-pin-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PushPinSimplePaths: IconPathData = {
  thin: [
    {
...
/** PushPinSimple icon in six Phosphor weights. Defaults to regular weight. */
export function PushPinSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PushPinSimplePaths} {...props} />;
}

export const PushPinSimple = PushPinSimpleIcon;
