 ...
 * Source: @phosphor-icons/core gender-intersex. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const GenderIntersexPaths: IconPathData = {
  thin: [
    {
...
/** GenderIntersex icon in six Phosphor weights. Defaults to regular weight. */
export function GenderIntersexIcon(props: IconProps): JSX.Element {
  return <IconBase paths={GenderIntersexPaths} {...props} />;
}

export const GenderIntersex = GenderIntersexIcon;
