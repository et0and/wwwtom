 ...
 * Source: @phosphor-icons/core subtitles. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SubtitlesPaths: IconPathData = {
  thin: [
    {
...
/** Subtitles icon in six Phosphor weights. Defaults to regular weight. */
export function SubtitlesIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SubtitlesPaths} {...props} />;
}

export const Subtitles = SubtitlesIcon;
