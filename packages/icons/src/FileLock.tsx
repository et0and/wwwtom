 ...
 * Source: @phosphor-icons/core file-lock. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FileLockPaths: IconPathData = {
  thin: [
    {
...
/** FileLock icon in six Phosphor weights. Defaults to regular weight. */
export function FileLockIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FileLockPaths} {...props} />;
}
