 ...
 * Source: @phosphor-icons/core megaphone-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MegaphoneSimplePaths: IconPathData = {
  thin: [
    {
...
/** MegaphoneSimple icon in six Phosphor weights. Defaults to regular weight. */
export function MegaphoneSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MegaphoneSimplePaths} {...props} />;
}

export const MegaphoneSimple = MegaphoneSimpleIcon;
