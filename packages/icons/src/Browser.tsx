 ...
 * Source: @phosphor-icons/core browser. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BrowserPaths: IconPathData = {
  thin: [
    {
...
/** Browser icon in six Phosphor weights. Defaults to regular weight. */
export function BrowserIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BrowserPaths} {...props} />;
}

export const Browser = BrowserIcon;
