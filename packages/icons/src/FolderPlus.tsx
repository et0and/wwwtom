 ...
 * Source: @phosphor-icons/core folder-plus. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FolderPlusPaths: IconPathData = {
  thin: [
    {
...
/** FolderPlus icon in six Phosphor weights. Defaults to regular weight. */
export function FolderPlusIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FolderPlusPaths} {...props} />;
}
