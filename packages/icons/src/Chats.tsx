 ...
 * Source: @phosphor-icons/core chats. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Chats icon in six Phosphor weights. Defaults to regular weight. */
export function ChatsIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChatsPaths} {...props} />;
}

export const Chats = ChatsIcon;
