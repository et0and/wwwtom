 ...
 * Source: @phosphor-icons/core text-indent. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TextIndentPaths: IconPathData = {
  thin: [
    {
...
/** TextIndent icon in six Phosphor weights. Defaults to regular weight. */
export function TextIndentIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TextIndentPaths} {...props} />;
}

export const TextIndent = TextIndentIcon;
