 ...
 * Source: @phosphor-icons/core hourglass-simple-low. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const HourglassSimpleLowPaths: IconPathData = {
  thin: [
    {
...
/** HourglassSimpleLow icon in six Phosphor weights. Defaults to regular weight. */
export function HourglassSimpleLowIcon(props: IconProps): JSX.Element {
  return <IconBase paths={HourglassSimpleLowPaths} {...props} />;
}

export const HourglassSimpleLow = HourglassSimpleLowIcon;
