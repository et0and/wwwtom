 ...
 * Source: @phosphor-icons/core arrow-fat-lines-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowFatLinesRightPaths: IconPathData = {
  thin: [
    {
...
/** ArrowFatLinesRight icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowFatLinesRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowFatLinesRightPaths} {...props} />;
}

export const ArrowFatLinesRight = ArrowFatLinesRightIcon;
