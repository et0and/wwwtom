 ...
 * Source: @phosphor-icons/core microphone. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MicrophonePaths: IconPathData = {
  thin: [
    {
...
/** Microphone icon in six Phosphor weights. Defaults to regular weight. */
export function MicrophoneIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MicrophonePaths} {...props} />;
}

export const Microphone = MicrophoneIcon;
