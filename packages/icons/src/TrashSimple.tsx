 ...
 * Source: @phosphor-icons/core trash-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TrashSimplePaths: IconPathData = {
  thin: [
    {
...
/** TrashSimple icon in six Phosphor weights. Defaults to regular weight. */
export function TrashSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TrashSimplePaths} {...props} />;
}

export const TrashSimple = TrashSimpleIcon;
