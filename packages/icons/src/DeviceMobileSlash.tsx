 ...
 * Source: @phosphor-icons/core device-mobile-slash. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DeviceMobileSlashPaths: IconPathData = {
  thin: [
    {
...
/** DeviceMobileSlash icon in six Phosphor weights. Defaults to regular weight. */
export function DeviceMobileSlashIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DeviceMobileSlashPaths} {...props} />;
}

export const DeviceMobileSlash = DeviceMobileSlashIcon;
