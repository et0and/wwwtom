 ...
 * Source: @phosphor-icons/core not-superset-of. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NotSupersetOfPaths: IconPathData = {
  thin: [
    {
...
/** NotSupersetOf icon in six Phosphor weights. Defaults to regular weight. */
export function NotSupersetOfIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NotSupersetOfPaths} {...props} />;
}

export const NotSupersetOf = NotSupersetOfIcon;
