 ...
 * Source: @phosphor-icons/core chat-centered. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChatCenteredPaths: IconPathData = {
  thin: [
    {
...
/** ChatCentered icon in six Phosphor weights. Defaults to regular weight. */
export function ChatCenteredIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChatCenteredPaths} {...props} />;
}

export const ChatCentered = ChatCenteredIcon;
