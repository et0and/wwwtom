 ...
 * Source: @phosphor-icons/core airplay. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const AirplayPaths: IconPathData = {
  thin: [
    {
...
/** Airplay icon in six Phosphor weights. Defaults to regular weight. */
export function AirplayIcon(props: IconProps): JSX.Element {
  return <IconBase paths={AirplayPaths} {...props} />;
}
