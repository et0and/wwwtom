 ...
 * Source: @phosphor-icons/core folder-lock. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FolderLockPaths: IconPathData = {
  thin: [
    {
...
/** FolderLock icon in six Phosphor weights. Defaults to regular weight. */
export function FolderLockIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FolderLockPaths} {...props} />;
}
