 ...
 * Source: @phosphor-icons/core spinner-gap. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SpinnerGapPaths: IconPathData = {
  thin: [
    {
...
/** SpinnerGap icon in six Phosphor weights. Defaults to regular weight. */
export function SpinnerGapIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SpinnerGapPaths} {...props} />;
}
