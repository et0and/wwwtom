 ...
 * Source: @phosphor-icons/core arrows-out-line-horizontal. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowsOutLineHorizontalPaths: IconPathData = {
  thin: [
    {
...
/** ArrowsOutLineHorizontal icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowsOutLineHorizontalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowsOutLineHorizontalPaths} {...props} />;
}

export const ArrowsOutLineHorizontal = ArrowsOutLineHorizontalIcon;
