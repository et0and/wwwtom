 ...
 * Source: @phosphor-icons/core less-than-or-equal. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const LessThanOrEqualPaths: IconPathData = {
  thin: [
    {
...
/** LessThanOrEqual icon in six Phosphor weights. Defaults to regular weight. */
export function LessThanOrEqualIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LessThanOrEqualPaths} {...props} />;
}

export const LessThanOrEqual = LessThanOrEqualIcon;
