 ...
 * Source: @phosphor-icons/core toggle-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ToggleLeftPaths: IconPathData = {
  thin: [
    {
...
/** ToggleLeft icon in six Phosphor weights. Defaults to regular weight. */
export function ToggleLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ToggleLeftPaths} {...props} />;
}
