 ...
 * Source: @phosphor-icons/core info. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Info icon in six Phosphor weights. Defaults to regular weight. */
export function InfoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={InfoPaths} {...props} />;
}
