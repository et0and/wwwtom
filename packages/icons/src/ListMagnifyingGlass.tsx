 ...
 * Source: @phosphor-icons/core list-magnifying-glass. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ListMagnifyingGlassPaths: IconPathData = {
  thin: [
    {
...
/** ListMagnifyingGlass icon in six Phosphor weights. Defaults to regular weight. */
export function ListMagnifyingGlassIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ListMagnifyingGlassPaths} {...props} />;
}

export const ListMagnifyingGlass = ListMagnifyingGlassIcon;
