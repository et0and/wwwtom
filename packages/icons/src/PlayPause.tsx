 ...
 * Source: @phosphor-icons/core play-pause. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PlayPausePaths: IconPathData = {
  thin: [
    {
...
/** PlayPause icon in six Phosphor weights. Defaults to regular weight. */
export function PlayPauseIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PlayPausePaths} {...props} />;
}

export const PlayPause = PlayPauseIcon;
