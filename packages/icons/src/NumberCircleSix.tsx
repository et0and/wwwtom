 ...
 * Source: @phosphor-icons/core number-circle-six. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NumberCircleSixPaths: IconPathData = {
  thin: [
    {
...
/** NumberCircleSix icon in six Phosphor weights. Defaults to regular weight. */
export function NumberCircleSixIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NumberCircleSixPaths} {...props} />;
}

export const NumberCircleSix = NumberCircleSixIcon;
