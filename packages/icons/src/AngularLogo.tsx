 ...
 * Source: @phosphor-icons/core angular-logo. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const AngularLogoPaths: IconPathData = {
  thin: [
    {
...
/** AngularLogo icon in six Phosphor weights. Defaults to regular weight. */
export function AngularLogoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={AngularLogoPaths} {...props} />;
}

export const AngularLogo = AngularLogoIcon;
