 ...
 * Source: @phosphor-icons/core highlighter-circle. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const HighlighterCirclePaths: IconPathData = {
  thin: [
    {
...
/** HighlighterCircle icon in six Phosphor weights. Defaults to regular weight. */
export function HighlighterCircleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={HighlighterCirclePaths} {...props} />;
}
