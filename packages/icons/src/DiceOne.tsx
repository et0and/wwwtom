 ...
 * Source: @phosphor-icons/core dice-one. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DiceOnePaths: IconPathData = {
  thin: [
    {
...
/** DiceOne icon in six Phosphor weights. Defaults to regular weight. */
export function DiceOneIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DiceOnePaths} {...props} />;
}

export const DiceOne = DiceOneIcon;
