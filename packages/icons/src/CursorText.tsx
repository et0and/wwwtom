 ...
 * Source: @phosphor-icons/core cursor-text. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CursorTextPaths: IconPathData = {
  thin: [
    {
...
/** CursorText icon in six Phosphor weights. Defaults to regular weight. */
export function CursorTextIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CursorTextPaths} {...props} />;
}

export const CursorText = CursorTextIcon;
