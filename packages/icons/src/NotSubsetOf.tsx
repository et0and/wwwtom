 ...
 * Source: @phosphor-icons/core not-subset-of. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NotSubsetOfPaths: IconPathData = {
  thin: [
    {
...
/** NotSubsetOf icon in six Phosphor weights. Defaults to regular weight. */
export function NotSubsetOfIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NotSubsetOfPaths} {...props} />;
}

export const NotSubsetOf = NotSubsetOfIcon;
