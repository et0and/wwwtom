 ...
 * Source: @phosphor-icons/core hand-grabbing. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const HandGrabbingPaths: IconPathData = {
  thin: [
    {
...
/** HandGrabbing icon in six Phosphor weights. Defaults to regular weight. */
export function HandGrabbingIcon(props: IconProps): JSX.Element {
  return <IconBase paths={HandGrabbingPaths} {...props} />;
}

export const HandGrabbing = HandGrabbingIcon;
