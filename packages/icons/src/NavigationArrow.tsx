 ...
 * Source: @phosphor-icons/core navigation-arrow. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NavigationArrowPaths: IconPathData = {
  thin: [
    {
...
/** NavigationArrow icon in six Phosphor weights. Defaults to regular weight. */
export function NavigationArrowIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NavigationArrowPaths} {...props} />;
}

export const NavigationArrow = NavigationArrowIcon;
