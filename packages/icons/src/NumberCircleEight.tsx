 ...
 * Source: @phosphor-icons/core number-circle-eight. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NumberCircleEightPaths: IconPathData = {
  thin: [
    {
...
/** NumberCircleEight icon in six Phosphor weights. Defaults to regular weight. */
export function NumberCircleEightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NumberCircleEightPaths} {...props} />;
}

export const NumberCircleEight = NumberCircleEightIcon;
