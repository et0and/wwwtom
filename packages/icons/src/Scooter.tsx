 ...
 * Source: @phosphor-icons/core scooter. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ScooterPaths: IconPathData = {
  thin: [
    {
...
/** Scooter icon in six Phosphor weights. Defaults to regular weight. */
export function ScooterIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ScooterPaths} {...props} />;
}

export const Scooter = ScooterIcon;
