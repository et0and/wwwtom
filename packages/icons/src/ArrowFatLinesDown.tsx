 ...
 * Source: @phosphor-icons/core arrow-fat-lines-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowFatLinesDownPaths: IconPathData = {
  thin: [
    {
...
/** ArrowFatLinesDown icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowFatLinesDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowFatLinesDownPaths} {...props} />;
}

export const ArrowFatLinesDown = ArrowFatLinesDownIcon;
