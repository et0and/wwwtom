 ...
 * Source: @phosphor-icons/core warehouse. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const WarehousePaths: IconPathData = {
  thin: [
    {
...
/** Warehouse icon in six Phosphor weights. Defaults to regular weight. */
export function WarehouseIcon(props: IconProps): JSX.Element {
  return <IconBase paths={WarehousePaths} {...props} />;
}
