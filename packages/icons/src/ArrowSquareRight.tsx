 ...
 * Source: @phosphor-icons/core arrow-square-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowSquareRightPaths: IconPathData = {
  thin: [
    {
...
/** ArrowSquareRight icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowSquareRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowSquareRightPaths} {...props} />;
}

export const ArrowSquareRight = ArrowSquareRightIcon;
