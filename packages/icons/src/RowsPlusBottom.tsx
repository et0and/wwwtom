 ...
 * Source: @phosphor-icons/core rows-plus-bottom. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const RowsPlusBottomPaths: IconPathData = {
  thin: [
    {
...
/** RowsPlusBottom icon in six Phosphor weights. Defaults to regular weight. */
export function RowsPlusBottomIcon(props: IconProps): JSX.Element {
  return <IconBase paths={RowsPlusBottomPaths} {...props} />;
}

export const RowsPlusBottom = RowsPlusBottomIcon;
