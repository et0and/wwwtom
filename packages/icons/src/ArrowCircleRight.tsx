 ...
 * Source: @phosphor-icons/core arrow-circle-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowCircleRightPaths: IconPathData = {
  thin: [
    {
...
/** ArrowCircleRight icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowCircleRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowCircleRightPaths} {...props} />;
}
