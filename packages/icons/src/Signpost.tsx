 ...
 * Source: @phosphor-icons/core signpost. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SignpostPaths: IconPathData = {
  thin: [
    {
...
/** Signpost icon in six Phosphor weights. Defaults to regular weight. */
export function SignpostIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SignpostPaths} {...props} />;
}
