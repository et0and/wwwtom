 ...
 * Source: @phosphor-icons/core video-camera. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const VideoCameraPaths: IconPathData = {
  thin: [
    {
...
/** VideoCamera icon in six Phosphor weights. Defaults to regular weight. */
export function VideoCameraIcon(props: IconProps): JSX.Element {
  return <IconBase paths={VideoCameraPaths} {...props} />;
}
