 ...
 * Source: @phosphor-icons/core park. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Park icon in six Phosphor weights. Defaults to regular weight. */
export function ParkIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ParkPaths} {...props} />;
}

export const Park = ParkIcon;
