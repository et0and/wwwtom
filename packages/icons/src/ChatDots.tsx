 ...
 * Source: @phosphor-icons/core chat-dots. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChatDotsPaths: IconPathData = {
  thin: [
    {
...
/** ChatDots icon in six Phosphor weights. Defaults to regular weight. */
export function ChatDotsIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChatDotsPaths} {...props} />;
}
