 ...
 * Source: @phosphor-icons/core text-t-slash. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TextTSlashPaths: IconPathData = {
  thin: [
    {
...
/** TextTSlash icon in six Phosphor weights. Defaults to regular weight. */
export function TextTSlashIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TextTSlashPaths} {...props} />;
}

export const TextTSlash = TextTSlashIcon;
