 ...
 * Source: @phosphor-icons/core chat-slash. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChatSlashPaths: IconPathData = {
  thin: [
    {
...
/** ChatSlash icon in six Phosphor weights. Defaults to regular weight. */
export function ChatSlashIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChatSlashPaths} {...props} />;
}

export const ChatSlash = ChatSlashIcon;
