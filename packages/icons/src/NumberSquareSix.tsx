 ...
 * Source: @phosphor-icons/core number-square-six. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NumberSquareSixPaths: IconPathData = {
  thin: [
    {
...
/** NumberSquareSix icon in six Phosphor weights. Defaults to regular weight. */
export function NumberSquareSixIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NumberSquareSixPaths} {...props} />;
}

export const NumberSquareSix = NumberSquareSixIcon;
