 ...
 * Source: @phosphor-icons/core steps. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Steps icon in six Phosphor weights. Defaults to regular weight. */
export function StepsIcon(props: IconProps): JSX.Element {
  return <IconBase paths={StepsPaths} {...props} />;
}

export const Steps = StepsIcon;
