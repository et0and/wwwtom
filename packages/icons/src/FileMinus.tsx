 ...
 * Source: @phosphor-icons/core file-minus. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FileMinusPaths: IconPathData = {
  thin: [
    {
...
/** FileMinus icon in six Phosphor weights. Defaults to regular weight. */
export function FileMinusIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FileMinusPaths} {...props} />;
}
