 ...
 * Source: @phosphor-icons/core sign-in. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SignInPaths: IconPathData = {
  thin: [
    {
...
/** SignIn icon in six Phosphor weights. Defaults to regular weight. */
export function SignInIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SignInPaths} {...props} />;
}

export const SignIn = SignInIcon;
