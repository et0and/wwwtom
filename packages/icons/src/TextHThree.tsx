 ...
 * Source: @phosphor-icons/core text-h-three. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TextHThreePaths: IconPathData = {
  thin: [
    {
...
/** TextHThree icon in six Phosphor weights. Defaults to regular weight. */
export function TextHThreeIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TextHThreePaths} {...props} />;
}

export const TextHThree = TextHThreeIcon;
