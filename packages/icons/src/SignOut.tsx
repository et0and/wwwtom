 ...
 * Source: @phosphor-icons/core sign-out. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SignOutPaths: IconPathData = {
  thin: [
    {
...
/** SignOut icon in six Phosphor weights. Defaults to regular weight. */
export function SignOutIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SignOutPaths} {...props} />;
}

export const SignOut = SignOutIcon;
