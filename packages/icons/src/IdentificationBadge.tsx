 ...
 * Source: @phosphor-icons/core identification-badge. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const IdentificationBadgePaths: IconPathData = {
  thin: [
    {
...
/** IdentificationBadge icon in six Phosphor weights. Defaults to regular weight. */
export function IdentificationBadgeIcon(props: IconProps): JSX.Element {
  return <IconBase paths={IdentificationBadgePaths} {...props} />;
}

export const IdentificationBadge = IdentificationBadgeIcon;
