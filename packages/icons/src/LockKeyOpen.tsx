 ...
 * Source: @phosphor-icons/core lock-key-open. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const LockKeyOpenPaths: IconPathData = {
  thin: [
    {
...
/** LockKeyOpen icon in six Phosphor weights. Defaults to regular weight. */
export function LockKeyOpenIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LockKeyOpenPaths} {...props} />;
}

export const LockKeyOpen = LockKeyOpenIcon;
