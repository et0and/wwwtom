 ...
 * Source: @phosphor-icons/core push-pin-simple-slash. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PushPinSimpleSlashPaths: IconPathData = {
  thin: [
    {
...
/** PushPinSimpleSlash icon in six Phosphor weights. Defaults to regular weight. */
export function PushPinSimpleSlashIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PushPinSimpleSlashPaths} {...props} />;
}

export const PushPinSimpleSlash = PushPinSimpleSlashIcon;
