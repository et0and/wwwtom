 ...
 * Source: @phosphor-icons/core popsicle. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PopsiclePaths: IconPathData = {
  thin: [
    {
...
/** Popsicle icon in six Phosphor weights. Defaults to regular weight. */
export function PopsicleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PopsiclePaths} {...props} />;
}
