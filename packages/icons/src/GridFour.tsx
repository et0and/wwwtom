 ...
 * Source: @phosphor-icons/core grid-four. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const GridFourPaths: IconPathData = {
  thin: [
    {
...
/** GridFour icon in six Phosphor weights. Defaults to regular weight. */
export function GridFourIcon(props: IconProps): JSX.Element {
  return <IconBase paths={GridFourPaths} {...props} />;
}
