 ...
 * Source: @phosphor-icons/core cell-signal-medium. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CellSignalMediumPaths: IconPathData = {
  thin: [
    {
...
/** CellSignalMedium icon in six Phosphor weights. Defaults to regular weight. */
export function CellSignalMediumIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CellSignalMediumPaths} {...props} />;
}

export const CellSignalMedium = CellSignalMediumIcon;
