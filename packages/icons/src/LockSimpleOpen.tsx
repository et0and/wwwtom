 ...
 * Source: @phosphor-icons/core lock-simple-open. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const LockSimpleOpenPaths: IconPathData = {
  thin: [
    {
...
/** LockSimpleOpen icon in six Phosphor weights. Defaults to regular weight. */
export function LockSimpleOpenIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LockSimpleOpenPaths} {...props} />;
}

export const LockSimpleOpen = LockSimpleOpenIcon;
