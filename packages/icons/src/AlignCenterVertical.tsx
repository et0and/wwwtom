 ...
 * Source: @phosphor-icons/core align-center-vertical. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const AlignCenterVerticalPaths: IconPathData = {
  thin: [
    {
...
/** AlignCenterVertical icon in six Phosphor weights. Defaults to regular weight. */
export function AlignCenterVerticalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={AlignCenterVerticalPaths} {...props} />;
}
