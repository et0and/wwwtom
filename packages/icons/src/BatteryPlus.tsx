 ...
 * Source: @phosphor-icons/core battery-plus. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BatteryPlusPaths: IconPathData = {
  thin: [
    {
...
/** BatteryPlus icon in six Phosphor weights. Defaults to regular weight. */
export function BatteryPlusIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BatteryPlusPaths} {...props} />;
}
