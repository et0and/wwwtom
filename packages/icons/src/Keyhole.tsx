 ...
 * Source: @phosphor-icons/core keyhole. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const KeyholePaths: IconPathData = {
  thin: [
    {
...
/** Keyhole icon in six Phosphor weights. Defaults to regular weight. */
export function KeyholeIcon(props: IconProps): JSX.Element {
  return <IconBase paths={KeyholePaths} {...props} />;
}

export const Keyhole = KeyholeIcon;
