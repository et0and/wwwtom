 ...
 * Source: @phosphor-icons/core coda-logo. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CodaLogoPaths: IconPathData = {
  thin: [
    {
...
/** CodaLogo icon in six Phosphor weights. Defaults to regular weight. */
export function CodaLogoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CodaLogoPaths} {...props} />;
}

export const CodaLogo = CodaLogoIcon;
