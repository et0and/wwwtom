 ...
 * Source: @phosphor-icons/core house-line. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const HouseLinePaths: IconPathData = {
  thin: [
    {
...
/** HouseLine icon in six Phosphor weights. Defaults to regular weight. */
export function HouseLineIcon(props: IconProps): JSX.Element {
  return <IconBase paths={HouseLinePaths} {...props} />;
}

export const HouseLine = HouseLineIcon;
