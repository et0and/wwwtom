 ...
 * Source: @phosphor-icons/core avocado. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const AvocadoPaths: IconPathData = {
  thin: [
    {
...
/** Avocado icon in six Phosphor weights. Defaults to regular weight. */
export function AvocadoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={AvocadoPaths} {...props} />;
}

export const Avocado = AvocadoIcon;
