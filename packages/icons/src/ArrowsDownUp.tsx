 ...
 * Source: @phosphor-icons/core arrows-down-up. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowsDownUpPaths: IconPathData = {
  thin: [
    {
...
/** ArrowsDownUp icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowsDownUpIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowsDownUpPaths} {...props} />;
}

export const ArrowsDownUp = ArrowsDownUpIcon;
