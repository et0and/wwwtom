 ...
 * Source: @phosphor-icons/core align-left-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const AlignLeftSimplePaths: IconPathData = {
  thin: [
    {
...
/** AlignLeftSimple icon in six Phosphor weights. Defaults to regular weight. */
export function AlignLeftSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={AlignLeftSimplePaths} {...props} />;
}

export const AlignLeftSimple = AlignLeftSimpleIcon;
