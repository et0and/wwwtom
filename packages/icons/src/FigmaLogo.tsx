 ...
 * Source: @phosphor-icons/core figma-logo. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FigmaLogoPaths: IconPathData = {
  thin: [
    {
...
/** FigmaLogo icon in six Phosphor weights. Defaults to regular weight. */
export function FigmaLogoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FigmaLogoPaths} {...props} />;
}

export const FigmaLogo = FigmaLogoIcon;
