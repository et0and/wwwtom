 ...
 * Source: @phosphor-icons/core arrow-fat-line-up. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowFatLineUpPaths: IconPathData = {
  thin: [
    {
...
/** ArrowFatLineUp icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowFatLineUpIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowFatLineUpPaths} {...props} />;
}
