 ...
 * Source: @phosphor-icons/core stack-minus. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const StackMinusPaths: IconPathData = {
  thin: [
    {
...
/** StackMinus icon in six Phosphor weights. Defaults to regular weight. */
export function StackMinusIcon(props: IconProps): JSX.Element {
  return <IconBase paths={StackMinusPaths} {...props} />;
}

export const StackMinus = StackMinusIcon;
