 ...
 * Source: @phosphor-icons/core medal. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Medal icon in six Phosphor weights. Defaults to regular weight. */
export function MedalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MedalPaths} {...props} />;
}
