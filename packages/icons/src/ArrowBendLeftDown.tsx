 ...
 * Source: @phosphor-icons/core arrow-bend-left-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowBendLeftDownPaths: IconPathData = {
  thin: [
    {
...
/** ArrowBendLeftDown icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowBendLeftDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowBendLeftDownPaths} {...props} />;
}

export const ArrowBendLeftDown = ArrowBendLeftDownIcon;
