 ...
 * Source: @phosphor-icons/core arrow-elbow-down-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowElbowDownRightPaths: IconPathData = {
  thin: [
    {
...
/** ArrowElbowDownRight icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowElbowDownRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowElbowDownRightPaths} {...props} />;
}

export const ArrowElbowDownRight = ArrowElbowDownRightIcon;
