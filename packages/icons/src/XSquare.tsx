 ...
 * Source: @phosphor-icons/core x-square. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const XSquarePaths: IconPathData = {
  thin: [
    {
...
/** XSquare icon in six Phosphor weights. Defaults to regular weight. */
export function XSquareIcon(props: IconProps): JSX.Element {
  return <IconBase paths={XSquarePaths} {...props} />;
}

export const XSquare = XSquareIcon;
