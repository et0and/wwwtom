 ...
 * Source: @phosphor-icons/core skip-back. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SkipBackPaths: IconPathData = {
  thin: [
    {
...
/** SkipBack icon in six Phosphor weights. Defaults to regular weight. */
export function SkipBackIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SkipBackPaths} {...props} />;
}
