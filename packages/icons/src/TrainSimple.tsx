 ...
 * Source: @phosphor-icons/core train-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TrainSimplePaths: IconPathData = {
  thin: [
    {
...
/** TrainSimple icon in six Phosphor weights. Defaults to regular weight. */
export function TrainSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TrainSimplePaths} {...props} />;
}

export const TrainSimple = TrainSimpleIcon;
