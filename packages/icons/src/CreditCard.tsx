 ...
 * Source: @phosphor-icons/core credit-card. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CreditCardPaths: IconPathData = {
  thin: [
    {
...
/** CreditCard icon in six Phosphor weights. Defaults to regular weight. */
export function CreditCardIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CreditCardPaths} {...props} />;
}
