 ...
 * Source: @phosphor-icons/core chat-teardrop-dots. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChatTeardropDotsPaths: IconPathData = {
  thin: [
    {
...
/** ChatTeardropDots icon in six Phosphor weights. Defaults to regular weight. */
export function ChatTeardropDotsIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChatTeardropDotsPaths} {...props} />;
}

export const ChatTeardropDots = ChatTeardropDotsIcon;
