 ...
 * Source: @phosphor-icons/core scan. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Scan icon in six Phosphor weights. Defaults to regular weight. */
export function ScanIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ScanPaths} {...props} />;
}
