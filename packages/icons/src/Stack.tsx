 ...
 * Source: @phosphor-icons/core stack. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Stack icon in six Phosphor weights. Defaults to regular weight. */
export function StackIcon(props: IconProps): JSX.Element {
  return <IconBase paths={StackPaths} {...props} />;
}
