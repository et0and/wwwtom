 ...
 * Source: @phosphor-icons/core arrow-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowLeftPaths: IconPathData = {
  thin: [
    {
...
/** ArrowLeft icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowLeftPaths} {...props} />;
}
