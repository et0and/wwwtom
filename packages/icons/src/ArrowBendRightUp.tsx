 ...
 * Source: @phosphor-icons/core arrow-bend-right-up. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowBendRightUpPaths: IconPathData = {
  thin: [
    {
...
/** ArrowBendRightUp icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowBendRightUpIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowBendRightUpPaths} {...props} />;
}

export const ArrowBendRightUp = ArrowBendRightUpIcon;
