 ...
 * Source: @phosphor-icons/core arrows-left-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowsLeftRightPaths: IconPathData = {
  thin: [
    {
...
/** ArrowsLeftRight icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowsLeftRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowsLeftRightPaths} {...props} />;
}

export const ArrowsLeftRight = ArrowsLeftRightIcon;
