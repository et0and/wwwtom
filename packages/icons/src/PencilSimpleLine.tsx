 ...
 * Source: @phosphor-icons/core pencil-simple-line. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PencilSimpleLinePaths: IconPathData = {
  thin: [
    {
...
/** PencilSimpleLine icon in six Phosphor weights. Defaults to regular weight. */
export function PencilSimpleLineIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PencilSimpleLinePaths} {...props} />;
}

export const PencilSimpleLine = PencilSimpleLineIcon;
