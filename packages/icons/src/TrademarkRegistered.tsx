 ...
 * Source: @phosphor-icons/core trademark-registered. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TrademarkRegisteredPaths: IconPathData = {
  thin: [
    {
...
/** TrademarkRegistered icon in six Phosphor weights. Defaults to regular weight. */
export function TrademarkRegisteredIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TrademarkRegisteredPaths} {...props} />;
}

export const TrademarkRegistered = TrademarkRegisteredIcon;
