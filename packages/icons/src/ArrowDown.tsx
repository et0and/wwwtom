 ...
 * Source: @phosphor-icons/core arrow-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowDownPaths: IconPathData = {
  thin: [
    {
...
/** ArrowDown icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowDownPaths} {...props} />;
}
