 ...
 * Source: @phosphor-icons/core square-split-vertical. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SquareSplitVerticalPaths: IconPathData = {
  thin: [
    {
...
/** SquareSplitVertical icon in six Phosphor weights. Defaults to regular weight. */
export function SquareSplitVerticalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SquareSplitVerticalPaths} {...props} />;
}
