 ...
 * Source: @phosphor-icons/core file-archive. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FileArchivePaths: IconPathData = {
  thin: [
    {
...
/** FileArchive icon in six Phosphor weights. Defaults to regular weight. */
export function FileArchiveIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FileArchivePaths} {...props} />;
}
