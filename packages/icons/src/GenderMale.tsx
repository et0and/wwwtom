 ...
 * Source: @phosphor-icons/core gender-male. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const GenderMalePaths: IconPathData = {
  thin: [
    {
...
/** GenderMale icon in six Phosphor weights. Defaults to regular weight. */
export function GenderMaleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={GenderMalePaths} {...props} />;
}

export const GenderMale = GenderMaleIcon;
