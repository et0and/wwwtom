 ...
 * Source: @phosphor-icons/core vibrate. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const VibratePaths: IconPathData = {
  thin: [
    {
...
/** Vibrate icon in six Phosphor weights. Defaults to regular weight. */
export function VibrateIcon(props: IconProps): JSX.Element {
  return <IconBase paths={VibratePaths} {...props} />;
}
