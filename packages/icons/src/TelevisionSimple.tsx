 ...
 * Source: @phosphor-icons/core television-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TelevisionSimplePaths: IconPathData = {
  thin: [
    {
...
/** TelevisionSimple icon in six Phosphor weights. Defaults to regular weight. */
export function TelevisionSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TelevisionSimplePaths} {...props} />;
}

export const TelevisionSimple = TelevisionSimpleIcon;
