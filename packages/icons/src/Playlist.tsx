 ...
 * Source: @phosphor-icons/core playlist. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PlaylistPaths: IconPathData = {
  thin: [
    {
...
/** Playlist icon in six Phosphor weights. Defaults to regular weight. */
export function PlaylistIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PlaylistPaths} {...props} />;
}

export const Playlist = PlaylistIcon;
