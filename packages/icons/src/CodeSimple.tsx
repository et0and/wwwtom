 ...
 * Source: @phosphor-icons/core code-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CodeSimplePaths: IconPathData = {
  thin: [
    {
...
/** CodeSimple icon in six Phosphor weights. Defaults to regular weight. */
export function CodeSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CodeSimplePaths} {...props} />;
}

export const CodeSimple = CodeSimpleIcon;
