 ...
 * Source: @phosphor-icons/core battery-warning. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BatteryWarningPaths: IconPathData = {
  thin: [
    {
...
/** BatteryWarning icon in six Phosphor weights. Defaults to regular weight. */
export function BatteryWarningIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BatteryWarningPaths} {...props} />;
}
