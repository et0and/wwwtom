 ...
 * Source: @phosphor-icons/core arrow-square-up-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowSquareUpLeftPaths: IconPathData = {
  thin: [
    {
...
/** ArrowSquareUpLeft icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowSquareUpLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowSquareUpLeftPaths} {...props} />;
}

export const ArrowSquareUpLeft = ArrowSquareUpLeftIcon;
