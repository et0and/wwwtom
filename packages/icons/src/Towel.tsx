 ...
 * Source: @phosphor-icons/core towel. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Towel icon in six Phosphor weights. Defaults to regular weight. */
export function TowelIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TowelPaths} {...props} />;
}

export const Towel = TowelIcon;
