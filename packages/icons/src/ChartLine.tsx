 ...
 * Source: @phosphor-icons/core chart-line. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChartLinePaths: IconPathData = {
  thin: [
    {
...
/** ChartLine icon in six Phosphor weights. Defaults to regular weight. */
export function ChartLineIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChartLinePaths} {...props} />;
}
