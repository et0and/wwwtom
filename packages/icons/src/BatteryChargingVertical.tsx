 ...
 * Source: @phosphor-icons/core battery-charging-vertical. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BatteryChargingVerticalPaths: IconPathData = {
  thin: [
    {
...
/** BatteryChargingVertical icon in six Phosphor weights. Defaults to regular weight. */
export function BatteryChargingVerticalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BatteryChargingVerticalPaths} {...props} />;
}

export const BatteryChargingVertical = BatteryChargingVerticalIcon;
