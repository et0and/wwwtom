 ...
 * Source: @phosphor-icons/core calendar-plus. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CalendarPlusPaths: IconPathData = {
  thin: [
    {
...
/** CalendarPlus icon in six Phosphor weights. Defaults to regular weight. */
export function CalendarPlusIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CalendarPlusPaths} {...props} />;
}
