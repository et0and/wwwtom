 ...
 * Source: @phosphor-icons/core paperclip-horizontal. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PaperclipHorizontalPaths: IconPathData = {
  thin: [
    {
...
/** PaperclipHorizontal icon in six Phosphor weights. Defaults to regular weight. */
export function PaperclipHorizontalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PaperclipHorizontalPaths} {...props} />;
}

export const PaperclipHorizontal = PaperclipHorizontalIcon;
