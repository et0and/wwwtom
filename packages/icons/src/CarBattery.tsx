 ...
 * Source: @phosphor-icons/core car-battery. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CarBatteryPaths: IconPathData = {
  thin: [
    {
...
/** CarBattery icon in six Phosphor weights. Defaults to regular weight. */
export function CarBatteryIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CarBatteryPaths} {...props} />;
}

export const CarBattery = CarBatteryIcon;
