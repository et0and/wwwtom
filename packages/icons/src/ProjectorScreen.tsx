 ...
 * Source: @phosphor-icons/core projector-screen. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ProjectorScreenPaths: IconPathData = {
  thin: [
    {
...
/** ProjectorScreen icon in six Phosphor weights. Defaults to regular weight. */
export function ProjectorScreenIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ProjectorScreenPaths} {...props} />;
}

export const ProjectorScreen = ProjectorScreenIcon;
