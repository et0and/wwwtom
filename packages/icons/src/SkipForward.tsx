 ...
 * Source: @phosphor-icons/core skip-forward. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SkipForwardPaths: IconPathData = {
  thin: [
    {
...
/** SkipForward icon in six Phosphor weights. Defaults to regular weight. */
export function SkipForwardIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SkipForwardPaths} {...props} />;
}
