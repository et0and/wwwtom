 ...
 * Source: @phosphor-icons/core notion-logo. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NotionLogoPaths: IconPathData = {
  thin: [
    {
...
/** NotionLogo icon in six Phosphor weights. Defaults to regular weight. */
export function NotionLogoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NotionLogoPaths} {...props} />;
}

export const NotionLogo = NotionLogoIcon;
