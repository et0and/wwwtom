 ...
 * Source: @phosphor-icons/core chat-circle. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChatCirclePaths: IconPathData = {
  thin: [
    {
...
/** ChatCircle icon in six Phosphor weights. Defaults to regular weight. */
export function ChatCircleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChatCirclePaths} {...props} />;
}
