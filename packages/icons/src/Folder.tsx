 ...
 * Source: @phosphor-icons/core folder. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FolderPaths: IconPathData = {
  thin: [
    {
...
/** Folder icon in six Phosphor weights. Defaults to regular weight. */
export function FolderIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FolderPaths} {...props} />;
}
