 ...
 * Source: @phosphor-icons/core plug-charging. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PlugChargingPaths: IconPathData = {
  thin: [
    {
...
/** PlugCharging icon in six Phosphor weights. Defaults to regular weight. */
export function PlugChargingIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PlugChargingPaths} {...props} />;
}

export const PlugCharging = PlugChargingIcon;
