 ...
 * Source: @phosphor-icons/core user-check. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const UserCheckPaths: IconPathData = {
  thin: [
    {
...
/** UserCheck icon in six Phosphor weights. Defaults to regular weight. */
export function UserCheckIcon(props: IconProps): JSX.Element {
  return <IconBase paths={UserCheckPaths} {...props} />;
}
