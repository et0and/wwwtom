 ...
 * Source: @phosphor-icons/core dots-three-outline-vertical. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DotsThreeOutlineVerticalPaths: IconPathData = {
  thin: [
    {
...
/** DotsThreeOutlineVertical icon in six Phosphor weights. Defaults to regular weight. */
export function DotsThreeOutlineVerticalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DotsThreeOutlineVerticalPaths} {...props} />;
}

export const DotsThreeOutlineVertical = DotsThreeOutlineVerticalIcon;
