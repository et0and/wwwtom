 ...
 * Source: @phosphor-icons/core currency-gbp. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CurrencyGbpPaths: IconPathData = {
  thin: [
    {
...
/** CurrencyGbp icon in six Phosphor weights. Defaults to regular weight. */
export function CurrencyGbpIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CurrencyGbpPaths} {...props} />;
}

export const CurrencyGbp = CurrencyGbpIcon;
