 ...
 * Source: @phosphor-icons/core unite-square. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const UniteSquarePaths: IconPathData = {
  thin: [
    {
...
/** UniteSquare icon in six Phosphor weights. Defaults to regular weight. */
export function UniteSquareIcon(props: IconProps): JSX.Element {
  return <IconBase paths={UniteSquarePaths} {...props} />;
}

export const UniteSquare = UniteSquareIcon;
