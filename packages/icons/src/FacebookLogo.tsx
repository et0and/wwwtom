 ...
 * Source: @phosphor-icons/core facebook-logo. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FacebookLogoPaths: IconPathData = {
  thin: [
    {
...
/** FacebookLogo icon in six Phosphor weights. Defaults to regular weight. */
export function FacebookLogoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FacebookLogoPaths} {...props} />;
}

export const FacebookLogo = FacebookLogoIcon;
