 ...
 * Source: @phosphor-icons/core asterisk. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const AsteriskPaths: IconPathData = {
  thin: [
    {
...
/** Asterisk icon in six Phosphor weights. Defaults to regular weight. */
export function AsteriskIcon(props: IconProps): JSX.Element {
  return <IconBase paths={AsteriskPaths} {...props} />;
}
