 ...
 * Source: @phosphor-icons/core car-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CarSimplePaths: IconPathData = {
  thin: [
    {
...
/** CarSimple icon in six Phosphor weights. Defaults to regular weight. */
export function CarSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CarSimplePaths} {...props} />;
}

export const CarSimple = CarSimpleIcon;
