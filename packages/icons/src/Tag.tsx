 ...
 * Source: @phosphor-icons/core tag. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Tag icon in six Phosphor weights. Defaults to regular weight. */
export function TagIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TagPaths} {...props} />;
}
