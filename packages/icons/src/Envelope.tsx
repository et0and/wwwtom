 ...
 * Source: @phosphor-icons/core envelope. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const EnvelopePaths: IconPathData = {
  thin: [
    {
...
/** Envelope icon in six Phosphor weights. Defaults to regular weight. */
export function EnvelopeIcon(props: IconProps): JSX.Element {
  return <IconBase paths={EnvelopePaths} {...props} />;
}
