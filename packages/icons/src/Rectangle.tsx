 ...
 * Source: @phosphor-icons/core rectangle. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const RectanglePaths: IconPathData = {
  thin: [
    {
...
/** Rectangle icon in six Phosphor weights. Defaults to regular weight. */
export function RectangleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={RectanglePaths} {...props} />;
}

export const Rectangle = RectangleIcon;
