 ...
 * Source: @phosphor-icons/core speaker-low. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SpeakerLowPaths: IconPathData = {
  thin: [
    {
...
/** SpeakerLow icon in six Phosphor weights. Defaults to regular weight. */
export function SpeakerLowIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SpeakerLowPaths} {...props} />;
}

export const SpeakerLow = SpeakerLowIcon;
