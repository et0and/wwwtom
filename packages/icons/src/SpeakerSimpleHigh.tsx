 ...
 * Source: @phosphor-icons/core speaker-simple-high. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SpeakerSimpleHighPaths: IconPathData = {
  thin: [
    {
...
/** SpeakerSimpleHigh icon in six Phosphor weights. Defaults to regular weight. */
export function SpeakerSimpleHighIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SpeakerSimpleHighPaths} {...props} />;
}

export const SpeakerSimpleHigh = SpeakerSimpleHighIcon;
