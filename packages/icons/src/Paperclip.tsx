 ...
 * Source: @phosphor-icons/core paperclip. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PaperclipPaths: IconPathData = {
  thin: [
    {
...
/** Paperclip icon in six Phosphor weights. Defaults to regular weight. */
export function PaperclipIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PaperclipPaths} {...props} />;
}
