 ...
 * Source: @phosphor-icons/core trolley. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TrolleyPaths: IconPathData = {
  thin: [
    {
...
/** Trolley icon in six Phosphor weights. Defaults to regular weight. */
export function TrolleyIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TrolleyPaths} {...props} />;
}

export const Trolley = TrolleyIcon;
