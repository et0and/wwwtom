 ...
 * Source: @phosphor-icons/core cell-signal-slash. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CellSignalSlashPaths: IconPathData = {
  thin: [
    {
...
/** CellSignalSlash icon in six Phosphor weights. Defaults to regular weight. */
export function CellSignalSlashIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CellSignalSlashPaths} {...props} />;
}

export const CellSignalSlash = CellSignalSlashIcon;
