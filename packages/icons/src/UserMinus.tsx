 ...
 * Source: @phosphor-icons/core user-minus. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const UserMinusPaths: IconPathData = {
  thin: [
    {
...
/** UserMinus icon in six Phosphor weights. Defaults to regular weight. */
export function UserMinusIcon(props: IconProps): JSX.Element {
  return <IconBase paths={UserMinusPaths} {...props} />;
}
