 ...
 * Source: @phosphor-icons/core radio-button. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const RadioButtonPaths: IconPathData = {
  thin: [
    {
...
/** RadioButton icon in six Phosphor weights. Defaults to regular weight. */
export function RadioButtonIcon(props: IconProps): JSX.Element {
  return <IconBase paths={RadioButtonPaths} {...props} />;
}

export const RadioButton = RadioButtonIcon;
