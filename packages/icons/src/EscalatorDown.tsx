 ...
 * Source: @phosphor-icons/core escalator-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const EscalatorDownPaths: IconPathData = {
  thin: [
    {
...
/** EscalatorDown icon in six Phosphor weights. Defaults to regular weight. */
export function EscalatorDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={EscalatorDownPaths} {...props} />;
}

export const EscalatorDown = EscalatorDownIcon;
