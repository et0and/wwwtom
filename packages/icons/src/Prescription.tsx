 ...
 * Source: @phosphor-icons/core prescription. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PrescriptionPaths: IconPathData = {
  thin: [
    {
...
/** Prescription icon in six Phosphor weights. Defaults to regular weight. */
export function PrescriptionIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PrescriptionPaths} {...props} />;
}
