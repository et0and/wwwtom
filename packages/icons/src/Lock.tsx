 ...
 * Source: @phosphor-icons/core lock. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Lock icon in six Phosphor weights. Defaults to regular weight. */
export function LockIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LockPaths} {...props} />;
}
