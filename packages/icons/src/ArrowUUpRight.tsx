 ...
 * Source: @phosphor-icons/core arrow-u-up-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowUUpRightPaths: IconPathData = {
  thin: [
    {
...
/** ArrowUUpRight icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowUUpRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowUUpRightPaths} {...props} />;
}

export const ArrowUUpRight = ArrowUUpRightIcon;
