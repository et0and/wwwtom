 ...
 * Source: @phosphor-icons/core git-pull-request. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const GitPullRequestPaths: IconPathData = {
  thin: [
    {
...
/** GitPullRequest icon in six Phosphor weights. Defaults to regular weight. */
export function GitPullRequestIcon(props: IconProps): JSX.Element {
  return <IconBase paths={GitPullRequestPaths} {...props} />;
}
