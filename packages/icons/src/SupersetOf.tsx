 ...
 * Source: @phosphor-icons/core superset-of. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SupersetOfPaths: IconPathData = {
  thin: [
    {
...
/** SupersetOf icon in six Phosphor weights. Defaults to regular weight. */
export function SupersetOfIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SupersetOfPaths} {...props} />;
}

export const SupersetOf = SupersetOfIcon;
