 ...
 * Source: @phosphor-icons/core shopping-bag. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ShoppingBagPaths: IconPathData = {
  thin: [
    {
...
/** ShoppingBag icon in six Phosphor weights. Defaults to regular weight. */
export function ShoppingBagIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ShoppingBagPaths} {...props} />;
}
