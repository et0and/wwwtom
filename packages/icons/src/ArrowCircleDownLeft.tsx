 ...
 * Source: @phosphor-icons/core arrow-circle-down-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowCircleDownLeftPaths: IconPathData = {
  thin: [
    {
...
/** ArrowCircleDownLeft icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowCircleDownLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowCircleDownLeftPaths} {...props} />;
}
