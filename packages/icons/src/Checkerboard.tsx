 ...
 * Source: @phosphor-icons/core checkerboard. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CheckerboardPaths: IconPathData = {
  thin: [
    {
...
/** Checkerboard icon in six Phosphor weights. Defaults to regular weight. */
export function CheckerboardIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CheckerboardPaths} {...props} />;
}

export const Checkerboard = CheckerboardIcon;
