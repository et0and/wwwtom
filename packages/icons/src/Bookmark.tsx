 ...
 * Source: @phosphor-icons/core bookmark. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BookmarkPaths: IconPathData = {
  thin: [
    {
...
/** Bookmark icon in six Phosphor weights. Defaults to regular weight. */
export function BookmarkIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BookmarkPaths} {...props} />;
}
