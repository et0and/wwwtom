 ...
 * Source: @phosphor-icons/core gender-transgender. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const GenderTransgenderPaths: IconPathData = {
  thin: [
    {
...
/** GenderTransgender icon in six Phosphor weights. Defaults to regular weight. */
export function GenderTransgenderIcon(props: IconProps): JSX.Element {
  return <IconBase paths={GenderTransgenderPaths} {...props} />;
}

export const GenderTransgender = GenderTransgenderIcon;
