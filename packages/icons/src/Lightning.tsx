 ...
 * Source: @phosphor-icons/core lightning. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const LightningPaths: IconPathData = {
  thin: [
    {
...
/** Lightning icon in six Phosphor weights. Defaults to regular weight. */
export function LightningIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LightningPaths} {...props} />;
}

export const Lightning = LightningIcon;
