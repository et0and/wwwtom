 ...
 * Source: @phosphor-icons/core map-pin-simple-line. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MapPinSimpleLinePaths: IconPathData = {
  thin: [
    {
...
/** MapPinSimpleLine icon in six Phosphor weights. Defaults to regular weight. */
export function MapPinSimpleLineIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MapPinSimpleLinePaths} {...props} />;
}

export const MapPinSimpleLine = MapPinSimpleLineIcon;
