 ...
 * Source: @phosphor-icons/core path. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Path icon in six Phosphor weights. Defaults to regular weight. */
export function PathIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PathPaths} {...props} />;
}
