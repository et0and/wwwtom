 ...
 * Source: @phosphor-icons/core arrow-up. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowUpPaths: IconPathData = {
  thin: [
    {
...
/** ArrowUp icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowUpIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowUpPaths} {...props} />;
}
