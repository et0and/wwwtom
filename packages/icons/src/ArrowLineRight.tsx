 ...
 * Source: @phosphor-icons/core arrow-line-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowLineRightPaths: IconPathData = {
  thin: [
    {
...
/** ArrowLineRight icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowLineRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowLineRightPaths} {...props} />;
}

export const ArrowLineRight = ArrowLineRightIcon;
