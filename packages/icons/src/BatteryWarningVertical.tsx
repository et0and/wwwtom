 ...
 * Source: @phosphor-icons/core battery-warning-vertical. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BatteryWarningVerticalPaths: IconPathData = {
  thin: [
    {
...
/** BatteryWarningVertical icon in six Phosphor weights. Defaults to regular weight. */
export function BatteryWarningVerticalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BatteryWarningVerticalPaths} {...props} />;
}

export const BatteryWarningVertical = BatteryWarningVerticalIcon;
