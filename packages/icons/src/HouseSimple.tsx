 ...
 * Source: @phosphor-icons/core house-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const HouseSimplePaths: IconPathData = {
  thin: [
    {
...
/** HouseSimple icon in six Phosphor weights. Defaults to regular weight. */
export function HouseSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={HouseSimplePaths} {...props} />;
}

export const HouseSimple = HouseSimpleIcon;
