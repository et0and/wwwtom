 ...
 * Source: @phosphor-icons/core chats-teardrop. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChatsTeardropPaths: IconPathData = {
  thin: [
    {
...
/** ChatsTeardrop icon in six Phosphor weights. Defaults to regular weight. */
export function ChatsTeardropIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChatsTeardropPaths} {...props} />;
}

export const ChatsTeardrop = ChatsTeardropIcon;
