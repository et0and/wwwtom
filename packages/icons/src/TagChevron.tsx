 ...
 * Source: @phosphor-icons/core tag-chevron. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TagChevronPaths: IconPathData = {
  thin: [
    {
...
/** TagChevron icon in six Phosphor weights. Defaults to regular weight. */
export function TagChevronIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TagChevronPaths} {...props} />;
}

export const TagChevron = TagChevronIcon;
