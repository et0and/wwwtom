 ...
 * Source: @phosphor-icons/core plus-square. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PlusSquarePaths: IconPathData = {
  thin: [
    {
...
/** PlusSquare icon in six Phosphor weights. Defaults to regular weight. */
export function PlusSquareIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PlusSquarePaths} {...props} />;
}
