 ...
 * Source: @phosphor-icons/core sailboat. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SailboatPaths: IconPathData = {
  thin: [
    {
...
/** Sailboat icon in six Phosphor weights. Defaults to regular weight. */
export function SailboatIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SailboatPaths} {...props} />;
}
