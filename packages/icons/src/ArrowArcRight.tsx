 ...
 * Source: @phosphor-icons/core arrow-arc-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowArcRightPaths: IconPathData = {
  thin: [
    {
...
/** ArrowArcRight icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowArcRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowArcRightPaths} {...props} />;
}

export const ArrowArcRight = ArrowArcRightIcon;
