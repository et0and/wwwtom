 ...
 * Source: @phosphor-icons/core door. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Door icon in six Phosphor weights. Defaults to regular weight. */
export function DoorIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DoorPaths} {...props} />;
}

export const Door = DoorIcon;
