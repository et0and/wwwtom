 ...
 * Source: @phosphor-icons/core number-eight. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NumberEightPaths: IconPathData = {
  thin: [
    {
...
/** NumberEight icon in six Phosphor weights. Defaults to regular weight. */
export function NumberEightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NumberEightPaths} {...props} />;
}

export const NumberEight = NumberEightIcon;
