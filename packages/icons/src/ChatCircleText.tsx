 ...
 * Source: @phosphor-icons/core chat-circle-text. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChatCircleTextPaths: IconPathData = {
  thin: [
    {
...
/** ChatCircleText icon in six Phosphor weights. Defaults to regular weight. */
export function ChatCircleTextIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChatCircleTextPaths} {...props} />;
}

export const ChatCircleText = ChatCircleTextIcon;
