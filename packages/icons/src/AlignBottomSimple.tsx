 ...
 * Source: @phosphor-icons/core align-bottom-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const AlignBottomSimplePaths: IconPathData = {
  thin: [
    {
...
/** AlignBottomSimple icon in six Phosphor weights. Defaults to regular weight. */
export function AlignBottomSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={AlignBottomSimplePaths} {...props} />;
}

export const AlignBottomSimple = AlignBottomSimpleIcon;
