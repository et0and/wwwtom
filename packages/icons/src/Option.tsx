 ...
 * Source: @phosphor-icons/core option. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const OptionPaths: IconPathData = {
  thin: [
    {
...
/** Option icon in six Phosphor weights. Defaults to regular weight. */
export function OptionIcon(props: IconProps): JSX.Element {
  return <IconBase paths={OptionPaths} {...props} />;
}
