 ...
 * Source: @phosphor-icons/core file-image. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FileImagePaths: IconPathData = {
  thin: [
    {
...
/** FileImage icon in six Phosphor weights. Defaults to regular weight. */
export function FileImageIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FileImagePaths} {...props} />;
}
