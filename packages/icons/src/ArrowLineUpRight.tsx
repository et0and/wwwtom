 ...
 * Source: @phosphor-icons/core arrow-line-up-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowLineUpRightPaths: IconPathData = {
  thin: [
    {
...
/** ArrowLineUpRight icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowLineUpRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowLineUpRightPaths} {...props} />;
}

export const ArrowLineUpRight = ArrowLineUpRightIcon;
