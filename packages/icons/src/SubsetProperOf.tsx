 ...
 * Source: @phosphor-icons/core subset-proper-of. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SubsetProperOfPaths: IconPathData = {
  thin: [
    {
...
/** SubsetProperOf icon in six Phosphor weights. Defaults to regular weight. */
export function SubsetProperOfIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SubsetProperOfPaths} {...props} />;
}

export const SubsetProperOf = SubsetProperOfIcon;
