 ...
 * Source: @phosphor-icons/core tag-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TagSimplePaths: IconPathData = {
  thin: [
    {
...
/** TagSimple icon in six Phosphor weights. Defaults to regular weight. */
export function TagSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TagSimplePaths} {...props} />;
}

export const TagSimple = TagSimpleIcon;
