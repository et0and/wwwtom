 ...
 * Source: @phosphor-icons/core warning-diamond. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const WarningDiamondPaths: IconPathData = {
  thin: [
    {
...
/** WarningDiamond icon in six Phosphor weights. Defaults to regular weight. */
export function WarningDiamondIcon(props: IconProps): JSX.Element {
  return <IconBase paths={WarningDiamondPaths} {...props} />;
}
