 ...
 * Source: @phosphor-icons/core chart-bar. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChartBarPaths: IconPathData = {
  thin: [
    {
...
/** ChartBar icon in six Phosphor weights. Defaults to regular weight. */
export function ChartBarIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChartBarPaths} {...props} />;
}
