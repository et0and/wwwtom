 ...
 * Source: @phosphor-icons/core arrow-bend-double-up-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowBendDoubleUpLeftPaths: IconPathData = {
  thin: [
    {
...
/** ArrowBendDoubleUpLeft icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowBendDoubleUpLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowBendDoubleUpLeftPaths} {...props} />;
}

export const ArrowBendDoubleUpLeft = ArrowBendDoubleUpLeftIcon;
