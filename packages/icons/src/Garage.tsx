 ...
 * Source: @phosphor-icons/core garage. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const GaragePaths: IconPathData = {
  thin: [
    {
...
/** Garage icon in six Phosphor weights. Defaults to regular weight. */
export function GarageIcon(props: IconProps): JSX.Element {
  return <IconBase paths={GaragePaths} {...props} />;
}
