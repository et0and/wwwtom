 ...
 * Source: @phosphor-icons/core presentation. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PresentationPaths: IconPathData = {
  thin: [
    {
...
/** Presentation icon in six Phosphor weights. Defaults to regular weight. */
export function PresentationIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PresentationPaths} {...props} />;
}
