 ...
 * Source: @phosphor-icons/core text-h-two. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TextHTwoPaths: IconPathData = {
  thin: [
    {
...
/** TextHTwo icon in six Phosphor weights. Defaults to regular weight. */
export function TextHTwoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TextHTwoPaths} {...props} />;
}

export const TextHTwo = TextHTwoIcon;
