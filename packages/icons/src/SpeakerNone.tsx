 ...
 * Source: @phosphor-icons/core speaker-none. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SpeakerNonePaths: IconPathData = {
  thin: [
    {
...
/** SpeakerNone icon in six Phosphor weights. Defaults to regular weight. */
export function SpeakerNoneIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SpeakerNonePaths} {...props} />;
}

export const SpeakerNone = SpeakerNoneIcon;
