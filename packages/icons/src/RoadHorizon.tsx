 ...
 * Source: @phosphor-icons/core road-horizon. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const RoadHorizonPaths: IconPathData = {
  thin: [
    {
...
/** RoadHorizon icon in six Phosphor weights. Defaults to regular weight. */
export function RoadHorizonIcon(props: IconProps): JSX.Element {
  return <IconBase paths={RoadHorizonPaths} {...props} />;
}

export const RoadHorizon = RoadHorizonIcon;
