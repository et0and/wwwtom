 ...
 * Source: @phosphor-icons/core git-fork. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const GitForkPaths: IconPathData = {
  thin: [
    {
...
/** GitFork icon in six Phosphor weights. Defaults to regular weight. */
export function GitForkIcon(props: IconProps): JSX.Element {
  return <IconBase paths={GitForkPaths} {...props} />;
}
