 ...
 * Source: @phosphor-icons/core user-list. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const UserListPaths: IconPathData = {
  thin: [
    {
...
/** UserList icon in six Phosphor weights. Defaults to regular weight. */
export function UserListIcon(props: IconProps): JSX.Element {
  return <IconBase paths={UserListPaths} {...props} />;
}

export const UserList = UserListIcon;
