 ...
 * Source: @phosphor-icons/core copyleft. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CopyleftPaths: IconPathData = {
  thin: [
    {
...
/** Copyleft icon in six Phosphor weights. Defaults to regular weight. */
export function CopyleftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CopyleftPaths} {...props} />;
}
