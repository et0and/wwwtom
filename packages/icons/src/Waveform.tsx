 ...
 * Source: @phosphor-icons/core waveform. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const WaveformPaths: IconPathData = {
  thin: [
    {
...
/** Waveform icon in six Phosphor weights. Defaults to regular weight. */
export function WaveformIcon(props: IconProps): JSX.Element {
  return <IconBase paths={WaveformPaths} {...props} />;
}

export const Waveform = WaveformIcon;
