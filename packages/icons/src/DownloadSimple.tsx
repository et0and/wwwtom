 ...
 * Source: @phosphor-icons/core download-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DownloadSimplePaths: IconPathData = {
  thin: [
    {
...
/** DownloadSimple icon in six Phosphor weights. Defaults to regular weight. */
export function DownloadSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DownloadSimplePaths} {...props} />;
}
