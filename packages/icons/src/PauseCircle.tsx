 ...
 * Source: @phosphor-icons/core pause-circle. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PauseCirclePaths: IconPathData = {
  thin: [
    {
...
/** PauseCircle icon in six Phosphor weights. Defaults to regular weight. */
export function PauseCircleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PauseCirclePaths} {...props} />;
}
