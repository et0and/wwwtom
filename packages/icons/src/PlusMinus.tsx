 ...
 * Source: @phosphor-icons/core plus-minus. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PlusMinusPaths: IconPathData = {
  thin: [
    {
...
/** PlusMinus icon in six Phosphor weights. Defaults to regular weight. */
export function PlusMinusIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PlusMinusPaths} {...props} />;
}
