 ...
 * Source: @phosphor-icons/core trash. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Trash icon in six Phosphor weights. Defaults to regular weight. */
export function TrashIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TrashPaths} {...props} />;
}
