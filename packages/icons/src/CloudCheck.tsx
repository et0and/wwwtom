 ...
 * Source: @phosphor-icons/core cloud-check. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CloudCheckPaths: IconPathData = {
  thin: [
    {
...
/** CloudCheck icon in six Phosphor weights. Defaults to regular weight. */
export function CloudCheckIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CloudCheckPaths} {...props} />;
}
