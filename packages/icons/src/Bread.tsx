 ...
 * Source: @phosphor-icons/core bread. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Bread icon in six Phosphor weights. Defaults to regular weight. */
export function BreadIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BreadPaths} {...props} />;
}

export const Bread = BreadIcon;
