 ...
 * Source: @phosphor-icons/core caret-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CaretRightPaths: IconPathData = {
  thin: [
    {
...
/** CaretRight icon in six Phosphor weights. Defaults to regular weight. */
export function CaretRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CaretRightPaths} {...props} />;
}
