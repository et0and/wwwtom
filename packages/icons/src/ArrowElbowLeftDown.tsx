 ...
 * Source: @phosphor-icons/core arrow-elbow-left-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowElbowLeftDownPaths: IconPathData = {
  thin: [
    {
...
/** ArrowElbowLeftDown icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowElbowLeftDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowElbowLeftDownPaths} {...props} />;
}

export const ArrowElbowLeftDown = ArrowElbowLeftDownIcon;
