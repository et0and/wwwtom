 ...
 * Source: @phosphor-icons/core caret-circle-up-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CaretCircleUpDownPaths: IconPathData = {
  thin: [
    {
...
/** CaretCircleUpDown icon in six Phosphor weights. Defaults to regular weight. */
export function CaretCircleUpDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CaretCircleUpDownPaths} {...props} />;
}

export const CaretCircleUpDown = CaretCircleUpDownIcon;
