 ...
 * Source: @phosphor-icons/core paragraph. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ParagraphPaths: IconPathData = {
  thin: [
    {
...
/** Paragraph icon in six Phosphor weights. Defaults to regular weight. */
export function ParagraphIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ParagraphPaths} {...props} />;
}
