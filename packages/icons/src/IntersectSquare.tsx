 ...
 * Source: @phosphor-icons/core intersect-square. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const IntersectSquarePaths: IconPathData = {
  thin: [
    {
...
/** IntersectSquare icon in six Phosphor weights. Defaults to regular weight. */
export function IntersectSquareIcon(props: IconProps): JSX.Element {
  return <IconBase paths={IntersectSquarePaths} {...props} />;
}

export const IntersectSquare = IntersectSquareIcon;
