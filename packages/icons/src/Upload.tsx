 ...
 * Source: @phosphor-icons/core upload. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const UploadPaths: IconPathData = {
  thin: [
    {
...
/** Upload icon in six Phosphor weights. Defaults to regular weight. */
export function UploadIcon(props: IconProps): JSX.Element {
  return <IconBase paths={UploadPaths} {...props} />;
}
