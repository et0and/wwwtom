 ...
 * Source: @phosphor-icons/core question. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const QuestionPaths: IconPathData = {
  thin: [
    {
...
/** Question icon in six Phosphor weights. Defaults to regular weight. */
export function QuestionIcon(props: IconProps): JSX.Element {
  return <IconBase paths={QuestionPaths} {...props} />;
}
