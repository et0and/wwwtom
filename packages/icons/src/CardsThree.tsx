 ...
 * Source: @phosphor-icons/core cards-three. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CardsThreePaths: IconPathData = {
  thin: [
    {
...
/** CardsThree icon in six Phosphor weights. Defaults to regular weight. */
export function CardsThreeIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CardsThreePaths} {...props} />;
}

export const CardsThree = CardsThreeIcon;
