 ...
 * Source: @phosphor-icons/core lamp. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Lamp icon in six Phosphor weights. Defaults to regular weight. */
export function LampIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LampPaths} {...props} />;
}
