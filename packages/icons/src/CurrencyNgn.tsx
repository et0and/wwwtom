 ...
 * Source: @phosphor-icons/core currency-ngn. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CurrencyNgnPaths: IconPathData = {
  thin: [
    {
...
/** CurrencyNgn icon in six Phosphor weights. Defaults to regular weight. */
export function CurrencyNgnIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CurrencyNgnPaths} {...props} />;
}

export const CurrencyNgn = CurrencyNgnIcon;
