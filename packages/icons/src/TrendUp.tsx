 ...
 * Source: @phosphor-icons/core trend-up. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TrendUpPaths: IconPathData = {
  thin: [
    {
...
/** TrendUp icon in six Phosphor weights. Defaults to regular weight. */
export function TrendUpIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TrendUpPaths} {...props} />;
}
