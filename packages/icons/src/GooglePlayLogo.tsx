 ...
 * Source: @phosphor-icons/core google-play-logo. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const GooglePlayLogoPaths: IconPathData = {
  thin: [
    {
...
/** GooglePlayLogo icon in six Phosphor weights. Defaults to regular weight. */
export function GooglePlayLogoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={GooglePlayLogoPaths} {...props} />;
}

export const GooglePlayLogo = GooglePlayLogoIcon;
