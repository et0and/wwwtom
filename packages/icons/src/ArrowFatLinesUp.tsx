 ...
 * Source: @phosphor-icons/core arrow-fat-lines-up. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowFatLinesUpPaths: IconPathData = {
  thin: [
    {
...
/** ArrowFatLinesUp icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowFatLinesUpIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowFatLinesUpPaths} {...props} />;
}

export const ArrowFatLinesUp = ArrowFatLinesUpIcon;
