 ...
 * Source: @phosphor-icons/core arrow-down-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowDownLeftPaths: IconPathData = {
  thin: [
    {
...
/** ArrowDownLeft icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowDownLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowDownLeftPaths} {...props} />;
}
