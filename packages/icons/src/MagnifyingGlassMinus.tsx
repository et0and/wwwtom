 ...
 * Source: @phosphor-icons/core magnifying-glass-minus. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MagnifyingGlassMinusPaths: IconPathData = {
  thin: [
    {
...
/** MagnifyingGlassMinus icon in six Phosphor weights. Defaults to regular weight. */
export function MagnifyingGlassMinusIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MagnifyingGlassMinusPaths} {...props} />;
}
