 ...
 * Source: @phosphor-icons/core arrow-circle-up-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowCircleUpRightPaths: IconPathData = {
  thin: [
    {
...
/** ArrowCircleUpRight icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowCircleUpRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowCircleUpRightPaths} {...props} />;
}
