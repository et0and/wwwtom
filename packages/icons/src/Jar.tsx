 ...
 * Source: @phosphor-icons/core jar. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Jar icon in six Phosphor weights. Defaults to regular weight. */
export function JarIcon(props: IconProps): JSX.Element {
  return <IconBase paths={JarPaths} {...props} />;
}

export const Jar = JarIcon;
