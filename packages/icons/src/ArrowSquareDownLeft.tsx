 ...
 * Source: @phosphor-icons/core arrow-square-down-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowSquareDownLeftPaths: IconPathData = {
  thin: [
    {
...
/** ArrowSquareDownLeft icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowSquareDownLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowSquareDownLeftPaths} {...props} />;
}

export const ArrowSquareDownLeft = ArrowSquareDownLeftIcon;
