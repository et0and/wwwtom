 ...
 * Source: @phosphor-icons/core arrow-square-out. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowSquareOutPaths: IconPathData = {
  thin: [
    {
...
/** ArrowSquareOut icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowSquareOutIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowSquareOutPaths} {...props} />;
}
