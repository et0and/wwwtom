 ...
 * Source: @phosphor-icons/core music-notes. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MusicNotesPaths: IconPathData = {
  thin: [
    {
...
/** MusicNotes icon in six Phosphor weights. Defaults to regular weight. */
export function MusicNotesIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MusicNotesPaths} {...props} />;
}

export const MusicNotes = MusicNotesIcon;
