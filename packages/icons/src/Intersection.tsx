 ...
 * Source: @phosphor-icons/core intersection. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const IntersectionPaths: IconPathData = {
  thin: [
    {
...
/** Intersection icon in six Phosphor weights. Defaults to regular weight. */
export function IntersectionIcon(props: IconProps): JSX.Element {
  return <IconBase paths={IntersectionPaths} {...props} />;
}

export const Intersection = IntersectionIcon;
