 ...
 * Source: @phosphor-icons/core keyboard. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const KeyboardPaths: IconPathData = {
  thin: [
    {
...
/** Keyboard icon in six Phosphor weights. Defaults to regular weight. */
export function KeyboardIcon(props: IconProps): JSX.Element {
  return <IconBase paths={KeyboardPaths} {...props} />;
}
