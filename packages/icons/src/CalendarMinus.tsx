 ...
 * Source: @phosphor-icons/core calendar-minus. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CalendarMinusPaths: IconPathData = {
  thin: [
    {
...
/** CalendarMinus icon in six Phosphor weights. Defaults to regular weight. */
export function CalendarMinusIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CalendarMinusPaths} {...props} />;
}
