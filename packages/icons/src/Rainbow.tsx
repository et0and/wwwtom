 ...
 * Source: @phosphor-icons/core rainbow. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const RainbowPaths: IconPathData = {
  thin: [
    {
...
/** Rainbow icon in six Phosphor weights. Defaults to regular weight. */
export function RainbowIcon(props: IconProps): JSX.Element {
  return <IconBase paths={RainbowPaths} {...props} />;
}
