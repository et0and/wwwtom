 ...
 * Source: @phosphor-icons/core circle-half. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CircleHalfPaths: IconPathData = {
  thin: [
    {
...
/** CircleHalf icon in six Phosphor weights. Defaults to regular weight. */
export function CircleHalfIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CircleHalfPaths} {...props} />;
}

export const CircleHalf = CircleHalfIcon;
