 ...
 * Source: @phosphor-icons/core pint-glass. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PintGlassPaths: IconPathData = {
  thin: [
    {
...
/** PintGlass icon in six Phosphor weights. Defaults to regular weight. */
export function PintGlassIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PintGlassPaths} {...props} />;
}

export const PintGlass = PintGlassIcon;
