 ...
 * Source: @phosphor-icons/core slideshow. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SlideshowPaths: IconPathData = {
  thin: [
    {
...
/** Slideshow icon in six Phosphor weights. Defaults to regular weight. */
export function SlideshowIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SlideshowPaths} {...props} />;
}

export const Slideshow = SlideshowIcon;
