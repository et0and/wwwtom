 ...
 * Source: @phosphor-icons/core person-simple-tai-chi. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PersonSimpleTaiChiPaths: IconPathData = {
  thin: [
    {
...
/** PersonSimpleTaiChi icon in six Phosphor weights. Defaults to regular weight. */
export function PersonSimpleTaiChiIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PersonSimpleTaiChiPaths} {...props} />;
}

export const PersonSimpleTaiChi = PersonSimpleTaiChiIcon;
