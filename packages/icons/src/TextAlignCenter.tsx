 ...
 * Source: @phosphor-icons/core text-align-center. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TextAlignCenterPaths: IconPathData = {
  thin: [
    {
...
/** TextAlignCenter icon in six Phosphor weights. Defaults to regular weight. */
export function TextAlignCenterIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TextAlignCenterPaths} {...props} />;
}
