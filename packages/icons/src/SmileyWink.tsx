 ...
 * Source: @phosphor-icons/core smiley-wink. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SmileyWinkPaths: IconPathData = {
  thin: [
    {
...
/** SmileyWink icon in six Phosphor weights. Defaults to regular weight. */
export function SmileyWinkIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SmileyWinkPaths} {...props} />;
}

export const SmileyWink = SmileyWinkIcon;
