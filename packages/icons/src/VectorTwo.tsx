 ...
 * Source: @phosphor-icons/core vector-two. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const VectorTwoPaths: IconPathData = {
  thin: [
    {
...
/** VectorTwo icon in six Phosphor weights. Defaults to regular weight. */
export function VectorTwoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={VectorTwoPaths} {...props} />;
}

export const VectorTwo = VectorTwoIcon;
