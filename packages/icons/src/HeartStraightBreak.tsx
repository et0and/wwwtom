 ...
 * Source: @phosphor-icons/core heart-straight-break. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const HeartStraightBreakPaths: IconPathData = {
  thin: [
    {
...
/** HeartStraightBreak icon in six Phosphor weights. Defaults to regular weight. */
export function HeartStraightBreakIcon(props: IconProps): JSX.Element {
  return <IconBase paths={HeartStraightBreakPaths} {...props} />;
}

export const HeartStraightBreak = HeartStraightBreakIcon;
