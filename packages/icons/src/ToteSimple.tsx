 ...
 * Source: @phosphor-icons/core tote-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ToteSimplePaths: IconPathData = {
  thin: [
    {
...
/** ToteSimple icon in six Phosphor weights. Defaults to regular weight. */
export function ToteSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ToteSimplePaths} {...props} />;
}

export const ToteSimple = ToteSimpleIcon;
