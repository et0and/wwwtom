 ...
 * Source: @phosphor-icons/core flag-pennant. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FlagPennantPaths: IconPathData = {
  thin: [
    {
...
/** FlagPennant icon in six Phosphor weights. Defaults to regular weight. */
export function FlagPennantIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FlagPennantPaths} {...props} />;
}

export const FlagPennant = FlagPennantIcon;
