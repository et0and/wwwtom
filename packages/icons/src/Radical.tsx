 ...
 * Source: @phosphor-icons/core radical. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const RadicalPaths: IconPathData = {
  thin: [
    {
...
/** Radical icon in six Phosphor weights. Defaults to regular weight. */
export function RadicalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={RadicalPaths} {...props} />;
}
