 ...
 * Source: @phosphor-icons/core device-mobile. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DeviceMobilePaths: IconPathData = {
  thin: [
    {
...
/** DeviceMobile icon in six Phosphor weights. Defaults to regular weight. */
export function DeviceMobileIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DeviceMobilePaths} {...props} />;
}

export const DeviceMobile = DeviceMobileIcon;
