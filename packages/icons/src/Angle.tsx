 ...
 * Source: @phosphor-icons/core angle. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Angle icon in six Phosphor weights. Defaults to regular weight. */
export function AngleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={AnglePaths} {...props} />;
}

export const Angle = AngleIcon;
