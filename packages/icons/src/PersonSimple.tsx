 ...
 * Source: @phosphor-icons/core person-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PersonSimplePaths: IconPathData = {
  thin: [
    {
...
/** PersonSimple icon in six Phosphor weights. Defaults to regular weight. */
export function PersonSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PersonSimplePaths} {...props} />;
}

export const PersonSimple = PersonSimpleIcon;
