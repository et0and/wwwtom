 ...
 * Source: @phosphor-icons/core hand-soap. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const HandSoapPaths: IconPathData = {
  thin: [
    {
...
/** HandSoap icon in six Phosphor weights. Defaults to regular weight. */
export function HandSoapIcon(props: IconProps): JSX.Element {
  return <IconBase paths={HandSoapPaths} {...props} />;
}

export const HandSoap = HandSoapIcon;
