 ...
 * Source: @phosphor-icons/core arrow-elbow-down-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowElbowDownLeftPaths: IconPathData = {
  thin: [
    {
...
/** ArrowElbowDownLeft icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowElbowDownLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowElbowDownLeftPaths} {...props} />;
}

export const ArrowElbowDownLeft = ArrowElbowDownLeftIcon;
