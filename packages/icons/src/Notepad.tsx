 ...
 * Source: @phosphor-icons/core notepad. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NotepadPaths: IconPathData = {
  thin: [
    {
...
/** Notepad icon in six Phosphor weights. Defaults to regular weight. */
export function NotepadIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NotepadPaths} {...props} />;
}

export const Notepad = NotepadIcon;
