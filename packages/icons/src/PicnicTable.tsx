 ...
 * Source: @phosphor-icons/core picnic-table. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PicnicTablePaths: IconPathData = {
  thin: [
    {
...
/** PicnicTable icon in six Phosphor weights. Defaults to regular weight. */
export function PicnicTableIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PicnicTablePaths} {...props} />;
}

export const PicnicTable = PicnicTableIcon;
