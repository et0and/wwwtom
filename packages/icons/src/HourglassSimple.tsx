 ...
 * Source: @phosphor-icons/core hourglass-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const HourglassSimplePaths: IconPathData = {
  thin: [
    {
...
/** HourglassSimple icon in six Phosphor weights. Defaults to regular weight. */
export function HourglassSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={HourglassSimplePaths} {...props} />;
}

export const HourglassSimple = HourglassSimpleIcon;
