 ...
 * Source: @phosphor-icons/core wave-sawtooth. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const WaveSawtoothPaths: IconPathData = {
  thin: [
    {
...
/** WaveSawtooth icon in six Phosphor weights. Defaults to regular weight. */
export function WaveSawtoothIcon(props: IconProps): JSX.Element {
  return <IconBase paths={WaveSawtoothPaths} {...props} />;
}

export const WaveSawtooth = WaveSawtoothIcon;
