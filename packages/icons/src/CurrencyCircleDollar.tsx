 ...
 * Source: @phosphor-icons/core currency-circle-dollar. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CurrencyCircleDollarPaths: IconPathData = {
  thin: [
    {
...
/** CurrencyCircleDollar icon in six Phosphor weights. Defaults to regular weight. */
export function CurrencyCircleDollarIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CurrencyCircleDollarPaths} {...props} />;
}

export const CurrencyCircleDollar = CurrencyCircleDollarIcon;
