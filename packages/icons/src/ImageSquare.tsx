 ...
 * Source: @phosphor-icons/core image-square. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ImageSquarePaths: IconPathData = {
  thin: [
    {
...
/** ImageSquare icon in six Phosphor weights. Defaults to regular weight. */
export function ImageSquareIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ImageSquarePaths} {...props} />;
}

export const ImageSquare = ImageSquareIcon;
