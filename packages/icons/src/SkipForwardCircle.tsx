 ...
 * Source: @phosphor-icons/core skip-forward-circle. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SkipForwardCirclePaths: IconPathData = {
  thin: [
    {
...
/** SkipForwardCircle icon in six Phosphor weights. Defaults to regular weight. */
export function SkipForwardCircleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SkipForwardCirclePaths} {...props} />;
}

export const SkipForwardCircle = SkipForwardCircleIcon;
