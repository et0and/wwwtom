 ...
 * Source: @phosphor-icons/core diamond. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DiamondPaths: IconPathData = {
  thin: [
    {
...
/** Diamond icon in six Phosphor weights. Defaults to regular weight. */
export function DiamondIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DiamondPaths} {...props} />;
}
