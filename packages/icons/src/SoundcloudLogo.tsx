 ...
 * Source: @phosphor-icons/core soundcloud-logo. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SoundcloudLogoPaths: IconPathData = {
  thin: [
    {
...
/** SoundcloudLogo icon in six Phosphor weights. Defaults to regular weight. */
export function SoundcloudLogoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SoundcloudLogoPaths} {...props} />;
}

export const SoundcloudLogo = SoundcloudLogoIcon;
