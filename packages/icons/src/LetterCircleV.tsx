 ...
 * Source: @phosphor-icons/core letter-circle-v. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const LetterCircleVPaths: IconPathData = {
  thin: [
    {
...
/** LetterCircleV icon in six Phosphor weights. Defaults to regular weight. */
export function LetterCircleVIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LetterCircleVPaths} {...props} />;
}

export const LetterCircleV = LetterCircleVIcon;
