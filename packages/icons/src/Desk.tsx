 ...
 * Source: @phosphor-icons/core desk. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Desk icon in six Phosphor weights. Defaults to regular weight. */
export function DeskIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DeskPaths} {...props} />;
}

export const Desk = DeskIcon;
