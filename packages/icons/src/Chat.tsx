 ...
 * Source: @phosphor-icons/core chat. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Chat icon in six Phosphor weights. Defaults to regular weight. */
export function ChatIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChatPaths} {...props} />;
}
