 ...
 * Source: @phosphor-icons/core share-network. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ShareNetworkPaths: IconPathData = {
  thin: [
    {
...
/** ShareNetwork icon in six Phosphor weights. Defaults to regular weight. */
export function ShareNetworkIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ShareNetworkPaths} {...props} />;
}
