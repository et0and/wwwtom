 ...
 * Source: @phosphor-icons/core minus-circle. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MinusCirclePaths: IconPathData = {
  thin: [
    {
...
/** MinusCircle icon in six Phosphor weights. Defaults to regular weight. */
export function MinusCircleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MinusCirclePaths} {...props} />;
}
