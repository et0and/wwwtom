 ...
 * Source: @phosphor-icons/core tornado. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TornadoPaths: IconPathData = {
  thin: [
    {
...
/** Tornado icon in six Phosphor weights. Defaults to regular weight. */
export function TornadoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TornadoPaths} {...props} />;
}
