 ...
 * Source: @phosphor-icons/core battery-vertical-low. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BatteryVerticalLowPaths: IconPathData = {
  thin: [
    {
...
/** BatteryVerticalLow icon in six Phosphor weights. Defaults to regular weight. */
export function BatteryVerticalLowIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BatteryVerticalLowPaths} {...props} />;
}

export const BatteryVerticalLow = BatteryVerticalLowIcon;
