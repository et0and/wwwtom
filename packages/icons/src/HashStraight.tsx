 ...
 * Source: @phosphor-icons/core hash-straight. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const HashStraightPaths: IconPathData = {
  thin: [
    {
...
/** HashStraight icon in six Phosphor weights. Defaults to regular weight. */
export function HashStraightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={HashStraightPaths} {...props} />;
}

export const HashStraight = HashStraightIcon;
