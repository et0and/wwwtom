 ...
 * Source: @phosphor-icons/core arrow-fat-up. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowFatUpPaths: IconPathData = {
  thin: [
    {
...
/** ArrowFatUp icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowFatUpIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowFatUpPaths} {...props} />;
}

export const ArrowFatUp = ArrowFatUpIcon;
