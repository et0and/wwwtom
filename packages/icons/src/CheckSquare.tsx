 ...
 * Source: @phosphor-icons/core check-square. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CheckSquarePaths: IconPathData = {
  thin: [
    {
...
/** CheckSquare icon in six Phosphor weights. Defaults to regular weight. */
export function CheckSquareIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CheckSquarePaths} {...props} />;
}
