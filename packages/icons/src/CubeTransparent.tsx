 ...
 * Source: @phosphor-icons/core cube-transparent. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CubeTransparentPaths: IconPathData = {
  thin: [
    {
...
/** CubeTransparent icon in six Phosphor weights. Defaults to regular weight. */
export function CubeTransparentIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CubeTransparentPaths} {...props} />;
}

export const CubeTransparent = CubeTransparentIcon;
