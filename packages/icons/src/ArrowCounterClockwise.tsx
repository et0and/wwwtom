 ...
 * Source: @phosphor-icons/core arrow-counter-clockwise. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowCounterClockwisePaths: IconPathData = {
  thin: [
    {
...
/** ArrowCounterClockwise icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowCounterClockwiseIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowCounterClockwisePaths} {...props} />;
}
