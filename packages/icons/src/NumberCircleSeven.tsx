 ...
 * Source: @phosphor-icons/core number-circle-seven. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NumberCircleSevenPaths: IconPathData = {
  thin: [
    {
...
/** NumberCircleSeven icon in six Phosphor weights. Defaults to regular weight. */
export function NumberCircleSevenIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NumberCircleSevenPaths} {...props} />;
}

export const NumberCircleSeven = NumberCircleSevenIcon;
