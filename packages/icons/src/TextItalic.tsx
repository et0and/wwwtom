 ...
 * Source: @phosphor-icons/core text-italic. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TextItalicPaths: IconPathData = {
  thin: [
    {
...
/** TextItalic icon in six Phosphor weights. Defaults to regular weight. */
export function TextItalicIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TextItalicPaths} {...props} />;
}

export const TextItalic = TextItalicIcon;
