 ...
 * Source: @phosphor-icons/core bed. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Bed icon in six Phosphor weights. Defaults to regular weight. */
export function BedIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BedPaths} {...props} />;
}
