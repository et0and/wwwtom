 ...
 * Source: @phosphor-icons/core file-arrow-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FileArrowDownPaths: IconPathData = {
  thin: [
    {
...
/** FileArrowDown icon in six Phosphor weights. Defaults to regular weight. */
export function FileArrowDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FileArrowDownPaths} {...props} />;
}

export const FileArrowDown = FileArrowDownIcon;
