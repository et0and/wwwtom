 ...
 * Source: @phosphor-icons/core arrows-in-line-horizontal. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowsInLineHorizontalPaths: IconPathData = {
  thin: [
    {
...
/** ArrowsInLineHorizontal icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowsInLineHorizontalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowsInLineHorizontalPaths} {...props} />;
}

export const ArrowsInLineHorizontal = ArrowsInLineHorizontalIcon;
