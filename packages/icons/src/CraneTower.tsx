 ...
 * Source: @phosphor-icons/core crane-tower. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CraneTowerPaths: IconPathData = {
  thin: [
    {
...
/** CraneTower icon in six Phosphor weights. Defaults to regular weight. */
export function CraneTowerIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CraneTowerPaths} {...props} />;
}

export const CraneTower = CraneTowerIcon;
