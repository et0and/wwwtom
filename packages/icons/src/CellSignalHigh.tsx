 ...
 * Source: @phosphor-icons/core cell-signal-high. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CellSignalHighPaths: IconPathData = {
  thin: [
    {
...
/** CellSignalHigh icon in six Phosphor weights. Defaults to regular weight. */
export function CellSignalHighIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CellSignalHighPaths} {...props} />;
}

export const CellSignalHigh = CellSignalHighIcon;
