 ...
 * Source: @phosphor-icons/core barcode. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BarcodePaths: IconPathData = {
  thin: [
    {
...
/** Barcode icon in six Phosphor weights. Defaults to regular weight. */
export function BarcodeIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BarcodePaths} {...props} />;
}
