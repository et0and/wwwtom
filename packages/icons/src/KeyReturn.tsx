 ...
 * Source: @phosphor-icons/core key-return. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const KeyReturnPaths: IconPathData = {
  thin: [
    {
...
/** KeyReturn icon in six Phosphor weights. Defaults to regular weight. */
export function KeyReturnIcon(props: IconProps): JSX.Element {
  return <IconBase paths={KeyReturnPaths} {...props} />;
}

export const KeyReturn = KeyReturnIcon;
