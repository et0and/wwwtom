 ...
 * Source: @phosphor-icons/core skip-back-circle. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SkipBackCirclePaths: IconPathData = {
  thin: [
    {
...
/** SkipBackCircle icon in six Phosphor weights. Defaults to regular weight. */
export function SkipBackCircleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SkipBackCirclePaths} {...props} />;
}

export const SkipBackCircle = SkipBackCircleIcon;
