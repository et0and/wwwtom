 ...
 * Source: @phosphor-icons/core fire-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FireSimplePaths: IconPathData = {
  thin: [
    {
...
/** FireSimple icon in six Phosphor weights. Defaults to regular weight. */
export function FireSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FireSimplePaths} {...props} />;
}

export const FireSimple = FireSimpleIcon;
