 ...
 * Source: @phosphor-icons/core list-bullets. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ListBulletsPaths: IconPathData = {
  thin: [
    {
...
/** ListBullets icon in six Phosphor weights. Defaults to regular weight. */
export function ListBulletsIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ListBulletsPaths} {...props} />;
}

export const ListBullets = ListBulletsIcon;
