 ...
 * Source: @phosphor-icons/core arrow-line-up. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowLineUpPaths: IconPathData = {
  thin: [
    {
...
/** ArrowLineUp icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowLineUpIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowLineUpPaths} {...props} />;
}

export const ArrowLineUp = ArrowLineUpIcon;
