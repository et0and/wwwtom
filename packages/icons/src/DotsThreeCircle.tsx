 ...
 * Source: @phosphor-icons/core dots-three-circle. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DotsThreeCirclePaths: IconPathData = {
  thin: [
    {
...
/** DotsThreeCircle icon in six Phosphor weights. Defaults to regular weight. */
export function DotsThreeCircleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DotsThreeCirclePaths} {...props} />;
}

export const DotsThreeCircle = DotsThreeCircleIcon;
