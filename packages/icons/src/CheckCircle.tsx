 ...
 * Source: @phosphor-icons/core check-circle. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CheckCirclePaths: IconPathData = {
  thin: [
    {
...
/** CheckCircle icon in six Phosphor weights. Defaults to regular weight. */
export function CheckCircleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CheckCirclePaths} {...props} />;
}
