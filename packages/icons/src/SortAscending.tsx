 ...
 * Source: @phosphor-icons/core sort-ascending. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SortAscendingPaths: IconPathData = {
  thin: [
    {
...
/** SortAscending icon in six Phosphor weights. Defaults to regular weight. */
export function SortAscendingIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SortAscendingPaths} {...props} />;
}
