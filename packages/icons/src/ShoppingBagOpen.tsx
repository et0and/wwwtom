 ...
 * Source: @phosphor-icons/core shopping-bag-open. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ShoppingBagOpenPaths: IconPathData = {
  thin: [
    {
...
/** ShoppingBagOpen icon in six Phosphor weights. Defaults to regular weight. */
export function ShoppingBagOpenIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ShoppingBagOpenPaths} {...props} />;
}

export const ShoppingBagOpen = ShoppingBagOpenIcon;
