 ...
 * Source: @phosphor-icons/core arrow-arc-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowArcLeftPaths: IconPathData = {
  thin: [
    {
...
/** ArrowArcLeft icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowArcLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowArcLeftPaths} {...props} />;
}

export const ArrowArcLeft = ArrowArcLeftIcon;
