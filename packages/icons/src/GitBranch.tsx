 ...
 * Source: @phosphor-icons/core git-branch. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const GitBranchPaths: IconPathData = {
  thin: [
    {
...
/** GitBranch icon in six Phosphor weights. Defaults to regular weight. */
export function GitBranchIcon(props: IconProps): JSX.Element {
  return <IconBase paths={GitBranchPaths} {...props} />;
}
