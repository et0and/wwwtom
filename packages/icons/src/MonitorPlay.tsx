 ...
 * Source: @phosphor-icons/core monitor-play. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MonitorPlayPaths: IconPathData = {
  thin: [
    {
...
/** MonitorPlay icon in six Phosphor weights. Defaults to regular weight. */
export function MonitorPlayIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MonitorPlayPaths} {...props} />;
}
