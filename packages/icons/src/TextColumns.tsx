 ...
 * Source: @phosphor-icons/core text-columns. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TextColumnsPaths: IconPathData = {
  thin: [
    {
...
/** TextColumns icon in six Phosphor weights. Defaults to regular weight. */
export function TextColumnsIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TextColumnsPaths} {...props} />;
}

export const TextColumns = TextColumnsIcon;
