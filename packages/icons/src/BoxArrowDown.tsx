 ...
 * Source: @phosphor-icons/core box-arrow-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BoxArrowDownPaths: IconPathData = {
  thin: [
    {
...
/** BoxArrowDown icon in six Phosphor weights. Defaults to regular weight. */
export function BoxArrowDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BoxArrowDownPaths} {...props} />;
}

export const BoxArrowDown = BoxArrowDownIcon;
