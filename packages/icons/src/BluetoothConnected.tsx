 ...
 * Source: @phosphor-icons/core bluetooth-connected. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BluetoothConnectedPaths: IconPathData = {
  thin: [
    {
...
/** BluetoothConnected icon in six Phosphor weights. Defaults to regular weight. */
export function BluetoothConnectedIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BluetoothConnectedPaths} {...props} />;
}
