 ...
 * Source: @phosphor-icons/core caret-circle-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CaretCircleLeftPaths: IconPathData = {
  thin: [
    {
...
/** CaretCircleLeft icon in six Phosphor weights. Defaults to regular weight. */
export function CaretCircleLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CaretCircleLeftPaths} {...props} />;
}
