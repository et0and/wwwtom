 ...
 * Source: @phosphor-icons/core arrow-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowRightPaths: IconPathData = {
  thin: [
    {
...
/** ArrowRight icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowRightPaths} {...props} />;
}
