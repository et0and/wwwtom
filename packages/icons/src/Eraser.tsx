 ...
 * Source: @phosphor-icons/core eraser. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const EraserPaths: IconPathData = {
  thin: [
    {
...
/** Eraser icon in six Phosphor weights. Defaults to regular weight. */
export function EraserIcon(props: IconProps): JSX.Element {
  return <IconBase paths={EraserPaths} {...props} />;
}
