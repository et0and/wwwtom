 ...
 * Source: @phosphor-icons/core letter-circle-h. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const LetterCircleHPaths: IconPathData = {
  thin: [
    {
...
/** LetterCircleH icon in six Phosphor weights. Defaults to regular weight. */
export function LetterCircleHIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LetterCircleHPaths} {...props} />;
}

export const LetterCircleH = LetterCircleHIcon;
