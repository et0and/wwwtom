 ...
 * Source: @phosphor-icons/core alarm. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Alarm icon in six Phosphor weights. Defaults to regular weight. */
export function AlarmIcon(props: IconProps): JSX.Element {
  return <IconBase paths={AlarmPaths} {...props} />;
}
