 ...
 * Source: @phosphor-icons/core chart-line-up. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChartLineUpPaths: IconPathData = {
  thin: [
    {
...
/** ChartLineUp icon in six Phosphor weights. Defaults to regular weight. */
export function ChartLineUpIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChartLineUpPaths} {...props} />;
}

export const ChartLineUp = ChartLineUpIcon;
