 ...
 * Source: @phosphor-icons/core number-two. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NumberTwoPaths: IconPathData = {
  thin: [
    {
...
/** NumberTwo icon in six Phosphor weights. Defaults to regular weight. */
export function NumberTwoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NumberTwoPaths} {...props} />;
}
