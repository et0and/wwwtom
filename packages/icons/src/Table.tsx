 ...
 * Source: @phosphor-icons/core table. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Table icon in six Phosphor weights. Defaults to regular weight. */
export function TableIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TablePaths} {...props} />;
}
