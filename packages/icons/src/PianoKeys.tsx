 ...
 * Source: @phosphor-icons/core piano-keys. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PianoKeysPaths: IconPathData = {
  thin: [
    {
...
/** PianoKeys icon in six Phosphor weights. Defaults to regular weight. */
export function PianoKeysIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PianoKeysPaths} {...props} />;
}

export const PianoKeys = PianoKeysIcon;
