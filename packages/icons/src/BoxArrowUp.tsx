 ...
 * Source: @phosphor-icons/core box-arrow-up. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BoxArrowUpPaths: IconPathData = {
  thin: [
    {
...
/** BoxArrowUp icon in six Phosphor weights. Defaults to regular weight. */
export function BoxArrowUpIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BoxArrowUpPaths} {...props} />;
}

export const BoxArrowUp = BoxArrowUpIcon;
