 ...
 * Source: @phosphor-icons/core dice-three. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DiceThreePaths: IconPathData = {
  thin: [
    {
...
/** DiceThree icon in six Phosphor weights. Defaults to regular weight. */
export function DiceThreeIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DiceThreePaths} {...props} />;
}

export const DiceThree = DiceThreeIcon;
