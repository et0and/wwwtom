 ...
 * Source: @phosphor-icons/core text-superscript. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TextSuperscriptPaths: IconPathData = {
  thin: [
    {
...
/** TextSuperscript icon in six Phosphor weights. Defaults to regular weight. */
export function TextSuperscriptIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TextSuperscriptPaths} {...props} />;
}

export const TextSuperscript = TextSuperscriptIcon;
