 ...
 * Source: @phosphor-icons/core chat-centered-dots. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChatCenteredDotsPaths: IconPathData = {
  thin: [
    {
...
/** ChatCenteredDots icon in six Phosphor weights. Defaults to regular weight. */
export function ChatCenteredDotsIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChatCenteredDotsPaths} {...props} />;
}

export const ChatCenteredDots = ChatCenteredDotsIcon;
