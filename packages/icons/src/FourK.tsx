 ...
 * Source: @phosphor-icons/core four-k. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** FourK icon in six Phosphor weights. Defaults to regular weight. */
export function FourKIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FourKPaths} {...props} />;
}

export const FourK = FourKIcon;
