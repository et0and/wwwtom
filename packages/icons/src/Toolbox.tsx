 ...
 * Source: @phosphor-icons/core toolbox. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ToolboxPaths: IconPathData = {
  thin: [
    {
...
/** Toolbox icon in six Phosphor weights. Defaults to regular weight. */
export function ToolboxIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ToolboxPaths} {...props} />;
}

export const Toolbox = ToolboxIcon;
