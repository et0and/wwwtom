 ...
 * Source: @phosphor-icons/core speaker-hifi. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SpeakerHifiPaths: IconPathData = {
  thin: [
    {
...
/** SpeakerHifi icon in six Phosphor weights. Defaults to regular weight. */
export function SpeakerHifiIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SpeakerHifiPaths} {...props} />;
}

export const SpeakerHifi = SpeakerHifiIcon;
