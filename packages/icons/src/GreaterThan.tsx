 ...
 * Source: @phosphor-icons/core greater-than. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const GreaterThanPaths: IconPathData = {
  thin: [
    {
...
/** GreaterThan icon in six Phosphor weights. Defaults to regular weight. */
export function GreaterThanIcon(props: IconProps): JSX.Element {
  return <IconBase paths={GreaterThanPaths} {...props} />;
}

export const GreaterThan = GreaterThanIcon;
