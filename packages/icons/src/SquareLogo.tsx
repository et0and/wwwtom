 ...
 * Source: @phosphor-icons/core square-logo. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SquareLogoPaths: IconPathData = {
  thin: [
    {
...
/** SquareLogo icon in six Phosphor weights. Defaults to regular weight. */
export function SquareLogoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SquareLogoPaths} {...props} />;
}

export const SquareLogo = SquareLogoIcon;
