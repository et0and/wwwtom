 ...
 * Source: @phosphor-icons/core fire-extinguisher. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FireExtinguisherPaths: IconPathData = {
  thin: [
    {
...
/** FireExtinguisher icon in six Phosphor weights. Defaults to regular weight. */
export function FireExtinguisherIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FireExtinguisherPaths} {...props} />;
}
