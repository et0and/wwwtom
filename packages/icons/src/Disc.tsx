 ...
 * Source: @phosphor-icons/core disc. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Disc icon in six Phosphor weights. Defaults to regular weight. */
export function DiscIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DiscPaths} {...props} />;
}
