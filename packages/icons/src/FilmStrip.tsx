 ...
 * Source: @phosphor-icons/core film-strip. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FilmStripPaths: IconPathData = {
  thin: [
    {
...
/** FilmStrip icon in six Phosphor weights. Defaults to regular weight. */
export function FilmStripIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FilmStripPaths} {...props} />;
}

export const FilmStrip = FilmStripIcon;
