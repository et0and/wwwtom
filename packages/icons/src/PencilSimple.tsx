 ...
 * Source: @phosphor-icons/core pencil-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PencilSimplePaths: IconPathData = {
  thin: [
    {
...
/** PencilSimple icon in six Phosphor weights. Defaults to regular weight. */
export function PencilSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PencilSimplePaths} {...props} />;
}

export const PencilSimple = PencilSimpleIcon;
