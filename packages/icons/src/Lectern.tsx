 ...
 * Source: @phosphor-icons/core lectern. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const LecternPaths: IconPathData = {
  thin: [
    {
...
/** Lectern icon in six Phosphor weights. Defaults to regular weight. */
export function LecternIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LecternPaths} {...props} />;
}
