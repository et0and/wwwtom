 ...
 * Source: @phosphor-icons/core calendar-check. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CalendarCheckPaths: IconPathData = {
  thin: [
    {
...
/** CalendarCheck icon in six Phosphor weights. Defaults to regular weight. */
export function CalendarCheckIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CalendarCheckPaths} {...props} />;
}
