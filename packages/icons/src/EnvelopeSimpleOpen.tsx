 ...
 * Source: @phosphor-icons/core envelope-simple-open. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const EnvelopeSimpleOpenPaths: IconPathData = {
  thin: [
    {
...
/** EnvelopeSimpleOpen icon in six Phosphor weights. Defaults to regular weight. */
export function EnvelopeSimpleOpenIcon(props: IconProps): JSX.Element {
  return <IconBase paths={EnvelopeSimpleOpenPaths} {...props} />;
}

export const EnvelopeSimpleOpen = EnvelopeSimpleOpenIcon;
