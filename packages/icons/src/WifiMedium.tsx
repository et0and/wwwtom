 ...
 * Source: @phosphor-icons/core wifi-medium. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const WifiMediumPaths: IconPathData = {
  thin: [
    {
...
/** WifiMedium icon in six Phosphor weights. Defaults to regular weight. */
export function WifiMediumIcon(props: IconProps): JSX.Element {
  return <IconBase paths={WifiMediumPaths} {...props} />;
}
