 ...
 * Source: @phosphor-icons/core brandy. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BrandyPaths: IconPathData = {
  thin: [
    {
...
/** Brandy icon in six Phosphor weights. Defaults to regular weight. */
export function BrandyIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BrandyPaths} {...props} />;
}

export const Brandy = BrandyIcon;
