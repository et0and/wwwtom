 ...
 * Source: @phosphor-icons/core arrow-elbow-left-up. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowElbowLeftUpPaths: IconPathData = {
  thin: [
    {
...
/** ArrowElbowLeftUp icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowElbowLeftUpIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowElbowLeftUpPaths} {...props} />;
}

export const ArrowElbowLeftUp = ArrowElbowLeftUpIcon;
