 ...
 * Source: @phosphor-icons/core map-trifold. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MapTrifoldPaths: IconPathData = {
  thin: [
    {
...
/** MapTrifold icon in six Phosphor weights. Defaults to regular weight. */
export function MapTrifoldIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MapTrifoldPaths} {...props} />;
}

export const MapTrifold = MapTrifoldIcon;
