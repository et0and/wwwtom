 ...
 * Source: @phosphor-icons/core stairs. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const StairsPaths: IconPathData = {
  thin: [
    {
...
/** Stairs icon in six Phosphor weights. Defaults to regular weight. */
export function StairsIcon(props: IconProps): JSX.Element {
  return <IconBase paths={StairsPaths} {...props} />;
}

export const Stairs = StairsIcon;
