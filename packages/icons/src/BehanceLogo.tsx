 ...
 * Source: @phosphor-icons/core behance-logo. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BehanceLogoPaths: IconPathData = {
  thin: [
    {
...
/** BehanceLogo icon in six Phosphor weights. Defaults to regular weight. */
export function BehanceLogoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BehanceLogoPaths} {...props} />;
}

export const BehanceLogo = BehanceLogoIcon;
