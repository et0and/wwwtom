 ...
 * Source: @phosphor-icons/core user-rectangle. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const UserRectanglePaths: IconPathData = {
  thin: [
    {
...
/** UserRectangle icon in six Phosphor weights. Defaults to regular weight. */
export function UserRectangleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={UserRectanglePaths} {...props} />;
}

export const UserRectangle = UserRectangleIcon;
