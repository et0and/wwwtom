 ...
 * Source: @phosphor-icons/core number-square-eight. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NumberSquareEightPaths: IconPathData = {
  thin: [
    {
...
/** NumberSquareEight icon in six Phosphor weights. Defaults to regular weight. */
export function NumberSquareEightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NumberSquareEightPaths} {...props} />;
}

export const NumberSquareEight = NumberSquareEightIcon;
