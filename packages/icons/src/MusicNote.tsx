 ...
 * Source: @phosphor-icons/core music-note. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MusicNotePaths: IconPathData = {
  thin: [
    {
...
/** MusicNote icon in six Phosphor weights. Defaults to regular weight. */
export function MusicNoteIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MusicNotePaths} {...props} />;
}

export const MusicNote = MusicNoteIcon;
