 ...
 * Source: @phosphor-icons/core percent. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PercentPaths: IconPathData = {
  thin: [
    {
...
/** Percent icon in six Phosphor weights. Defaults to regular weight. */
export function PercentIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PercentPaths} {...props} />;
}
