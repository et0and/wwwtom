 ...
 * Source: @phosphor-icons/core clipboard-text. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ClipboardTextPaths: IconPathData = {
  thin: [
    {
...
/** ClipboardText icon in six Phosphor weights. Defaults to regular weight. */
export function ClipboardTextIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ClipboardTextPaths} {...props} />;
}
