 ...
 * Source: @phosphor-icons/core book-bookmark. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BookBookmarkPaths: IconPathData = {
  thin: [
    {
...
/** BookBookmark icon in six Phosphor weights. Defaults to regular weight. */
export function BookBookmarkIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BookBookmarkPaths} {...props} />;
}

export const BookBookmark = BookBookmarkIcon;
