 ...
 * Source: @phosphor-icons/core subtract-square. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SubtractSquarePaths: IconPathData = {
  thin: [
    {
...
/** SubtractSquare icon in six Phosphor weights. Defaults to regular weight. */
export function SubtractSquareIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SubtractSquarePaths} {...props} />;
}

export const SubtractSquare = SubtractSquareIcon;
