 ...
 * Source: @phosphor-icons/core arrows-split. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowsSplitPaths: IconPathData = {
  thin: [
    {
...
/** ArrowsSplit icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowsSplitIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowsSplitPaths} {...props} />;
}

export const ArrowsSplit = ArrowsSplitIcon;
