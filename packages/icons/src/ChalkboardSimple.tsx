 ...
 * Source: @phosphor-icons/core chalkboard-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChalkboardSimplePaths: IconPathData = {
  thin: [
    {
...
/** ChalkboardSimple icon in six Phosphor weights. Defaults to regular weight. */
export function ChalkboardSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChalkboardSimplePaths} {...props} />;
}

export const ChalkboardSimple = ChalkboardSimpleIcon;
