 ...
 * Source: @phosphor-icons/core letter-circle-p. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const LetterCirclePPaths: IconPathData = {
  thin: [
    {
...
/** LetterCircleP icon in six Phosphor weights. Defaults to regular weight. */
export function LetterCirclePIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LetterCirclePPaths} {...props} />;
}

export const LetterCircleP = LetterCirclePIcon;
