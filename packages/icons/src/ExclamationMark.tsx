 ...
 * Source: @phosphor-icons/core exclamation-mark. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ExclamationMarkPaths: IconPathData = {
  thin: [
    {
...
/** ExclamationMark icon in six Phosphor weights. Defaults to regular weight. */
export function ExclamationMarkIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ExclamationMarkPaths} {...props} />;
}
