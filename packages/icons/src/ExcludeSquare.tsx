 ...
 * Source: @phosphor-icons/core exclude-square. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ExcludeSquarePaths: IconPathData = {
  thin: [
    {
...
/** ExcludeSquare icon in six Phosphor weights. Defaults to regular weight. */
export function ExcludeSquareIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ExcludeSquarePaths} {...props} />;
}

export const ExcludeSquare = ExcludeSquareIcon;
