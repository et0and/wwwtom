 ...
 * Source: @phosphor-icons/core list-plus. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ListPlusPaths: IconPathData = {
  thin: [
    {
...
/** ListPlus icon in six Phosphor weights. Defaults to regular weight. */
export function ListPlusIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ListPlusPaths} {...props} />;
}
