 ...
 * Source: @phosphor-icons/core tree-evergreen. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TreeEvergreenPaths: IconPathData = {
  thin: [
    {
...
/** TreeEvergreen icon in six Phosphor weights. Defaults to regular weight. */
export function TreeEvergreenIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TreeEvergreenPaths} {...props} />;
}

export const TreeEvergreen = TreeEvergreenIcon;
