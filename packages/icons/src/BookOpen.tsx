 ...
 * Source: @phosphor-icons/core book-open. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BookOpenPaths: IconPathData = {
  thin: [
    {
...
/** BookOpen icon in six Phosphor weights. Defaults to regular weight. */
export function BookOpenIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BookOpenPaths} {...props} />;
}
