 ...
 * Source: @phosphor-icons/core film-script. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FilmScriptPaths: IconPathData = {
  thin: [
    {
...
/** FilmScript icon in six Phosphor weights. Defaults to regular weight. */
export function FilmScriptIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FilmScriptPaths} {...props} />;
}

export const FilmScript = FilmScriptIcon;
