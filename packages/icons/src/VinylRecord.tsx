 ...
 * Source: @phosphor-icons/core vinyl-record. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const VinylRecordPaths: IconPathData = {
  thin: [
    {
...
/** VinylRecord icon in six Phosphor weights. Defaults to regular weight. */
export function VinylRecordIcon(props: IconProps): JSX.Element {
  return <IconBase paths={VinylRecordPaths} {...props} />;
}

export const VinylRecord = VinylRecordIcon;
