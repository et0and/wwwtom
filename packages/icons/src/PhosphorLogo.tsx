 ...
 * Source: @phosphor-icons/core phosphor-logo. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PhosphorLogoPaths: IconPathData = {
  thin: [
    {
...
/** PhosphorLogo icon in six Phosphor weights. Defaults to regular weight. */
export function PhosphorLogoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PhosphorLogoPaths} {...props} />;
}

export const PhosphorLogo = PhosphorLogoIcon;
