 ...
 * Source: @phosphor-icons/core check-square-offset. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CheckSquareOffsetPaths: IconPathData = {
  thin: [
    {
...
/** CheckSquareOffset icon in six Phosphor weights. Defaults to regular weight. */
export function CheckSquareOffsetIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CheckSquareOffsetPaths} {...props} />;
}

export const CheckSquareOffset = CheckSquareOffsetIcon;
