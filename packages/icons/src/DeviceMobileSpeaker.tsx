 ...
 * Source: @phosphor-icons/core device-mobile-speaker. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DeviceMobileSpeakerPaths: IconPathData = {
  thin: [
    {
...
/** DeviceMobileSpeaker icon in six Phosphor weights. Defaults to regular weight. */
export function DeviceMobileSpeakerIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DeviceMobileSpeakerPaths} {...props} />;
}

export const DeviceMobileSpeaker = DeviceMobileSpeakerIcon;
