 ...
 * Source: @phosphor-icons/core align-right-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const AlignRightSimplePaths: IconPathData = {
  thin: [
    {
...
/** AlignRightSimple icon in six Phosphor weights. Defaults to regular weight. */
export function AlignRightSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={AlignRightSimplePaths} {...props} />;
}

export const AlignRightSimple = AlignRightSimpleIcon;
