 ...
 * Source: @phosphor-icons/core arrow-fat-line-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowFatLineRightPaths: IconPathData = {
  thin: [
    {
...
/** ArrowFatLineRight icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowFatLineRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowFatLineRightPaths} {...props} />;
}

export const ArrowFatLineRight = ArrowFatLineRightIcon;
