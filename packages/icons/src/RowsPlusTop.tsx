 ...
 * Source: @phosphor-icons/core rows-plus-top. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const RowsPlusTopPaths: IconPathData = {
  thin: [
    {
...
/** RowsPlusTop icon in six Phosphor weights. Defaults to regular weight. */
export function RowsPlusTopIcon(props: IconProps): JSX.Element {
  return <IconBase paths={RowsPlusTopPaths} {...props} />;
}

export const RowsPlusTop = RowsPlusTopIcon;
