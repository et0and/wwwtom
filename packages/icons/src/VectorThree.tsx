 ...
 * Source: @phosphor-icons/core vector-three. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const VectorThreePaths: IconPathData = {
  thin: [
    {
...
/** VectorThree icon in six Phosphor weights. Defaults to regular weight. */
export function VectorThreeIcon(props: IconProps): JSX.Element {
  return <IconBase paths={VectorThreePaths} {...props} />;
}

export const VectorThree = VectorThreeIcon;
