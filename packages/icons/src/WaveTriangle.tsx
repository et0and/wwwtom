 ...
 * Source: @phosphor-icons/core wave-triangle. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const WaveTrianglePaths: IconPathData = {
  thin: [
    {
...
/** WaveTriangle icon in six Phosphor weights. Defaults to regular weight. */
export function WaveTriangleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={WaveTrianglePaths} {...props} />;
}

export const WaveTriangle = WaveTriangleIcon;
