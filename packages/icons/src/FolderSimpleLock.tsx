 ...
 * Source: @phosphor-icons/core folder-simple-lock. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FolderSimpleLockPaths: IconPathData = {
  thin: [
    {
...
/** FolderSimpleLock icon in six Phosphor weights. Defaults to regular weight. */
export function FolderSimpleLockIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FolderSimpleLockPaths} {...props} />;
}

export const FolderSimpleLock = FolderSimpleLockIcon;
