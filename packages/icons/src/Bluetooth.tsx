 ...
 * Source: @phosphor-icons/core bluetooth. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BluetoothPaths: IconPathData = {
  thin: [
    {
...
/** Bluetooth icon in six Phosphor weights. Defaults to regular weight. */
export function BluetoothIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BluetoothPaths} {...props} />;
}
