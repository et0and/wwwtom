 ...
 * Source: @phosphor-icons/core number-five. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NumberFivePaths: IconPathData = {
  thin: [
    {
...
/** NumberFive icon in six Phosphor weights. Defaults to regular weight. */
export function NumberFiveIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NumberFivePaths} {...props} />;
}

export const NumberFive = NumberFiveIcon;
