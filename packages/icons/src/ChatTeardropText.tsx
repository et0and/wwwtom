 ...
 * Source: @phosphor-icons/core chat-teardrop-text. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChatTeardropTextPaths: IconPathData = {
  thin: [
    {
...
/** ChatTeardropText icon in six Phosphor weights. Defaults to regular weight. */
export function ChatTeardropTextIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChatTeardropTextPaths} {...props} />;
}

export const ChatTeardropText = ChatTeardropTextIcon;
