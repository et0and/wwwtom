 ...
 * Source: @phosphor-icons/core bookmarks-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BookmarksSimplePaths: IconPathData = {
  thin: [
    {
...
/** BookmarksSimple icon in six Phosphor weights. Defaults to regular weight. */
export function BookmarksSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BookmarksSimplePaths} {...props} />;
}

export const BookmarksSimple = BookmarksSimpleIcon;
