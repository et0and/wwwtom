 ...
 * Source: @phosphor-icons/core upload-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const UploadSimplePaths: IconPathData = {
  thin: [
    {
...
/** UploadSimple icon in six Phosphor weights. Defaults to regular weight. */
export function UploadSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={UploadSimplePaths} {...props} />;
}
