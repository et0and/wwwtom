 ...
 * Source: @phosphor-icons/core currency-dollar-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CurrencyDollarSimplePaths: IconPathData = {
  thin: [
    {
...
/** CurrencyDollarSimple icon in six Phosphor weights. Defaults to regular weight. */
export function CurrencyDollarSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CurrencyDollarSimplePaths} {...props} />;
}

export const CurrencyDollarSimple = CurrencyDollarSimpleIcon;
