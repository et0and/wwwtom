 ...
 * Source: @phosphor-icons/core ice-cream. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const IceCreamPaths: IconPathData = {
  thin: [
    {
...
/** IceCream icon in six Phosphor weights. Defaults to regular weight. */
export function IceCreamIcon(props: IconProps): JSX.Element {
  return <IconBase paths={IceCreamPaths} {...props} />;
}

export const IceCream = IceCreamIcon;
