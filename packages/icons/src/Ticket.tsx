 ...
 * Source: @phosphor-icons/core ticket. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TicketPaths: IconPathData = {
  thin: [
    {
...
/** Ticket icon in six Phosphor weights. Defaults to regular weight. */
export function TicketIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TicketPaths} {...props} />;
}
