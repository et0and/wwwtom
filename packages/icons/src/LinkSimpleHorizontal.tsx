 ...
 * Source: @phosphor-icons/core link-simple-horizontal. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const LinkSimpleHorizontalPaths: IconPathData = {
  thin: [
    {
...
/** LinkSimpleHorizontal icon in six Phosphor weights. Defaults to regular weight. */
export function LinkSimpleHorizontalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LinkSimpleHorizontalPaths} {...props} />;
}

export const LinkSimpleHorizontal = LinkSimpleHorizontalIcon;
