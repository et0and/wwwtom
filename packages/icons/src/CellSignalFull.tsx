 ...
 * Source: @phosphor-icons/core cell-signal-full. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CellSignalFullPaths: IconPathData = {
  thin: [
    {
...
/** CellSignalFull icon in six Phosphor weights. Defaults to regular weight. */
export function CellSignalFullIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CellSignalFullPaths} {...props} />;
}

export const CellSignalFull = CellSignalFullIcon;
