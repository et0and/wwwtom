 ...
 * Source: @phosphor-icons/core arrow-square-up-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowSquareUpRightPaths: IconPathData = {
  thin: [
    {
...
/** ArrowSquareUpRight icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowSquareUpRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowSquareUpRightPaths} {...props} />;
}

export const ArrowSquareUpRight = ArrowSquareUpRightIcon;
