 ...
 * Source: @phosphor-icons/core export. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ExportPaths: IconPathData = {
  thin: [
    {
...
/** Export icon in six Phosphor weights. Defaults to regular weight. */
export function ExportIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ExportPaths} {...props} />;
}

export const Export = ExportIcon;
