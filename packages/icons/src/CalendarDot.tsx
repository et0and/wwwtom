 ...
 * Source: @phosphor-icons/core calendar-dot. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CalendarDotPaths: IconPathData = {
  thin: [
    {
...
/** CalendarDot icon in six Phosphor weights. Defaults to regular weight. */
export function CalendarDotIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CalendarDotPaths} {...props} />;
}

export const CalendarDot = CalendarDotIcon;
