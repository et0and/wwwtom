 ...
 * Source: @phosphor-icons/core person-simple-circle. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PersonSimpleCirclePaths: IconPathData = {
  thin: [
    {
...
/** PersonSimpleCircle icon in six Phosphor weights. Defaults to regular weight. */
export function PersonSimpleCircleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PersonSimpleCirclePaths} {...props} />;
}

export const PersonSimpleCircle = PersonSimpleCircleIcon;
