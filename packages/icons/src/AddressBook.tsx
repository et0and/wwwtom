 ...
 * Source: @phosphor-icons/core address-book. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const AddressBookPaths: IconPathData = {
  thin: [
    {
...
/** AddressBook icon in six Phosphor weights. Defaults to regular weight. */
export function AddressBookIcon(props: IconProps): JSX.Element {
  return <IconBase paths={AddressBookPaths} {...props} />;
}

export const AddressBook = AddressBookIcon;
