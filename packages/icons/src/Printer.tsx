 ...
 * Source: @phosphor-icons/core printer. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PrinterPaths: IconPathData = {
  thin: [
    {
...
/** Printer icon in six Phosphor weights. Defaults to regular weight. */
export function PrinterIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PrinterPaths} {...props} />;
}
