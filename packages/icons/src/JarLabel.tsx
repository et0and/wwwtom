 ...
 * Source: @phosphor-icons/core jar-label. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const JarLabelPaths: IconPathData = {
  thin: [
    {
...
/** JarLabel icon in six Phosphor weights. Defaults to regular weight. */
export function JarLabelIcon(props: IconProps): JSX.Element {
  return <IconBase paths={JarLabelPaths} {...props} />;
}

export const JarLabel = JarLabelIcon;
