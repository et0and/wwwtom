 ...
 * Source: @phosphor-icons/core funnel. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FunnelPaths: IconPathData = {
  thin: [
    {
...
/** Funnel icon in six Phosphor weights. Defaults to regular weight. */
export function FunnelIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FunnelPaths} {...props} />;
}
