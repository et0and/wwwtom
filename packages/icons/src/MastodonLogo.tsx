 ...
 * Source: @phosphor-icons/core mastodon-logo. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MastodonLogoPaths: IconPathData = {
  thin: [
    {
...
/** MastodonLogo icon in six Phosphor weights. Defaults to regular weight. */
export function MastodonLogoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MastodonLogoPaths} {...props} />;
}

export const MastodonLogo = MastodonLogoIcon;
