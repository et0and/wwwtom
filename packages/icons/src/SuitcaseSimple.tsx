 ...
 * Source: @phosphor-icons/core suitcase-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SuitcaseSimplePaths: IconPathData = {
  thin: [
    {
...
/** SuitcaseSimple icon in six Phosphor weights. Defaults to regular weight. */
export function SuitcaseSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SuitcaseSimplePaths} {...props} />;
}

export const SuitcaseSimple = SuitcaseSimpleIcon;
