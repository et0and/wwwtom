 ...
 * Source: @phosphor-icons/core arrow-u-right-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowURightDownPaths: IconPathData = {
  thin: [
    {
...
/** ArrowURightDown icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowURightDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowURightDownPaths} {...props} />;
}

export const ArrowURightDown = ArrowURightDownIcon;
