 ...
 * Source: @phosphor-icons/core hand-palm. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const HandPalmPaths: IconPathData = {
  thin: [
    {
...
/** HandPalm icon in six Phosphor weights. Defaults to regular weight. */
export function HandPalmIcon(props: IconProps): JSX.Element {
  return <IconBase paths={HandPalmPaths} {...props} />;
}

export const HandPalm = HandPalmIcon;
