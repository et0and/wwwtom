 ...
 * Source: @phosphor-icons/core thumbs-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ThumbsDownPaths: IconPathData = {
  thin: [
    {
...
/** ThumbsDown icon in six Phosphor weights. Defaults to regular weight. */
export function ThumbsDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ThumbsDownPaths} {...props} />;
}
