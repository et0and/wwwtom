 ...
 * Source: @phosphor-icons/core newspaper. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NewspaperPaths: IconPathData = {
  thin: [
    {
...
/** Newspaper icon in six Phosphor weights. Defaults to regular weight. */
export function NewspaperIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NewspaperPaths} {...props} />;
}
