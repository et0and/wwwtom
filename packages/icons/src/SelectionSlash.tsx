 ...
 * Source: @phosphor-icons/core selection-slash. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SelectionSlashPaths: IconPathData = {
  thin: [
    {
...
/** SelectionSlash icon in six Phosphor weights. Defaults to regular weight. */
export function SelectionSlashIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SelectionSlashPaths} {...props} />;
}

export const SelectionSlash = SelectionSlashIcon;
