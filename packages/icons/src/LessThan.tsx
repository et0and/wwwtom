 ...
 * Source: @phosphor-icons/core less-than. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const LessThanPaths: IconPathData = {
  thin: [
    {
...
/** LessThan icon in six Phosphor weights. Defaults to regular weight. */
export function LessThanIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LessThanPaths} {...props} />;
}

export const LessThan = LessThanIcon;
