 ...
 * Source: @phosphor-icons/core cloud-warning. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CloudWarningPaths: IconPathData = {
  thin: [
    {
...
/** CloudWarning icon in six Phosphor weights. Defaults to regular weight. */
export function CloudWarningIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CloudWarningPaths} {...props} />;
}

export const CloudWarning = CloudWarningIcon;
