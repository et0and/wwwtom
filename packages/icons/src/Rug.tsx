 ...
 * Source: @phosphor-icons/core rug. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Rug icon in six Phosphor weights. Defaults to regular weight. */
export function RugIcon(props: IconProps): JSX.Element {
  return <IconBase paths={RugPaths} {...props} />;
}

export const Rug = RugIcon;
