 ...
 * Source: @phosphor-icons/core file-arrow-up. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FileArrowUpPaths: IconPathData = {
  thin: [
    {
...
/** FileArrowUp icon in six Phosphor weights. Defaults to regular weight. */
export function FileArrowUpIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FileArrowUpPaths} {...props} />;
}

export const FileArrowUp = FileArrowUpIcon;
