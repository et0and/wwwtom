 ...
 * Source: @phosphor-icons/core subset-of. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SubsetOfPaths: IconPathData = {
  thin: [
    {
...
/** SubsetOf icon in six Phosphor weights. Defaults to regular weight. */
export function SubsetOfIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SubsetOfPaths} {...props} />;
}

export const SubsetOf = SubsetOfIcon;
