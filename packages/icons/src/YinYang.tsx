 ...
 * Source: @phosphor-icons/core yin-yang. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const YinYangPaths: IconPathData = {
  thin: [
    {
...
/** YinYang icon in six Phosphor weights. Defaults to regular weight. */
export function YinYangIcon(props: IconProps): JSX.Element {
  return <IconBase paths={YinYangPaths} {...props} />;
}

export const YinYang = YinYangIcon;
