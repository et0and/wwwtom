 ...
 * Source: @phosphor-icons/core tent. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Tent icon in six Phosphor weights. Defaults to regular weight. */
export function TentIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TentPaths} {...props} />;
}
