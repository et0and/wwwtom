 ...
 * Source: @phosphor-icons/core code. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Code icon in six Phosphor weights. Defaults to regular weight. */
export function CodeIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CodePaths} {...props} />;
}
