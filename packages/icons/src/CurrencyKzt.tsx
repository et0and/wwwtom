 ...
 * Source: @phosphor-icons/core currency-kzt. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CurrencyKztPaths: IconPathData = {
  thin: [
    {
...
/** CurrencyKzt icon in six Phosphor weights. Defaults to regular weight. */
export function CurrencyKztIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CurrencyKztPaths} {...props} />;
}

export const CurrencyKzt = CurrencyKztIcon;
