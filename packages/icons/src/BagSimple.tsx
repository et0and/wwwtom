 ...
 * Source: @phosphor-icons/core bag-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BagSimplePaths: IconPathData = {
  thin: [
    {
...
/** BagSimple icon in six Phosphor weights. Defaults to regular weight. */
export function BagSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BagSimplePaths} {...props} />;
}

export const BagSimple = BagSimpleIcon;
