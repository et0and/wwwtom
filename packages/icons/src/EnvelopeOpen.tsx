 ...
 * Source: @phosphor-icons/core envelope-open. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const EnvelopeOpenPaths: IconPathData = {
  thin: [
    {
...
/** EnvelopeOpen icon in six Phosphor weights. Defaults to regular weight. */
export function EnvelopeOpenIcon(props: IconProps): JSX.Element {
  return <IconBase paths={EnvelopeOpenPaths} {...props} />;
}

export const EnvelopeOpen = EnvelopeOpenIcon;
