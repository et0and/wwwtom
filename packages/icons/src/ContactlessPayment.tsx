 ...
 * Source: @phosphor-icons/core contactless-payment. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ContactlessPaymentPaths: IconPathData = {
  thin: [
    {
...
/** ContactlessPayment icon in six Phosphor weights. Defaults to regular weight. */
export function ContactlessPaymentIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ContactlessPaymentPaths} {...props} />;
}

export const ContactlessPayment = ContactlessPaymentIcon;
