 ...
 * Source: @phosphor-icons/core folder-minus. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FolderMinusPaths: IconPathData = {
  thin: [
    {
...
/** FolderMinus icon in six Phosphor weights. Defaults to regular weight. */
export function FolderMinusIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FolderMinusPaths} {...props} />;
}
