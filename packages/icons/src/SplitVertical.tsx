 ...
 * Source: @phosphor-icons/core split-vertical. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SplitVerticalPaths: IconPathData = {
  thin: [
    {
...
/** SplitVertical icon in six Phosphor weights. Defaults to regular weight. */
export function SplitVerticalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SplitVerticalPaths} {...props} />;
}

export const SplitVertical = SplitVerticalIcon;
