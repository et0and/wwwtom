 ...
 * Source: @phosphor-icons/core projector-screen-chart. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ProjectorScreenChartPaths: IconPathData = {
  thin: [
    {
...
/** ProjectorScreenChart icon in six Phosphor weights. Defaults to regular weight. */
export function ProjectorScreenChartIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ProjectorScreenChartPaths} {...props} />;
}

export const ProjectorScreenChart = ProjectorScreenChartIcon;
