 ...
 * Source: @phosphor-icons/core ranking. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const RankingPaths: IconPathData = {
  thin: [
    {
...
/** Ranking icon in six Phosphor weights. Defaults to regular weight. */
export function RankingIcon(props: IconProps): JSX.Element {
  return <IconBase paths={RankingPaths} {...props} />;
}

export const Ranking = RankingIcon;
