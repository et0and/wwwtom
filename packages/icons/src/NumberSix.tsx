 ...
 * Source: @phosphor-icons/core number-six. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NumberSixPaths: IconPathData = {
  thin: [
    {
...
/** NumberSix icon in six Phosphor weights. Defaults to regular weight. */
export function NumberSixIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NumberSixPaths} {...props} />;
}

export const NumberSix = NumberSixIcon;
