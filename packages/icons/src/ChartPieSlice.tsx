 ...
 * Source: @phosphor-icons/core chart-pie-slice. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChartPieSlicePaths: IconPathData = {
  thin: [
    {
...
/** ChartPieSlice icon in six Phosphor weights. Defaults to regular weight. */
export function ChartPieSliceIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChartPieSlicePaths} {...props} />;
}
