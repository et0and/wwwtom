 ...
 * Source: @phosphor-icons/core empty. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Empty icon in six Phosphor weights. Defaults to regular weight. */
export function EmptyIcon(props: IconProps): JSX.Element {
  return <IconBase paths={EmptyPaths} {...props} />;
}
