 ...
 * Source: @phosphor-icons/core paper-plane-tilt. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PaperPlaneTiltPaths: IconPathData = {
  thin: [
    {
...
/** PaperPlaneTilt icon in six Phosphor weights. Defaults to regular weight. */
export function PaperPlaneTiltIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PaperPlaneTiltPaths} {...props} />;
}
