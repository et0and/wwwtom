 ...
 * Source: @phosphor-icons/core currency-eth. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CurrencyEthPaths: IconPathData = {
  thin: [
    {
...
/** CurrencyEth icon in six Phosphor weights. Defaults to regular weight. */
export function CurrencyEthIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CurrencyEthPaths} {...props} />;
}

export const CurrencyEth = CurrencyEthIcon;
