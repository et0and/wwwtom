 ...
 * Source: @phosphor-icons/core wave-sine. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const WaveSinePaths: IconPathData = {
  thin: [
    {
...
/** WaveSine icon in six Phosphor weights. Defaults to regular weight. */
export function WaveSineIcon(props: IconProps): JSX.Element {
  return <IconBase paths={WaveSinePaths} {...props} />;
}

export const WaveSine = WaveSineIcon;
