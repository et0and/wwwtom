 ...
 * Source: @phosphor-icons/core battery-plus-vertical. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BatteryPlusVerticalPaths: IconPathData = {
  thin: [
    {
...
/** BatteryPlusVertical icon in six Phosphor weights. Defaults to regular weight. */
export function BatteryPlusVerticalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BatteryPlusVerticalPaths} {...props} />;
}

export const BatteryPlusVertical = BatteryPlusVerticalIcon;
