 ...
 * Source: @phosphor-icons/core check-fat. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CheckFatPaths: IconPathData = {
  thin: [
    {
...
/** CheckFat icon in six Phosphor weights. Defaults to regular weight. */
export function CheckFatIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CheckFatPaths} {...props} />;
}

export const CheckFat = CheckFatIcon;
