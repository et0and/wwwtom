 ...
 * Source: @phosphor-icons/core arrow-circle-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowCircleLeftPaths: IconPathData = {
  thin: [
    {
...
/** ArrowCircleLeft icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowCircleLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowCircleLeftPaths} {...props} />;
}
