 ...
 * Source: @phosphor-icons/core magnifying-glass-plus. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MagnifyingGlassPlusPaths: IconPathData = {
  thin: [
    {
...
/** MagnifyingGlassPlus icon in six Phosphor weights. Defaults to regular weight. */
export function MagnifyingGlassPlusIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MagnifyingGlassPlusPaths} {...props} />;
}
