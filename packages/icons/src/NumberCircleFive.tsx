 ...
 * Source: @phosphor-icons/core number-circle-five. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NumberCircleFivePaths: IconPathData = {
  thin: [
    {
...
/** NumberCircleFive icon in six Phosphor weights. Defaults to regular weight. */
export function NumberCircleFiveIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NumberCircleFivePaths} {...props} />;
}

export const NumberCircleFive = NumberCircleFiveIcon;
