 ...
 * Source: @phosphor-icons/core git-merge. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const GitMergePaths: IconPathData = {
  thin: [
    {
...
/** GitMerge icon in six Phosphor weights. Defaults to regular weight. */
export function GitMergeIcon(props: IconProps): JSX.Element {
  return <IconBase paths={GitMergePaths} {...props} />;
}
