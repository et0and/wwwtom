 ...
 * Source: @phosphor-icons/core mailbox. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MailboxPaths: IconPathData = {
  thin: [
    {
...
/** Mailbox icon in six Phosphor weights. Defaults to regular weight. */
export function MailboxIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MailboxPaths} {...props} />;
}
