 ...
 * Source: @phosphor-icons/core trademark. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TrademarkPaths: IconPathData = {
  thin: [
    {
...
/** Trademark icon in six Phosphor weights. Defaults to regular weight. */
export function TrademarkIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TrademarkPaths} {...props} />;
}

export const Trademark = TrademarkIcon;
