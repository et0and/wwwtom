 ...
 * Source: @phosphor-icons/core play-circle. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PlayCirclePaths: IconPathData = {
  thin: [
    {
...
/** PlayCircle icon in six Phosphor weights. Defaults to regular weight. */
export function PlayCircleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PlayCirclePaths} {...props} />;
}
