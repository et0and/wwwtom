 ...
 * Source: @phosphor-icons/core sketch-logo. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SketchLogoPaths: IconPathData = {
  thin: [
    {
...
/** SketchLogo icon in six Phosphor weights. Defaults to regular weight. */
export function SketchLogoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SketchLogoPaths} {...props} />;
}

export const SketchLogo = SketchLogoIcon;
