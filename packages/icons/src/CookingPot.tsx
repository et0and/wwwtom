 ...
 * Source: @phosphor-icons/core cooking-pot. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CookingPotPaths: IconPathData = {
  thin: [
    {
...
/** CookingPot icon in six Phosphor weights. Defaults to regular weight. */
export function CookingPotIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CookingPotPaths} {...props} />;
}
