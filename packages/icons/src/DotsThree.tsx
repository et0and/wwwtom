 ...
 * Source: @phosphor-icons/core dots-three. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DotsThreePaths: IconPathData = {
  thin: [
    {
...
/** DotsThree icon in six Phosphor weights. Defaults to regular weight. */
export function DotsThreeIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DotsThreePaths} {...props} />;
}

export const DotsThree = DotsThreeIcon;
