 ...
 * Source: @phosphor-icons/core lamp-pendant. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const LampPendantPaths: IconPathData = {
  thin: [
    {
...
/** LampPendant icon in six Phosphor weights. Defaults to regular weight. */
export function LampPendantIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LampPendantPaths} {...props} />;
}

export const LampPendant = LampPendantIcon;
