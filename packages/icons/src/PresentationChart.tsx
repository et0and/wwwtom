 ...
 * Source: @phosphor-icons/core presentation-chart. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PresentationChartPaths: IconPathData = {
  thin: [
    {
...
/** PresentationChart icon in six Phosphor weights. Defaults to regular weight. */
export function PresentationChartIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PresentationChartPaths} {...props} />;
}

export const PresentationChart = PresentationChartIcon;
