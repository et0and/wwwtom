 ...
 * Source: @phosphor-icons/core battery-vertical-medium. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BatteryVerticalMediumPaths: IconPathData = {
  thin: [
    {
...
/** BatteryVerticalMedium icon in six Phosphor weights. Defaults to regular weight. */
export function BatteryVerticalMediumIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BatteryVerticalMediumPaths} {...props} />;
}

export const BatteryVerticalMedium = BatteryVerticalMediumIcon;
