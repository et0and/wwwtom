 ...
 * Source: @phosphor-icons/core clock-counter-clockwise. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ClockCounterClockwisePaths: IconPathData = {
  thin: [
    {
...
/** ClockCounterClockwise icon in six Phosphor weights. Defaults to regular weight. */
export function ClockCounterClockwiseIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ClockCounterClockwisePaths} {...props} />;
}

export const ClockCounterClockwise = ClockCounterClockwiseIcon;
