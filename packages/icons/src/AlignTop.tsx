 ...
 * Source: @phosphor-icons/core align-top. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const AlignTopPaths: IconPathData = {
  thin: [
    {
...
/** AlignTop icon in six Phosphor weights. Defaults to regular weight. */
export function AlignTopIcon(props: IconProps): JSX.Element {
  return <IconBase paths={AlignTopPaths} {...props} />;
}

export const AlignTop = AlignTopIcon;
