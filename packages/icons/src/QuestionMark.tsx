 ...
 * Source: @phosphor-icons/core question-mark. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const QuestionMarkPaths: IconPathData = {
  thin: [
    {
...
/** QuestionMark icon in six Phosphor weights. Defaults to regular weight. */
export function QuestionMarkIcon(props: IconProps): JSX.Element {
  return <IconBase paths={QuestionMarkPaths} {...props} />;
}
