 ...
 * Source: @phosphor-icons/core prohibit-inset. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ProhibitInsetPaths: IconPathData = {
  thin: [
    {
...
/** ProhibitInset icon in six Phosphor weights. Defaults to regular weight. */
export function ProhibitInsetIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ProhibitInsetPaths} {...props} />;
}

export const ProhibitInset = ProhibitInsetIcon;
