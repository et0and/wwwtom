 ...
 * Source: @phosphor-icons/core align-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const AlignLeftPaths: IconPathData = {
  thin: [
    {
...
/** AlignLeft icon in six Phosphor weights. Defaults to regular weight. */
export function AlignLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={AlignLeftPaths} {...props} />;
}
