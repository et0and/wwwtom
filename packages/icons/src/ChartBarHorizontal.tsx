 ...
 * Source: @phosphor-icons/core chart-bar-horizontal. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChartBarHorizontalPaths: IconPathData = {
  thin: [
    {
...
/** ChartBarHorizontal icon in six Phosphor weights. Defaults to regular weight. */
export function ChartBarHorizontalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChartBarHorizontalPaths} {...props} />;
}

export const ChartBarHorizontal = ChartBarHorizontalIcon;
