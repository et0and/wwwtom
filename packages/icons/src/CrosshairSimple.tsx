 ...
 * Source: @phosphor-icons/core crosshair-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CrosshairSimplePaths: IconPathData = {
  thin: [
    {
...
/** CrosshairSimple icon in six Phosphor weights. Defaults to regular weight. */
export function CrosshairSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CrosshairSimplePaths} {...props} />;
}

export const CrosshairSimple = CrosshairSimpleIcon;
