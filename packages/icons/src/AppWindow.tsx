 ...
 * Source: @phosphor-icons/core app-window. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const AppWindowPaths: IconPathData = {
  thin: [
    {
...
/** AppWindow icon in six Phosphor weights. Defaults to regular weight. */
export function AppWindowIcon(props: IconProps): JSX.Element {
  return <IconBase paths={AppWindowPaths} {...props} />;
}
