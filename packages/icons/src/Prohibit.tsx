 ...
 * Source: @phosphor-icons/core prohibit. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ProhibitPaths: IconPathData = {
  thin: [
    {
...
/** Prohibit icon in six Phosphor weights. Defaults to regular weight. */
export function ProhibitIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ProhibitPaths} {...props} />;
}

export const Prohibit = ProhibitIcon;
