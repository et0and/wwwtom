 ...
 * Source: @phosphor-icons/core arrow-fat-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowFatDownPaths: IconPathData = {
  thin: [
    {
...
/** ArrowFatDown icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowFatDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowFatDownPaths} {...props} />;
}

export const ArrowFatDown = ArrowFatDownIcon;
