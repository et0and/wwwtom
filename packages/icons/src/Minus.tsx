 ...
 * Source: @phosphor-icons/core minus. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Minus icon in six Phosphor weights. Defaults to regular weight. */
export function MinusIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MinusPaths} {...props} />;
}
