 ...
 * Source: @phosphor-icons/core smiley-sad. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SmileySadPaths: IconPathData = {
  thin: [
    {
...
/** SmileySad icon in six Phosphor weights. Defaults to regular weight. */
export function SmileySadIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SmileySadPaths} {...props} />;
}

export const SmileySad = SmileySadIcon;
