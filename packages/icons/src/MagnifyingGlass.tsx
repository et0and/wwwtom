 ...
 * Source: @phosphor-icons/core magnifying-glass. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MagnifyingGlassPaths: IconPathData = {
  thin: [
    {
...
/** MagnifyingGlass icon in six Phosphor weights. Defaults to regular weight. */
export function MagnifyingGlassIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MagnifyingGlassPaths} {...props} />;
}
