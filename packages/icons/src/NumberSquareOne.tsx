 ...
 * Source: @phosphor-icons/core number-square-one. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NumberSquareOnePaths: IconPathData = {
  thin: [
    {
...
/** NumberSquareOne icon in six Phosphor weights. Defaults to regular weight. */
export function NumberSquareOneIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NumberSquareOnePaths} {...props} />;
}

export const NumberSquareOne = NumberSquareOneIcon;
