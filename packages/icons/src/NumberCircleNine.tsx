 ...
 * Source: @phosphor-icons/core number-circle-nine. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NumberCircleNinePaths: IconPathData = {
  thin: [
    {
...
/** NumberCircleNine icon in six Phosphor weights. Defaults to regular weight. */
export function NumberCircleNineIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NumberCircleNinePaths} {...props} />;
}

export const NumberCircleNine = NumberCircleNineIcon;
