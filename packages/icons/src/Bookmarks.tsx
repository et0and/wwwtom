 ...
 * Source: @phosphor-icons/core bookmarks. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BookmarksPaths: IconPathData = {
  thin: [
    {
...
/** Bookmarks icon in six Phosphor weights. Defaults to regular weight. */
export function BookmarksIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BookmarksPaths} {...props} />;
}

export const Bookmarks = BookmarksIcon;
