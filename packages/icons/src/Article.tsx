 ...
 * Source: @phosphor-icons/core article. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArticlePaths: IconPathData = {
  thin: [
    {
...
/** Article icon in six Phosphor weights. Defaults to regular weight. */
export function ArticleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArticlePaths} {...props} />;
}
