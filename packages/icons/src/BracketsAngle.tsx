 ...
 * Source: @phosphor-icons/core brackets-angle. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BracketsAnglePaths: IconPathData = {
  thin: [
    {
...
/** BracketsAngle icon in six Phosphor weights. Defaults to regular weight. */
export function BracketsAngleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BracketsAnglePaths} {...props} />;
}

export const BracketsAngle = BracketsAngleIcon;
