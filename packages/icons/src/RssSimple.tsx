 ...
 * Source: @phosphor-icons/core rss-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const RssSimplePaths: IconPathData = {
  thin: [
    {
...
/** RssSimple icon in six Phosphor weights. Defaults to regular weight. */
export function RssSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={RssSimplePaths} {...props} />;
}

export const RssSimple = RssSimpleIcon;
