 ...
 * Source: @phosphor-icons/core flip-horizontal. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FlipHorizontalPaths: IconPathData = {
  thin: [
    {
...
/** FlipHorizontal icon in six Phosphor weights. Defaults to regular weight. */
export function FlipHorizontalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FlipHorizontalPaths} {...props} />;
}
