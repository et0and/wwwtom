 ...
 * Source: @phosphor-icons/core arrow-line-up-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowLineUpLeftPaths: IconPathData = {
  thin: [
    {
...
/** ArrowLineUpLeft icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowLineUpLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowLineUpLeftPaths} {...props} />;
}

export const ArrowLineUpLeft = ArrowLineUpLeftIcon;
