 ...
 * Source: @phosphor-icons/core align-center-horizontal. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const AlignCenterHorizontalPaths: IconPathData = {
  thin: [
    {
...
/** AlignCenterHorizontal icon in six Phosphor weights. Defaults to regular weight. */
export function AlignCenterHorizontalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={AlignCenterHorizontalPaths} {...props} />;
}
