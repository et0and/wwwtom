 ...
 * Source: @phosphor-icons/core crop. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Crop icon in six Phosphor weights. Defaults to regular weight. */
export function CropIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CropPaths} {...props} />;
}
