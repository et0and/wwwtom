 ...
 * Source: @phosphor-icons/core caret-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CaretLeftPaths: IconPathData = {
  thin: [
    {
...
/** CaretLeft icon in six Phosphor weights. Defaults to regular weight. */
export function CaretLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CaretLeftPaths} {...props} />;
}
