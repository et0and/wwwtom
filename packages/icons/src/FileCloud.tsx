 ...
 * Source: @phosphor-icons/core file-cloud. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FileCloudPaths: IconPathData = {
  thin: [
    {
...
/** FileCloud icon in six Phosphor weights. Defaults to regular weight. */
export function FileCloudIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FileCloudPaths} {...props} />;
}

export const FileCloud = FileCloudIcon;
