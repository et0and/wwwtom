 ...
 * Source: @phosphor-icons/core microscope. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MicroscopePaths: IconPathData = {
  thin: [
    {
...
/** Microscope icon in six Phosphor weights. Defaults to regular weight. */
export function MicroscopeIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MicroscopePaths} {...props} />;
}
