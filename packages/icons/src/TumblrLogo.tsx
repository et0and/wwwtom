 ...
 * Source: @phosphor-icons/core tumblr-logo. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TumblrLogoPaths: IconPathData = {
  thin: [
    {
...
/** TumblrLogo icon in six Phosphor weights. Defaults to regular weight. */
export function TumblrLogoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TumblrLogoPaths} {...props} />;
}

export const TumblrLogo = TumblrLogoIcon;
