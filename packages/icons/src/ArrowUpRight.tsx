 ...
 * Source: @phosphor-icons/core arrow-up-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowUpRightPaths: IconPathData = {
  thin: [
    {
...
/** ArrowUpRight icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowUpRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowUpRightPaths} {...props} />;
}
