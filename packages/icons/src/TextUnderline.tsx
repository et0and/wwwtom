 ...
 * Source: @phosphor-icons/core text-underline. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TextUnderlinePaths: IconPathData = {
  thin: [
    {
...
/** TextUnderline icon in six Phosphor weights. Defaults to regular weight. */
export function TextUnderlineIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TextUnderlinePaths} {...props} />;
}

export const TextUnderline = TextUnderlineIcon;
