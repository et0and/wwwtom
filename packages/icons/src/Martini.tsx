 ...
 * Source: @phosphor-icons/core martini. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MartiniPaths: IconPathData = {
  thin: [
    {
...
/** Martini icon in six Phosphor weights. Defaults to regular weight. */
export function MartiniIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MartiniPaths} {...props} />;
}
