 ...
 * Source: @phosphor-icons/core suitcase. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SuitcasePaths: IconPathData = {
  thin: [
    {
...
/** Suitcase icon in six Phosphor weights. Defaults to regular weight. */
export function SuitcaseIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SuitcasePaths} {...props} />;
}
