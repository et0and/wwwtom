 ...
 * Source: @phosphor-icons/core number-square-three. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NumberSquareThreePaths: IconPathData = {
  thin: [
    {
...
/** NumberSquareThree icon in six Phosphor weights. Defaults to regular weight. */
export function NumberSquareThreeIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NumberSquareThreePaths} {...props} />;
}

export const NumberSquareThree = NumberSquareThreeIcon;
