 ...
 * Source: @phosphor-icons/core number-four. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NumberFourPaths: IconPathData = {
  thin: [
    {
...
/** NumberFour icon in six Phosphor weights. Defaults to regular weight. */
export function NumberFourIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NumberFourPaths} {...props} />;
}

export const NumberFour = NumberFourIcon;
