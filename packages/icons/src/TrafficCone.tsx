 ...
 * Source: @phosphor-icons/core traffic-cone. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TrafficConePaths: IconPathData = {
  thin: [
    {
...
/** TrafficCone icon in six Phosphor weights. Defaults to regular weight. */
export function TrafficConeIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TrafficConePaths} {...props} />;
}
