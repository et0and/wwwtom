 ...
 * Source: @phosphor-icons/core battery-medium. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BatteryMediumPaths: IconPathData = {
  thin: [
    {
...
/** BatteryMedium icon in six Phosphor weights. Defaults to regular weight. */
export function BatteryMediumIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BatteryMediumPaths} {...props} />;
}
