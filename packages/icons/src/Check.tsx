 ...
 * Source: @phosphor-icons/core check. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Check icon in six Phosphor weights. Defaults to regular weight. */
export function CheckIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CheckPaths} {...props} />;
}
