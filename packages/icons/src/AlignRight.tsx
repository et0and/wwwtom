 ...
 * Source: @phosphor-icons/core align-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const AlignRightPaths: IconPathData = {
  thin: [
    {
...
/** AlignRight icon in six Phosphor weights. Defaults to regular weight. */
export function AlignRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={AlignRightPaths} {...props} />;
}
