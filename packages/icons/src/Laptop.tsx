 ...
 * Source: @phosphor-icons/core laptop. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const LaptopPaths: IconPathData = {
  thin: [
    {
...
/** Laptop icon in six Phosphor weights. Defaults to regular weight. */
export function LaptopIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LaptopPaths} {...props} />;
}
