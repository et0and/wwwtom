 ...
 * Source: @phosphor-icons/core cloud-fog. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CloudFogPaths: IconPathData = {
  thin: [
    {
...
/** CloudFog icon in six Phosphor weights. Defaults to regular weight. */
export function CloudFogIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CloudFogPaths} {...props} />;
}
