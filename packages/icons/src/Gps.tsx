 ...
 * Source: @phosphor-icons/core gps. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Gps icon in six Phosphor weights. Defaults to regular weight. */
export function GpsIcon(props: IconProps): JSX.Element {
  return <IconBase paths={GpsPaths} {...props} />;
}

export const Gps = GpsIcon;
