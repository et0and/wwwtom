 ...
 * Source: @phosphor-icons/core lock-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const LockSimplePaths: IconPathData = {
  thin: [
    {
...
/** LockSimple icon in six Phosphor weights. Defaults to regular weight. */
export function LockSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LockSimplePaths} {...props} />;
}

export const LockSimple = LockSimpleIcon;
