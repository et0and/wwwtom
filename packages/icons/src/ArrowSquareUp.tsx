 ...
 * Source: @phosphor-icons/core arrow-square-up. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowSquareUpPaths: IconPathData = {
  thin: [
    {
...
/** ArrowSquareUp icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowSquareUpIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowSquareUpPaths} {...props} />;
}

export const ArrowSquareUp = ArrowSquareUpIcon;
