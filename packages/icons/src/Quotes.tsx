 ...
 * Source: @phosphor-icons/core quotes. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const QuotesPaths: IconPathData = {
  thin: [
    {
...
/** Quotes icon in six Phosphor weights. Defaults to regular weight. */
export function QuotesIcon(props: IconProps): JSX.Element {
  return <IconBase paths={QuotesPaths} {...props} />;
}

export const Quotes = QuotesIcon;
