 ...
 * Source: @phosphor-icons/core egg. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Egg icon in six Phosphor weights. Defaults to regular weight. */
export function EggIcon(props: IconProps): JSX.Element {
  return <IconBase paths={EggPaths} {...props} />;
}
