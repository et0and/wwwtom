 ...
 * Source: @phosphor-icons/core envelope-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const EnvelopeSimplePaths: IconPathData = {
  thin: [
    {
...
/** EnvelopeSimple icon in six Phosphor weights. Defaults to regular weight. */
export function EnvelopeSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={EnvelopeSimplePaths} {...props} />;
}
