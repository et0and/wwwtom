 ...
 * Source: @phosphor-icons/core currency-cny. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CurrencyCnyPaths: IconPathData = {
  thin: [
    {
...
/** CurrencyCny icon in six Phosphor weights. Defaults to regular weight. */
export function CurrencyCnyIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CurrencyCnyPaths} {...props} />;
}

export const CurrencyCny = CurrencyCnyIcon;
