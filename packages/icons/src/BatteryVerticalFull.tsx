 ...
 * Source: @phosphor-icons/core battery-vertical-full. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BatteryVerticalFullPaths: IconPathData = {
  thin: [
    {
...
/** BatteryVerticalFull icon in six Phosphor weights. Defaults to regular weight. */
export function BatteryVerticalFullIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BatteryVerticalFullPaths} {...props} />;
}

export const BatteryVerticalFull = BatteryVerticalFullIcon;
