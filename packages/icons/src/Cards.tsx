 ...
 * Source: @phosphor-icons/core cards. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Cards icon in six Phosphor weights. Defaults to regular weight. */
export function CardsIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CardsPaths} {...props} />;
}

export const Cards = CardsIcon;
