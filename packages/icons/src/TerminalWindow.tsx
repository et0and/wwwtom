 ...
 * Source: @phosphor-icons/core terminal-window. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TerminalWindowPaths: IconPathData = {
  thin: [
    {
...
/** TerminalWindow icon in six Phosphor weights. Defaults to regular weight. */
export function TerminalWindowIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TerminalWindowPaths} {...props} />;
}

export const TerminalWindow = TerminalWindowIcon;
