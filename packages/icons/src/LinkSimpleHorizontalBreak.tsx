 ...
 * Source: @phosphor-icons/core link-simple-horizontal-break. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const LinkSimpleHorizontalBreakPaths: IconPathData = {
  thin: [
    {
...
/** LinkSimpleHorizontalBreak icon in six Phosphor weights. Defaults to regular weight. */
export function LinkSimpleHorizontalBreakIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LinkSimpleHorizontalBreakPaths} {...props} />;
}

export const LinkSimpleHorizontalBreak = LinkSimpleHorizontalBreakIcon;
