 ...
 * Source: @phosphor-icons/core umbrella-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const UmbrellaSimplePaths: IconPathData = {
  thin: [
    {
...
/** UmbrellaSimple icon in six Phosphor weights. Defaults to regular weight. */
export function UmbrellaSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={UmbrellaSimplePaths} {...props} />;
}

export const UmbrellaSimple = UmbrellaSimpleIcon;
