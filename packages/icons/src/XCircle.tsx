 ...
 * Source: @phosphor-icons/core x-circle. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const XCirclePaths: IconPathData = {
  thin: [
    {
...
/** XCircle icon in six Phosphor weights. Defaults to regular weight. */
export function XCircleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={XCirclePaths} {...props} />;
}
