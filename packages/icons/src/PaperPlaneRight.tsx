 ...
 * Source: @phosphor-icons/core paper-plane-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PaperPlaneRightPaths: IconPathData = {
  thin: [
    {
...
/** PaperPlaneRight icon in six Phosphor weights. Defaults to regular weight. */
export function PaperPlaneRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PaperPlaneRightPaths} {...props} />;
}

export const PaperPlaneRight = PaperPlaneRightIcon;
