 ...
 * Source: @phosphor-icons/core fast-forward-circle. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FastForwardCirclePaths: IconPathData = {
  thin: [
    {
...
/** FastForwardCircle icon in six Phosphor weights. Defaults to regular weight. */
export function FastForwardCircleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FastForwardCirclePaths} {...props} />;
}

export const FastForwardCircle = FastForwardCircleIcon;
