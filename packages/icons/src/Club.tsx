 ...
 * Source: @phosphor-icons/core club. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Club icon in six Phosphor weights. Defaults to regular weight. */
export function ClubIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ClubPaths} {...props} />;
}
