 ...
 * Source: @phosphor-icons/core arrow-circle-up. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowCircleUpPaths: IconPathData = {
  thin: [
    {
...
/** ArrowCircleUp icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowCircleUpIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowCircleUpPaths} {...props} />;
}
