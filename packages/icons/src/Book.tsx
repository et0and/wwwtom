 ...
 * Source: @phosphor-icons/core book. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Book icon in six Phosphor weights. Defaults to regular weight. */
export function BookIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BookPaths} {...props} />;
}
