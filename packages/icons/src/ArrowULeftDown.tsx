 ...
 * Source: @phosphor-icons/core arrow-u-left-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowULeftDownPaths: IconPathData = {
  thin: [
    {
...
/** ArrowULeftDown icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowULeftDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowULeftDownPaths} {...props} />;
}

export const ArrowULeftDown = ArrowULeftDownIcon;
