 ...
 * Source: @phosphor-icons/core arrow-bend-right-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowBendRightDownPaths: IconPathData = {
  thin: [
    {
...
/** ArrowBendRightDown icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowBendRightDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowBendRightDownPaths} {...props} />;
}

export const ArrowBendRightDown = ArrowBendRightDownIcon;
