 ...
 * Source: @phosphor-icons/core number-three. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NumberThreePaths: IconPathData = {
  thin: [
    {
...
/** NumberThree icon in six Phosphor weights. Defaults to regular weight. */
export function NumberThreeIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NumberThreePaths} {...props} />;
}
