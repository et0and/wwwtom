 ...
 * Source: @phosphor-icons/core paper-plane. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PaperPlanePaths: IconPathData = {
  thin: [
    {
...
/** PaperPlane icon in six Phosphor weights. Defaults to regular weight. */
export function PaperPlaneIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PaperPlanePaths} {...props} />;
}
