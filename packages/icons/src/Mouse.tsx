 ...
 * Source: @phosphor-icons/core mouse. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Mouse icon in six Phosphor weights. Defaults to regular weight. */
export function MouseIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MousePaths} {...props} />;
}
