 ...
 * Source: @phosphor-icons/core cardholder. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CardholderPaths: IconPathData = {
  thin: [
    {
...
/** Cardholder icon in six Phosphor weights. Defaults to regular weight. */
export function CardholderIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CardholderPaths} {...props} />;
}

export const Cardholder = CardholderIcon;
