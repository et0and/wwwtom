 ...
 * Source: @phosphor-icons/core chart-pie. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChartPiePaths: IconPathData = {
  thin: [
    {
...
/** ChartPie icon in six Phosphor weights. Defaults to regular weight. */
export function ChartPieIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChartPiePaths} {...props} />;
}
