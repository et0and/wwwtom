 ...
 * Source: @phosphor-icons/core copy-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CopySimplePaths: IconPathData = {
  thin: [
    {
...
/** CopySimple icon in six Phosphor weights. Defaults to regular weight. */
export function CopySimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CopySimplePaths} {...props} />;
}
