 ...
 * Source: @phosphor-icons/core arrow-bend-down-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowBendDownRightPaths: IconPathData = {
  thin: [
    {
...
/** ArrowBendDownRight icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowBendDownRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowBendDownRightPaths} {...props} />;
}

export const ArrowBendDownRight = ArrowBendDownRightIcon;
