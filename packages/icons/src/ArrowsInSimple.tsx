 ...
 * Source: @phosphor-icons/core arrows-in-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowsInSimplePaths: IconPathData = {
  thin: [
    {
...
/** ArrowsInSimple icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowsInSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowsInSimplePaths} {...props} />;
}

export const ArrowsInSimple = ArrowsInSimpleIcon;
