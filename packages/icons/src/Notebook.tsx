 ...
 * Source: @phosphor-icons/core notebook. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NotebookPaths: IconPathData = {
  thin: [
    {
...
/** Notebook icon in six Phosphor weights. Defaults to regular weight. */
export function NotebookIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NotebookPaths} {...props} />;
}
