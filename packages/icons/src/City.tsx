 ...
 * Source: @phosphor-icons/core city. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** City icon in six Phosphor weights. Defaults to regular weight. */
export function CityIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CityPaths} {...props} />;
}

export const City = CityIcon;
