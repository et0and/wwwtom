 ...
 * Source: @phosphor-icons/core magnet-straight. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MagnetStraightPaths: IconPathData = {
  thin: [
    {
...
/** MagnetStraight icon in six Phosphor weights. Defaults to regular weight. */
export function MagnetStraightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MagnetStraightPaths} {...props} />;
}

export const MagnetStraight = MagnetStraightIcon;
