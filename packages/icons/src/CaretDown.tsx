 ...
 * Source: @phosphor-icons/core caret-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CaretDownPaths: IconPathData = {
  thin: [
    {
...
/** CaretDown icon in six Phosphor weights. Defaults to regular weight. */
export function CaretDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CaretDownPaths} {...props} />;
}
