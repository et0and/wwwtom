 ...
 * Source: @phosphor-icons/core blueprint. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BlueprintPaths: IconPathData = {
  thin: [
    {
...
/** Blueprint icon in six Phosphor weights. Defaults to regular weight. */
export function BlueprintIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BlueprintPaths} {...props} />;
}

export const Blueprint = BlueprintIcon;
