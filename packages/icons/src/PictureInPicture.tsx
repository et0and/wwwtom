 ...
 * Source: @phosphor-icons/core picture-in-picture. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PictureInPicturePaths: IconPathData = {
  thin: [
    {
...
/** PictureInPicture icon in six Phosphor weights. Defaults to regular weight. */
export function PictureInPictureIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PictureInPicturePaths} {...props} />;
}
