 ...
 * Source: @phosphor-icons/core chair. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Chair icon in six Phosphor weights. Defaults to regular weight. */
export function ChairIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChairPaths} {...props} />;
}

export const Chair = ChairIcon;
