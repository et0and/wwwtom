 ...
 * Source: @phosphor-icons/core arrow-bend-left-up. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowBendLeftUpPaths: IconPathData = {
  thin: [
    {
...
/** ArrowBendLeftUp icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowBendLeftUpIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowBendLeftUpPaths} {...props} />;
}

export const ArrowBendLeftUp = ArrowBendLeftUpIcon;
