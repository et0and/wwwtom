 ...
 * Source: @phosphor-icons/core align-center-vertical-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const AlignCenterVerticalSimplePaths: IconPathData = {
  thin: [
    {
...
/** AlignCenterVerticalSimple icon in six Phosphor weights. Defaults to regular weight. */
export function AlignCenterVerticalSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={AlignCenterVerticalSimplePaths} {...props} />;
}

export const AlignCenterVerticalSimple = AlignCenterVerticalSimpleIcon;
