 ...
 * Source: @phosphor-icons/core linktree-logo. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const LinktreeLogoPaths: IconPathData = {
  thin: [
    {
...
/** LinktreeLogo icon in six Phosphor weights. Defaults to regular weight. */
export function LinktreeLogoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LinktreeLogoPaths} {...props} />;
}

export const LinktreeLogo = LinktreeLogoIcon;
