 ...
 * Source: @phosphor-icons/core chat-teardrop. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChatTeardropPaths: IconPathData = {
  thin: [
    {
...
/** ChatTeardrop icon in six Phosphor weights. Defaults to regular weight. */
export function ChatTeardropIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChatTeardropPaths} {...props} />;
}

export const ChatTeardrop = ChatTeardropIcon;
