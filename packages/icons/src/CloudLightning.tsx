 ...
 * Source: @phosphor-icons/core cloud-lightning. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CloudLightningPaths: IconPathData = {
  thin: [
    {
...
/** CloudLightning icon in six Phosphor weights. Defaults to regular weight. */
export function CloudLightningIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CloudLightningPaths} {...props} />;
}
