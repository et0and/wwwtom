 ...
 * Source: @phosphor-icons/core download. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DownloadPaths: IconPathData = {
  thin: [
    {
...
/** Download icon in six Phosphor weights. Defaults to regular weight. */
export function DownloadIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DownloadPaths} {...props} />;
}
