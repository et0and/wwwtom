 ...
 * Source: @phosphor-icons/core google-logo. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const GoogleLogoPaths: IconPathData = {
  thin: [
    {
...
/** GoogleLogo icon in six Phosphor weights. Defaults to regular weight. */
export function GoogleLogoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={GoogleLogoPaths} {...props} />;
}

export const GoogleLogo = GoogleLogoIcon;
