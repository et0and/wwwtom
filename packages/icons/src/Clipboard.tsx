 ...
 * Source: @phosphor-icons/core clipboard. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ClipboardPaths: IconPathData = {
  thin: [
    {
...
/** Clipboard icon in six Phosphor weights. Defaults to regular weight. */
export function ClipboardIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ClipboardPaths} {...props} />;
}
