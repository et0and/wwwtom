 ...
 * Source: @phosphor-icons/core align-top-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const AlignTopSimplePaths: IconPathData = {
  thin: [
    {
...
/** AlignTopSimple icon in six Phosphor weights. Defaults to regular weight. */
export function AlignTopSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={AlignTopSimplePaths} {...props} />;
}

export const AlignTopSimple = AlignTopSimpleIcon;
