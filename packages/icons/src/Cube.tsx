 ...
 * Source: @phosphor-icons/core cube. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Cube icon in six Phosphor weights. Defaults to regular weight. */
export function CubeIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CubePaths} {...props} />;
}
