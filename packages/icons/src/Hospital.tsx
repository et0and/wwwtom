 ...
 * Source: @phosphor-icons/core hospital. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const HospitalPaths: IconPathData = {
  thin: [
    {
...
/** Hospital icon in six Phosphor weights. Defaults to regular weight. */
export function HospitalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={HospitalPaths} {...props} />;
}
