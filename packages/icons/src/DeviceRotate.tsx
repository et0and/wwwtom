 ...
 * Source: @phosphor-icons/core device-rotate. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DeviceRotatePaths: IconPathData = {
  thin: [
    {
...
/** DeviceRotate icon in six Phosphor weights. Defaults to regular weight. */
export function DeviceRotateIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DeviceRotatePaths} {...props} />;
}

export const DeviceRotate = DeviceRotateIcon;
