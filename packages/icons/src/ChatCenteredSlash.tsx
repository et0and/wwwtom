 ...
 * Source: @phosphor-icons/core chat-centered-slash. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChatCenteredSlashPaths: IconPathData = {
  thin: [
    {
...
/** ChatCenteredSlash icon in six Phosphor weights. Defaults to regular weight. */
export function ChatCenteredSlashIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChatCenteredSlashPaths} {...props} />;
}

export const ChatCenteredSlash = ChatCenteredSlashIcon;
