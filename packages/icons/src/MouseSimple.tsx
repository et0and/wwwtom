 ...
 * Source: @phosphor-icons/core mouse-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MouseSimplePaths: IconPathData = {
  thin: [
    {
...
/** MouseSimple icon in six Phosphor weights. Defaults to regular weight. */
export function MouseSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MouseSimplePaths} {...props} />;
}

export const MouseSimple = MouseSimpleIcon;
