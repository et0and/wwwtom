 ...
 * Source: @phosphor-icons/core caret-circle-double-up. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CaretCircleDoubleUpPaths: IconPathData = {
  thin: [
    {
...
/** CaretCircleDoubleUp icon in six Phosphor weights. Defaults to regular weight. */
export function CaretCircleDoubleUpIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CaretCircleDoubleUpPaths} {...props} />;
}

export const CaretCircleDoubleUp = CaretCircleDoubleUpIcon;
