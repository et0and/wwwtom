 ...
 * Source: @phosphor-icons/core flag-banner. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FlagBannerPaths: IconPathData = {
  thin: [
    {
...
/** FlagBanner icon in six Phosphor weights. Defaults to regular weight. */
export function FlagBannerIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FlagBannerPaths} {...props} />;
}

export const FlagBanner = FlagBannerIcon;
