 ...
 * Source: @phosphor-icons/core device-tablet-speaker. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DeviceTabletSpeakerPaths: IconPathData = {
  thin: [
    {
...
/** DeviceTabletSpeaker icon in six Phosphor weights. Defaults to regular weight. */
export function DeviceTabletSpeakerIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DeviceTabletSpeakerPaths} {...props} />;
}

export const DeviceTabletSpeaker = DeviceTabletSpeakerIcon;
