 ...
 * Source: @phosphor-icons/core clock-countdown. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ClockCountdownPaths: IconPathData = {
  thin: [
    {
...
/** ClockCountdown icon in six Phosphor weights. Defaults to regular weight. */
export function ClockCountdownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ClockCountdownPaths} {...props} />;
}

export const ClockCountdown = ClockCountdownIcon;
