 ...
 * Source: @phosphor-icons/core caret-up-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CaretUpDownPaths: IconPathData = {
  thin: [
    {
...
/** CaretUpDown icon in six Phosphor weights. Defaults to regular weight. */
export function CaretUpDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CaretUpDownPaths} {...props} />;
}
