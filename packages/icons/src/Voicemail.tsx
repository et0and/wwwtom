 ...
 * Source: @phosphor-icons/core voicemail. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const VoicemailPaths: IconPathData = {
  thin: [
    {
...
/** Voicemail icon in six Phosphor weights. Defaults to regular weight. */
export function VoicemailIcon(props: IconProps): JSX.Element {
  return <IconBase paths={VoicemailPaths} {...props} />;
}
