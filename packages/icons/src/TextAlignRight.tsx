 ...
 * Source: @phosphor-icons/core text-align-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TextAlignRightPaths: IconPathData = {
  thin: [
    {
...
/** TextAlignRight icon in six Phosphor weights. Defaults to regular weight. */
export function TextAlignRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TextAlignRightPaths} {...props} />;
}
