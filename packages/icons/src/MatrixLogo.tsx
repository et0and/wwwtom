 ...
 * Source: @phosphor-icons/core matrix-logo. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MatrixLogoPaths: IconPathData = {
  thin: [
    {
...
/** MatrixLogo icon in six Phosphor weights. Defaults to regular weight. */
export function MatrixLogoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MatrixLogoPaths} {...props} />;
}

export const MatrixLogo = MatrixLogoIcon;
