 ...
 * Source: @phosphor-icons/core bank. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Bank icon in six Phosphor weights. Defaults to regular weight. */
export function BankIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BankPaths} {...props} />;
}
