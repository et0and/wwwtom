 ...
 * Source: @phosphor-icons/core sigma. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Sigma icon in six Phosphor weights. Defaults to regular weight. */
export function SigmaIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SigmaPaths} {...props} />;
}
