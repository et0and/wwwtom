 ...
 * Source: @phosphor-icons/core member-of. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MemberOfPaths: IconPathData = {
  thin: [
    {
...
/** MemberOf icon in six Phosphor weights. Defaults to regular weight. */
export function MemberOfIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MemberOfPaths} {...props} />;
}

export const MemberOf = MemberOfIcon;
