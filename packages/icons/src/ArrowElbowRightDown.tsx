 ...
 * Source: @phosphor-icons/core arrow-elbow-right-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowElbowRightDownPaths: IconPathData = {
  thin: [
    {
...
/** ArrowElbowRightDown icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowElbowRightDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowElbowRightDownPaths} {...props} />;
}

export const ArrowElbowRightDown = ArrowElbowRightDownIcon;
