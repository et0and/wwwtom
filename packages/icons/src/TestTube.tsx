 ...
 * Source: @phosphor-icons/core test-tube. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TestTubePaths: IconPathData = {
  thin: [
    {
...
/** TestTube icon in six Phosphor weights. Defaults to regular weight. */
export function TestTubeIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TestTubePaths} {...props} />;
}
