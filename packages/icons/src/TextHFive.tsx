 ...
 * Source: @phosphor-icons/core text-h-five. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TextHFivePaths: IconPathData = {
  thin: [
    {
...
/** TextHFive icon in six Phosphor weights. Defaults to regular weight. */
export function TextHFiveIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TextHFivePaths} {...props} />;
}

export const TextHFive = TextHFiveIcon;
