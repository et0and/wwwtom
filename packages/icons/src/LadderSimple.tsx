 ...
 * Source: @phosphor-icons/core ladder-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const LadderSimplePaths: IconPathData = {
  thin: [
    {
...
/** LadderSimple icon in six Phosphor weights. Defaults to regular weight. */
export function LadderSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LadderSimplePaths} {...props} />;
}

export const LadderSimple = LadderSimpleIcon;
