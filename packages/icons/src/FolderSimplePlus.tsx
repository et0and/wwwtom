 ...
 * Source: @phosphor-icons/core folder-simple-plus. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FolderSimplePlusPaths: IconPathData = {
  thin: [
    {
...
/** FolderSimplePlus icon in six Phosphor weights. Defaults to regular weight. */
export function FolderSimplePlusIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FolderSimplePlusPaths} {...props} />;
}

export const FolderSimplePlus = FolderSimplePlusIcon;
