 ...
 * Source: @phosphor-icons/core caret-circle-up. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CaretCircleUpPaths: IconPathData = {
  thin: [
    {
...
/** CaretCircleUp icon in six Phosphor weights. Defaults to regular weight. */
export function CaretCircleUpIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CaretCircleUpPaths} {...props} />;
}
