 ...
 * Source: @phosphor-icons/core dot-outline. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DotOutlinePaths: IconPathData = {
  thin: [
    {
...
/** DotOutline icon in six Phosphor weights. Defaults to regular weight. */
export function DotOutlineIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DotOutlinePaths} {...props} />;
}

export const DotOutline = DotOutlineIcon;
