 ...
 * Source: @phosphor-icons/core note-pencil. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NotePencilPaths: IconPathData = {
  thin: [
    {
...
/** NotePencil icon in six Phosphor weights. Defaults to regular weight. */
export function NotePencilIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NotePencilPaths} {...props} />;
}

export const NotePencil = NotePencilIcon;
