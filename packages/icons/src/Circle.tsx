 ...
 * Source: @phosphor-icons/core circle. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CirclePaths: IconPathData = {
  thin: [
    {
...
/** Circle icon in six Phosphor weights. Defaults to regular weight. */
export function CircleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CirclePaths} {...props} />;
}
