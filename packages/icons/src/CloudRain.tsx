 ...
 * Source: @phosphor-icons/core cloud-rain. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CloudRainPaths: IconPathData = {
  thin: [
    {
...
/** CloudRain icon in six Phosphor weights. Defaults to regular weight. */
export function CloudRainIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CloudRainPaths} {...props} />;
}
