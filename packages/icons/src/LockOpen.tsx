 ...
 * Source: @phosphor-icons/core lock-open. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const LockOpenPaths: IconPathData = {
  thin: [
    {
...
/** LockOpen icon in six Phosphor weights. Defaults to regular weight. */
export function LockOpenIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LockOpenPaths} {...props} />;
}
