 ...
 * Source: @phosphor-icons/core clock-clockwise. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ClockClockwisePaths: IconPathData = {
  thin: [
    {
...
/** ClockClockwise icon in six Phosphor weights. Defaults to regular weight. */
export function ClockClockwiseIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ClockClockwisePaths} {...props} />;
}
