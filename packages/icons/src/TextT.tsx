 ...
 * Source: @phosphor-icons/core text-t. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** TextT icon in six Phosphor weights. Defaults to regular weight. */
export function TextTIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TextTPaths} {...props} />;
}

export const TextT = TextTIcon;
