 ...
 * Source: @phosphor-icons/core infinity. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const InfinityPaths: IconPathData = {
  thin: [
    {
...
/** Infinity icon in six Phosphor weights. Defaults to regular weight. */
export function InfinityIcon(props: IconProps): JSX.Element {
  return <IconBase paths={InfinityPaths} {...props} />;
}
