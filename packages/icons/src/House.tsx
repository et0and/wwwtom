 ...
 * Source: @phosphor-icons/core house. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** House icon in six Phosphor weights. Defaults to regular weight. */
export function HouseIcon(props: IconProps): JSX.Element {
  return <IconBase paths={HousePaths} {...props} />;
}
