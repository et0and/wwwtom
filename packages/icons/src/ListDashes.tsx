 ...
 * Source: @phosphor-icons/core list-dashes. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ListDashesPaths: IconPathData = {
  thin: [
    {
...
/** ListDashes icon in six Phosphor weights. Defaults to regular weight. */
export function ListDashesIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ListDashesPaths} {...props} />;
}

export const ListDashes = ListDashesIcon;
