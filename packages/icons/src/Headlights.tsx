 ...
 * Source: @phosphor-icons/core headlights. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const HeadlightsPaths: IconPathData = {
  thin: [
    {
...
/** Headlights icon in six Phosphor weights. Defaults to regular weight. */
export function HeadlightsIcon(props: IconProps): JSX.Element {
  return <IconBase paths={HeadlightsPaths} {...props} />;
}

export const Headlights = HeadlightsIcon;
