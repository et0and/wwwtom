 ...
 * Source: @phosphor-icons/core flag-banner-fold. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FlagBannerFoldPaths: IconPathData = {
  thin: [
    {
...
/** FlagBannerFold icon in six Phosphor weights. Defaults to regular weight. */
export function FlagBannerFoldIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FlagBannerFoldPaths} {...props} />;
}

export const FlagBannerFold = FlagBannerFoldIcon;
