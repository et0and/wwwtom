 ...
 * Source: @phosphor-icons/core plus. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Plus icon in six Phosphor weights. Defaults to regular weight. */
export function PlusIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PlusPaths} {...props} />;
}
