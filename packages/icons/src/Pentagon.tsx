 ...
 * Source: @phosphor-icons/core pentagon. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PentagonPaths: IconPathData = {
  thin: [
    {
...
/** Pentagon icon in six Phosphor weights. Defaults to regular weight. */
export function PentagonIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PentagonPaths} {...props} />;
}
