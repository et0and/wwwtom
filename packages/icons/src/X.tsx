 ...
 * Source: @phosphor-icons/core x. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** X icon in six Phosphor weights. Defaults to regular weight. */
export function XIcon(props: IconProps): JSX.Element {
  return <IconBase paths={XPaths} {...props} />;
}
