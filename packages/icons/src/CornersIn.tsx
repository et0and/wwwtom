 ...
 * Source: @phosphor-icons/core corners-in. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CornersInPaths: IconPathData = {
  thin: [
    {
...
/** CornersIn icon in six Phosphor weights. Defaults to regular weight. */
export function CornersInIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CornersInPaths} {...props} />;
}
