 ...
 * Source: @phosphor-icons/core line-segment. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const LineSegmentPaths: IconPathData = {
  thin: [
    {
...
/** LineSegment icon in six Phosphor weights. Defaults to regular weight. */
export function LineSegmentIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LineSegmentPaths} {...props} />;
}

export const LineSegment = LineSegmentIcon;
