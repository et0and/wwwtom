 ...
 * Source: @phosphor-icons/core hourglass-simple-high. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const HourglassSimpleHighPaths: IconPathData = {
  thin: [
    {
...
/** HourglassSimpleHigh icon in six Phosphor weights. Defaults to regular weight. */
export function HourglassSimpleHighIcon(props: IconProps): JSX.Element {
  return <IconBase paths={HourglassSimpleHighPaths} {...props} />;
}

export const HourglassSimpleHigh = HourglassSimpleHighIcon;
