 ...
 * Source: @phosphor-icons/core text-outdent. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TextOutdentPaths: IconPathData = {
  thin: [
    {
...
/** TextOutdent icon in six Phosphor weights. Defaults to regular weight. */
export function TextOutdentIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TextOutdentPaths} {...props} />;
}

export const TextOutdent = TextOutdentIcon;
