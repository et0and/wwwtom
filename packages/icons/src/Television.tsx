 ...
 * Source: @phosphor-icons/core television. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TelevisionPaths: IconPathData = {
  thin: [
    {
...
/** Television icon in six Phosphor weights. Defaults to regular weight. */
export function TelevisionIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TelevisionPaths} {...props} />;
}

export const Television = TelevisionIcon;
