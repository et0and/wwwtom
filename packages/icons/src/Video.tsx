 ...
 * Source: @phosphor-icons/core video. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Video icon in six Phosphor weights. Defaults to regular weight. */
export function VideoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={VideoPaths} {...props} />;
}
