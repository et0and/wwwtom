 ...
 * Source: @phosphor-icons/core stack-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const StackSimplePaths: IconPathData = {
  thin: [
    {
...
/** StackSimple icon in six Phosphor weights. Defaults to regular weight. */
export function StackSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={StackSimplePaths} {...props} />;
}

export const StackSimple = StackSimpleIcon;
