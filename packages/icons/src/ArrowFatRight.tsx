 ...
 * Source: @phosphor-icons/core arrow-fat-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowFatRightPaths: IconPathData = {
  thin: [
    {
...
/** ArrowFatRight icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowFatRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowFatRightPaths} {...props} />;
}

export const ArrowFatRight = ArrowFatRightIcon;
