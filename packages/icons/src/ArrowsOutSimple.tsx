 ...
 * Source: @phosphor-icons/core arrows-out-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowsOutSimplePaths: IconPathData = {
  thin: [
    {
...
/** ArrowsOutSimple icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowsOutSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowsOutSimplePaths} {...props} />;
}
