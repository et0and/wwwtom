 ...
 * Source: @phosphor-icons/core tipi. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Tipi icon in six Phosphor weights. Defaults to regular weight. */
export function TipiIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TipiPaths} {...props} />;
}

export const Tipi = TipiIcon;
