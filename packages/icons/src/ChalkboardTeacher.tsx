 ...
 * Source: @phosphor-icons/core chalkboard-teacher. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChalkboardTeacherPaths: IconPathData = {
  thin: [
    {
...
/** ChalkboardTeacher icon in six Phosphor weights. Defaults to regular weight. */
export function ChalkboardTeacherIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChalkboardTeacherPaths} {...props} />;
}

export const ChalkboardTeacher = ChalkboardTeacherIcon;
