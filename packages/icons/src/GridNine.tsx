 ...
 * Source: @phosphor-icons/core grid-nine. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const GridNinePaths: IconPathData = {
  thin: [
    {
...
/** GridNine icon in six Phosphor weights. Defaults to regular weight. */
export function GridNineIcon(props: IconProps): JSX.Element {
  return <IconBase paths={GridNinePaths} {...props} />;
}

export const GridNine = GridNineIcon;
