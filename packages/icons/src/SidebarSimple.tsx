 ...
 * Source: @phosphor-icons/core sidebar-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SidebarSimplePaths: IconPathData = {
  thin: [
    {
...
/** SidebarSimple icon in six Phosphor weights. Defaults to regular weight. */
export function SidebarSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SidebarSimplePaths} {...props} />;
}
