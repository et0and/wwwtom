 ...
 * Source: @phosphor-icons/core flashlight. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FlashlightPaths: IconPathData = {
  thin: [
    {
...
/** Flashlight icon in six Phosphor weights. Defaults to regular weight. */
export function FlashlightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FlashlightPaths} {...props} />;
}
