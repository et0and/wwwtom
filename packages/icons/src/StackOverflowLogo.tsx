 ...
 * Source: @phosphor-icons/core stack-overflow-logo. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const StackOverflowLogoPaths: IconPathData = {
  thin: [
    {
...
/** StackOverflowLogo icon in six Phosphor weights. Defaults to regular weight. */
export function StackOverflowLogoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={StackOverflowLogoPaths} {...props} />;
}

export const StackOverflowLogo = StackOverflowLogoIcon;
