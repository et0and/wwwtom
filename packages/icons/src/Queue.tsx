 ...
 * Source: @phosphor-icons/core queue. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Queue icon in six Phosphor weights. Defaults to regular weight. */
export function QueueIcon(props: IconProps): JSX.Element {
  return <IconBase paths={QueuePaths} {...props} />;
}
