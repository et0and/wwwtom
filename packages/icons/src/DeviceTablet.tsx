 ...
 * Source: @phosphor-icons/core device-tablet. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DeviceTabletPaths: IconPathData = {
  thin: [
    {
...
/** DeviceTablet icon in six Phosphor weights. Defaults to regular weight. */
export function DeviceTabletIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DeviceTabletPaths} {...props} />;
}

export const DeviceTablet = DeviceTabletIcon;
