 ...
 * Source: @phosphor-icons/core code-block. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CodeBlockPaths: IconPathData = {
  thin: [
    {
...
/** CodeBlock icon in six Phosphor weights. Defaults to regular weight. */
export function CodeBlockIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CodeBlockPaths} {...props} />;
}

export const CodeBlock = CodeBlockIcon;
