 ...
 * Source: @phosphor-icons/core repeat. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const RepeatPaths: IconPathData = {
  thin: [
    {
...
/** Repeat icon in six Phosphor weights. Defaults to regular weight. */
export function RepeatIcon(props: IconProps): JSX.Element {
  return <IconBase paths={RepeatPaths} {...props} />;
}
