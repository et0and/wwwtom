 ...
 * Source: @phosphor-icons/core arrow-square-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowSquareLeftPaths: IconPathData = {
  thin: [
    {
...
/** ArrowSquareLeft icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowSquareLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowSquareLeftPaths} {...props} />;
}

export const ArrowSquareLeft = ArrowSquareLeftIcon;
