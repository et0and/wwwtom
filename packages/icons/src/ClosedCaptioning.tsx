 ...
 * Source: @phosphor-icons/core closed-captioning. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ClosedCaptioningPaths: IconPathData = {
  thin: [
    {
...
/** ClosedCaptioning icon in six Phosphor weights. Defaults to regular weight. */
export function ClosedCaptioningIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ClosedCaptioningPaths} {...props} />;
}

export const ClosedCaptioning = ClosedCaptioningIcon;
