 ...
 * Source: @phosphor-icons/core replit-logo. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ReplitLogoPaths: IconPathData = {
  thin: [
    {
...
/** ReplitLogo icon in six Phosphor weights. Defaults to regular weight. */
export function ReplitLogoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ReplitLogoPaths} {...props} />;
}

export const ReplitLogo = ReplitLogoIcon;
