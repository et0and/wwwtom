 ...
 * Source: @phosphor-icons/core arrow-elbow-up-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowElbowUpRightPaths: IconPathData = {
  thin: [
    {
...
/** ArrowElbowUpRight icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowElbowUpRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowElbowUpRightPaths} {...props} />;
}

export const ArrowElbowUpRight = ArrowElbowUpRightIcon;
