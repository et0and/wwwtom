 ...
 * Source: @phosphor-icons/core twitch-logo. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TwitchLogoPaths: IconPathData = {
  thin: [
    {
...
/** TwitchLogo icon in six Phosphor weights. Defaults to regular weight. */
export function TwitchLogoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TwitchLogoPaths} {...props} />;
}

export const TwitchLogo = TwitchLogoIcon;
