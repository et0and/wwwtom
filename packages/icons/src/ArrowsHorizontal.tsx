 ...
 * Source: @phosphor-icons/core arrows-horizontal. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowsHorizontalPaths: IconPathData = {
  thin: [
    {
...
/** ArrowsHorizontal icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowsHorizontalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowsHorizontalPaths} {...props} />;
}

export const ArrowsHorizontal = ArrowsHorizontalIcon;
