 ...
 * Source: @phosphor-icons/core bookmark-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BookmarkSimplePaths: IconPathData = {
  thin: [
    {
...
/** BookmarkSimple icon in six Phosphor weights. Defaults to regular weight. */
export function BookmarkSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BookmarkSimplePaths} {...props} />;
}

export const BookmarkSimple = BookmarkSimpleIcon;
