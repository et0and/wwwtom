 ...
 * Source: @phosphor-icons/core power. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Power icon in six Phosphor weights. Defaults to regular weight. */
export function PowerIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PowerPaths} {...props} />;
}
