 ...
 * Source: @phosphor-icons/core arrow-fat-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowFatLeftPaths: IconPathData = {
  thin: [
    {
...
/** ArrowFatLeft icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowFatLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowFatLeftPaths} {...props} />;
}

export const ArrowFatLeft = ArrowFatLeftIcon;
