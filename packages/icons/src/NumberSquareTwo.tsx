 ...
 * Source: @phosphor-icons/core number-square-two. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NumberSquareTwoPaths: IconPathData = {
  thin: [
    {
...
/** NumberSquareTwo icon in six Phosphor weights. Defaults to regular weight. */
export function NumberSquareTwoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NumberSquareTwoPaths} {...props} />;
}

export const NumberSquareTwo = NumberSquareTwoIcon;
