 ...
 * Source: @phosphor-icons/core minus-square. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MinusSquarePaths: IconPathData = {
  thin: [
    {
...
/** MinusSquare icon in six Phosphor weights. Defaults to regular weight. */
export function MinusSquareIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MinusSquarePaths} {...props} />;
}
