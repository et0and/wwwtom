 ...
 * Source: @phosphor-icons/core clock-afternoon. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ClockAfternoonPaths: IconPathData = {
  thin: [
    {
...
/** ClockAfternoon icon in six Phosphor weights. Defaults to regular weight. */
export function ClockAfternoonIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ClockAfternoonPaths} {...props} />;
}

export const ClockAfternoon = ClockAfternoonIcon;
