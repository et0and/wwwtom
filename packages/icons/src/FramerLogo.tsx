 ...
 * Source: @phosphor-icons/core framer-logo. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FramerLogoPaths: IconPathData = {
  thin: [
    {
...
/** FramerLogo icon in six Phosphor weights. Defaults to regular weight. */
export function FramerLogoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FramerLogoPaths} {...props} />;
}

export const FramerLogo = FramerLogoIcon;
