 ...
 * Source: @phosphor-icons/core flip-vertical. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FlipVerticalPaths: IconPathData = {
  thin: [
    {
...
/** FlipVertical icon in six Phosphor weights. Defaults to regular weight. */
export function FlipVerticalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FlipVerticalPaths} {...props} />;
}
