 ...
 * Source: @phosphor-icons/core first-aid-kit. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FirstAidKitPaths: IconPathData = {
  thin: [
    {
...
/** FirstAidKit icon in six Phosphor weights. Defaults to regular weight. */
export function FirstAidKitIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FirstAidKitPaths} {...props} />;
}

export const FirstAidKit = FirstAidKitIcon;
