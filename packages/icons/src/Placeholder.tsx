 ...
 * Source: @phosphor-icons/core placeholder. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PlaceholderPaths: IconPathData = {
  thin: [
    {
...
/** Placeholder icon in six Phosphor weights. Defaults to regular weight. */
export function PlaceholderIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PlaceholderPaths} {...props} />;
}
