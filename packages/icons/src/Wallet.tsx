 ...
 * Source: @phosphor-icons/core wallet. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const WalletPaths: IconPathData = {
  thin: [
    {
...
/** Wallet icon in six Phosphor weights. Defaults to regular weight. */
export function WalletIcon(props: IconProps): JSX.Element {
  return <IconBase paths={WalletPaths} {...props} />;
}
