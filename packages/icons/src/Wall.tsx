 ...
 * Source: @phosphor-icons/core wall. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Wall icon in six Phosphor weights. Defaults to regular weight. */
export function WallIcon(props: IconProps): JSX.Element {
  return <IconBase paths={WallPaths} {...props} />;
}

export const Wall = WallIcon;
