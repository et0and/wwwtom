 ...
 * Source: @phosphor-icons/core chat-centered-text. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChatCenteredTextPaths: IconPathData = {
  thin: [
    {
...
/** ChatCenteredText icon in six Phosphor weights. Defaults to regular weight. */
export function ChatCenteredTextIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChatCenteredTextPaths} {...props} />;
}

export const ChatCenteredText = ChatCenteredTextIcon;
