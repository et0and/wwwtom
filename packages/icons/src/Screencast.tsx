 ...
 * Source: @phosphor-icons/core screencast. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ScreencastPaths: IconPathData = {
  thin: [
    {
...
/** Screencast icon in six Phosphor weights. Defaults to regular weight. */
export function ScreencastIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ScreencastPaths} {...props} />;
}

export const Screencast = ScreencastIcon;
