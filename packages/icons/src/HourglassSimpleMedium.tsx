 ...
 * Source: @phosphor-icons/core hourglass-simple-medium. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const HourglassSimpleMediumPaths: IconPathData = {
  thin: [
    {
...
/** HourglassSimpleMedium icon in six Phosphor weights. Defaults to regular weight. */
export function HourglassSimpleMediumIcon(props: IconProps): JSX.Element {
  return <IconBase paths={HourglassSimpleMediumPaths} {...props} />;
}

export const HourglassSimpleMedium = HourglassSimpleMediumIcon;
