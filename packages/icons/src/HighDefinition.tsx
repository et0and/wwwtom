 ...
 * Source: @phosphor-icons/core high-definition. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const HighDefinitionPaths: IconPathData = {
  thin: [
    {
...
/** HighDefinition icon in six Phosphor weights. Defaults to regular weight. */
export function HighDefinitionIcon(props: IconProps): JSX.Element {
  return <IconBase paths={HighDefinitionPaths} {...props} />;
}

export const HighDefinition = HighDefinitionIcon;
