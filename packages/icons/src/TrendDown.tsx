 ...
 * Source: @phosphor-icons/core trend-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TrendDownPaths: IconPathData = {
  thin: [
    {
...
/** TrendDown icon in six Phosphor weights. Defaults to regular weight. */
export function TrendDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TrendDownPaths} {...props} />;
}
