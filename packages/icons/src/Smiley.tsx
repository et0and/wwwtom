 ...
 * Source: @phosphor-icons/core smiley. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SmileyPaths: IconPathData = {
  thin: [
    {
...
/** Smiley icon in six Phosphor weights. Defaults to regular weight. */
export function SmileyIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SmileyPaths} {...props} />;
}
