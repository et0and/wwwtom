 ...
 * Source: @phosphor-icons/core three-d. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ThreeDPaths: IconPathData = {
  thin: [
    {
...
/** ThreeD icon in six Phosphor weights. Defaults to regular weight. */
export function ThreeDIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ThreeDPaths} {...props} />;
}

export const ThreeD = ThreeDIcon;
