 ...
 * Source: @phosphor-icons/core timer. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Timer icon in six Phosphor weights. Defaults to regular weight. */
export function TimerIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TimerPaths} {...props} />;
}
