 ...
 * Source: @phosphor-icons/core sliders-horizontal. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SlidersHorizontalPaths: IconPathData = {
  thin: [
    {
...
/** SlidersHorizontal icon in six Phosphor weights. Defaults to regular weight. */
export function SlidersHorizontalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SlidersHorizontalPaths} {...props} />;
}
