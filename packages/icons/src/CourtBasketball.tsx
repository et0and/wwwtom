 ...
 * Source: @phosphor-icons/core court-basketball. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CourtBasketballPaths: IconPathData = {
  thin: [
    {
...
/** CourtBasketball icon in six Phosphor weights. Defaults to regular weight. */
export function CourtBasketballIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CourtBasketballPaths} {...props} />;
}

export const CourtBasketball = CourtBasketballIcon;
