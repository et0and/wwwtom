 ...
 * Source: @phosphor-icons/core perspective. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const PerspectivePaths: IconPathData = {
  thin: [
    {
...
/** Perspective icon in six Phosphor weights. Defaults to regular weight. */
export function PerspectiveIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PerspectivePaths} {...props} />;
}

export const Perspective = PerspectiveIcon;
