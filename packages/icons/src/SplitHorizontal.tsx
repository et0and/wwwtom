 ...
 * Source: @phosphor-icons/core split-horizontal. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SplitHorizontalPaths: IconPathData = {
  thin: [
    {
...
/** SplitHorizontal icon in six Phosphor weights. Defaults to regular weight. */
export function SplitHorizontalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SplitHorizontalPaths} {...props} />;
}

export const SplitHorizontal = SplitHorizontalIcon;
