 ...
 * Source: @phosphor-icons/core asterisk-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const AsteriskSimplePaths: IconPathData = {
  thin: [
    {
...
/** AsteriskSimple icon in six Phosphor weights. Defaults to regular weight. */
export function AsteriskSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={AsteriskSimplePaths} {...props} />;
}

export const AsteriskSimple = AsteriskSimpleIcon;
