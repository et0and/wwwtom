 ...
 * Source: @phosphor-icons/core linkedin-logo. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const LinkedinLogoPaths: IconPathData = {
  thin: [
    {
...
/** LinkedinLogo icon in six Phosphor weights. Defaults to regular weight. */
export function LinkedinLogoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LinkedinLogoPaths} {...props} />;
}
