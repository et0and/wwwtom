 ...
 * Source: @phosphor-icons/core frame-corners. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FrameCornersPaths: IconPathData = {
  thin: [
    {
...
/** FrameCorners icon in six Phosphor weights. Defaults to regular weight. */
export function FrameCornersIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FrameCornersPaths} {...props} />;
}

export const FrameCorners = FrameCornersIcon;
