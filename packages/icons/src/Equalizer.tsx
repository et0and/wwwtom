 ...
 * Source: @phosphor-icons/core equalizer. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const EqualizerPaths: IconPathData = {
  thin: [
    {
...
/** Equalizer icon in six Phosphor weights. Defaults to regular weight. */
export function EqualizerIcon(props: IconProps): JSX.Element {
  return <IconBase paths={EqualizerPaths} {...props} />;
}
