 ...
 * Source: @phosphor-icons/core belt. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Belt icon in six Phosphor weights. Defaults to regular weight. */
export function BeltIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BeltPaths} {...props} />;
}

export const Belt = BeltIcon;
