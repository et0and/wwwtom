 ...
 * Source: @phosphor-icons/core funnel-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FunnelSimplePaths: IconPathData = {
  thin: [
    {
...
/** FunnelSimple icon in six Phosphor weights. Defaults to regular weight. */
export function FunnelSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FunnelSimplePaths} {...props} />;
}
