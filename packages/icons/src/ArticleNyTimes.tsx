 ...
 * Source: @phosphor-icons/core article-ny-times. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArticleNyTimesPaths: IconPathData = {
  thin: [
    {
...
/** ArticleNyTimes icon in six Phosphor weights. Defaults to regular weight. */
export function ArticleNyTimesIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArticleNyTimesPaths} {...props} />;
}

export const ArticleNyTimes = ArticleNyTimesIcon;
