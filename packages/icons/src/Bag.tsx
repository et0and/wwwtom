 ...
 * Source: @phosphor-icons/core bag. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Bag icon in six Phosphor weights. Defaults to regular weight. */
export function BagIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BagPaths} {...props} />;
}
