 ...
 * Source: @phosphor-icons/core browsers. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BrowsersPaths: IconPathData = {
  thin: [
    {
...
/** Browsers icon in six Phosphor weights. Defaults to regular weight. */
export function BrowsersIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BrowsersPaths} {...props} />;
}

export const Browsers = BrowsersIcon;
