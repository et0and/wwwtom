 ...
 * Source: @phosphor-icons/core goodreads-logo. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const GoodreadsLogoPaths: IconPathData = {
  thin: [
    {
...
/** GoodreadsLogo icon in six Phosphor weights. Defaults to regular weight. */
export function GoodreadsLogoIcon(props: IconProps): JSX.Element {
  return <IconBase paths={GoodreadsLogoPaths} {...props} />;
}

export const GoodreadsLogo = GoodreadsLogoIcon;
