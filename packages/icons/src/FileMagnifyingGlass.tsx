 ...
 * Source: @phosphor-icons/core file-magnifying-glass. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FileMagnifyingGlassPaths: IconPathData = {
  thin: [
    {
...
/** FileMagnifyingGlass icon in six Phosphor weights. Defaults to regular weight. */
export function FileMagnifyingGlassIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FileMagnifyingGlassPaths} {...props} />;
}

export const FileMagnifyingGlass = FileMagnifyingGlassIcon;
