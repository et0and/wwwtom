 ...
 * Source: @phosphor-icons/core copyright. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CopyrightPaths: IconPathData = {
  thin: [
    {
...
/** Copyright icon in six Phosphor weights. Defaults to regular weight. */
export function CopyrightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CopyrightPaths} {...props} />;
}
