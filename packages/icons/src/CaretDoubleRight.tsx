 ...
 * Source: @phosphor-icons/core caret-double-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CaretDoubleRightPaths: IconPathData = {
  thin: [
    {
...
/** CaretDoubleRight icon in six Phosphor weights. Defaults to regular weight. */
export function CaretDoubleRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CaretDoubleRightPaths} {...props} />;
}

export const CaretDoubleRight = CaretDoubleRightIcon;
