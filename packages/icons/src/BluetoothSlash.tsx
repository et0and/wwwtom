 ...
 * Source: @phosphor-icons/core bluetooth-slash. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BluetoothSlashPaths: IconPathData = {
  thin: [
    {
...
/** BluetoothSlash icon in six Phosphor weights. Defaults to regular weight. */
export function BluetoothSlashIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BluetoothSlashPaths} {...props} />;
}

export const BluetoothSlash = BluetoothSlashIcon;
