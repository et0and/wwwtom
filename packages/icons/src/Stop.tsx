 ...
 * Source: @phosphor-icons/core stop. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Stop icon in six Phosphor weights. Defaults to regular weight. */
export function StopIcon(props: IconProps): JSX.Element {
  return <IconBase paths={StopPaths} {...props} />;
}
