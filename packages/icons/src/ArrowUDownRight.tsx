 ...
 * Source: @phosphor-icons/core arrow-u-down-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowUDownRightPaths: IconPathData = {
  thin: [
    {
...
/** ArrowUDownRight icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowUDownRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowUDownRightPaths} {...props} />;
}

export const ArrowUDownRight = ArrowUDownRightIcon;
