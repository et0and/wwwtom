 ...
 * Source: @phosphor-icons/core webcam. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const WebcamPaths: IconPathData = {
  thin: [
    {
...
/** Webcam icon in six Phosphor weights. Defaults to regular weight. */
export function WebcamIcon(props: IconProps): JSX.Element {
  return <IconBase paths={WebcamPaths} {...props} />;
}
