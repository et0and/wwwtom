 ...
 * Source: @phosphor-icons/core sort-descending. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SortDescendingPaths: IconPathData = {
  thin: [
    {
...
/** SortDescending icon in six Phosphor weights. Defaults to regular weight. */
export function SortDescendingIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SortDescendingPaths} {...props} />;
}
