 ...
 * Source: @phosphor-icons/core cell-signal-low. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CellSignalLowPaths: IconPathData = {
  thin: [
    {
...
/** CellSignalLow icon in six Phosphor weights. Defaults to regular weight. */
export function CellSignalLowIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CellSignalLowPaths} {...props} />;
}

export const CellSignalLow = CellSignalLowIcon;
