 ...
 * Source: @phosphor-icons/core dots-six. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DotsSixPaths: IconPathData = {
  thin: [
    {
...
/** DotsSix icon in six Phosphor weights. Defaults to regular weight. */
export function DotsSixIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DotsSixPaths} {...props} />;
}

export const DotsSix = DotsSixIcon;
