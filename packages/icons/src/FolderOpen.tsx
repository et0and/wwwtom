 ...
 * Source: @phosphor-icons/core folder-open. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FolderOpenPaths: IconPathData = {
  thin: [
    {
...
/** FolderOpen icon in six Phosphor weights. Defaults to regular weight. */
export function FolderOpenIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FolderOpenPaths} {...props} />;
}
