 ...
 * Source: @phosphor-icons/core pulse. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Pulse icon in six Phosphor weights. Defaults to regular weight. */
export function PulseIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PulsePaths} {...props} />;
}
