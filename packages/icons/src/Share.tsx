 ...
 * Source: @phosphor-icons/core share. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Share icon in six Phosphor weights. Defaults to regular weight. */
export function ShareIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SharePaths} {...props} />;
}
