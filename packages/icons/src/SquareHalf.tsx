 ...
 * Source: @phosphor-icons/core square-half. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SquareHalfPaths: IconPathData = {
  thin: [
    {
...
/** SquareHalf icon in six Phosphor weights. Defaults to regular weight. */
export function SquareHalfIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SquareHalfPaths} {...props} />;
}

export const SquareHalf = SquareHalfIcon;
