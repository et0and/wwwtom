 ...
 * Source: @phosphor-icons/core lock-laminated. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const LockLaminatedPaths: IconPathData = {
  thin: [
    {
...
/** LockLaminated icon in six Phosphor weights. Defaults to regular weight. */
export function LockLaminatedIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LockLaminatedPaths} {...props} />;
}

export const LockLaminated = LockLaminatedIcon;
