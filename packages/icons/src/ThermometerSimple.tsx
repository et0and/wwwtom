 ...
 * Source: @phosphor-icons/core thermometer-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ThermometerSimplePaths: IconPathData = {
  thin: [
    {
...
/** ThermometerSimple icon in six Phosphor weights. Defaults to regular weight. */
export function ThermometerSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ThermometerSimplePaths} {...props} />;
}

export const ThermometerSimple = ThermometerSimpleIcon;
