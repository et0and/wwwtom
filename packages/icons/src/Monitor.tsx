 ...
 * Source: @phosphor-icons/core monitor. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const MonitorPaths: IconPathData = {
  thin: [
    {
...
/** Monitor icon in six Phosphor weights. Defaults to regular weight. */
export function MonitorIcon(props: IconProps): JSX.Element {
  return <IconBase paths={MonitorPaths} {...props} />;
}
