 ...
 * Source: @phosphor-icons/core columns-plus-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ColumnsPlusRightPaths: IconPathData = {
  thin: [
    {
...
/** ColumnsPlusRight icon in six Phosphor weights. Defaults to regular weight. */
export function ColumnsPlusRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ColumnsPlusRightPaths} {...props} />;
}

export const ColumnsPlusRight = ColumnsPlusRightIcon;
