 ...
 * Source: @phosphor-icons/core parallelogram. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ParallelogramPaths: IconPathData = {
  thin: [
    {
...
/** Parallelogram icon in six Phosphor weights. Defaults to regular weight. */
export function ParallelogramIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ParallelogramPaths} {...props} />;
}

export const Parallelogram = ParallelogramIcon;
