 ...
 * Source: @phosphor-icons/core caret-circle-double-down. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CaretCircleDoubleDownPaths: IconPathData = {
  thin: [
    {
...
/** CaretCircleDoubleDown icon in six Phosphor weights. Defaults to regular weight. */
export function CaretCircleDoubleDownIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CaretCircleDoubleDownPaths} {...props} />;
}

export const CaretCircleDoubleDown = CaretCircleDoubleDownIcon;
