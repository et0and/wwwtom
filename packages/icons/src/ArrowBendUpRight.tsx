 ...
 * Source: @phosphor-icons/core arrow-bend-up-right. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowBendUpRightPaths: IconPathData = {
  thin: [
    {
...
/** ArrowBendUpRight icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowBendUpRightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowBendUpRightPaths} {...props} />;
}

export const ArrowBendUpRight = ArrowBendUpRightIcon;
