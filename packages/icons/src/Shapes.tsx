 ...
 * Source: @phosphor-icons/core shapes. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ShapesPaths: IconPathData = {
  thin: [
    {
...
/** Shapes icon in six Phosphor weights. Defaults to regular weight. */
export function ShapesIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ShapesPaths} {...props} />;
}
