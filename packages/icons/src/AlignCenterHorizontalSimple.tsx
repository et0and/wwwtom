 ...
 * Source: @phosphor-icons/core align-center-horizontal-simple. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const AlignCenterHorizontalSimplePaths: IconPathData = {
  thin: [
    {
...
/** AlignCenterHorizontalSimple icon in six Phosphor weights. Defaults to regular weight. */
export function AlignCenterHorizontalSimpleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={AlignCenterHorizontalSimplePaths} {...props} />;
}

export const AlignCenterHorizontalSimple = AlignCenterHorizontalSimpleIcon;
