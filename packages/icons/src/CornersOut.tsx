 ...
 * Source: @phosphor-icons/core corners-out. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CornersOutPaths: IconPathData = {
  thin: [
    {
...
/** CornersOut icon in six Phosphor weights. Defaults to regular weight. */
export function CornersOutIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CornersOutPaths} {...props} />;
}

export const CornersOut = CornersOutIcon;
