 ...
 * Source: @phosphor-icons/core funnel-simple-x. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FunnelSimpleXPaths: IconPathData = {
  thin: [
    {
...
/** FunnelSimpleX icon in six Phosphor weights. Defaults to regular weight. */
export function FunnelSimpleXIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FunnelSimpleXPaths} {...props} />;
}

export const FunnelSimpleX = FunnelSimpleXIcon;
