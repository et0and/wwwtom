 ...
 * Source: @phosphor-icons/core arrow-fat-line-left. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowFatLineLeftPaths: IconPathData = {
  thin: [
    {
...
/** ArrowFatLineLeft icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowFatLineLeftIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowFatLineLeftPaths} {...props} />;
}

export const ArrowFatLineLeft = ArrowFatLineLeftIcon;
