 ...
 * Source: @phosphor-icons/core escalator-up. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const EscalatorUpPaths: IconPathData = {
  thin: [
    {
...
/** EscalatorUp icon in six Phosphor weights. Defaults to regular weight. */
export function EscalatorUpIcon(props: IconProps): JSX.Element {
  return <IconBase paths={EscalatorUpPaths} {...props} />;
}

export const EscalatorUp = EscalatorUpIcon;
