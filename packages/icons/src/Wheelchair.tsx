 ...
 * Source: @phosphor-icons/core wheelchair. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const WheelchairPaths: IconPathData = {
  thin: [
    {
...
/** Wheelchair icon in six Phosphor weights. Defaults to regular weight. */
export function WheelchairIcon(props: IconProps): JSX.Element {
  return <IconBase paths={WheelchairPaths} {...props} />;
}

export const Wheelchair = WheelchairIcon;
