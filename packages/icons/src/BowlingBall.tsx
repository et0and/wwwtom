 ...
 * Source: @phosphor-icons/core bowling-ball. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BowlingBallPaths: IconPathData = {
  thin: [
    {
...
/** BowlingBall icon in six Phosphor weights. Defaults to regular weight. */
export function BowlingBallIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BowlingBallPaths} {...props} />;
}

export const BowlingBall = BowlingBallIcon;
