 ...
 * Source: @phosphor-icons/core invoice. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const InvoicePaths: IconPathData = {
  thin: [
    {
...
/** Invoice icon in six Phosphor weights. Defaults to regular weight. */
export function InvoiceIcon(props: IconProps): JSX.Element {
  return <IconBase paths={InvoicePaths} {...props} />;
}
