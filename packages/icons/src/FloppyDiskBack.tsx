 ...
 * Source: @phosphor-icons/core floppy-disk-back. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FloppyDiskBackPaths: IconPathData = {
  thin: [
    {
...
/** FloppyDiskBack icon in six Phosphor weights. Defaults to regular weight. */
export function FloppyDiskBackIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FloppyDiskBackPaths} {...props} />;
}

export const FloppyDiskBack = FloppyDiskBackIcon;
