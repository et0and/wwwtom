 ...
 * Source: @phosphor-icons/core arrow-elbow-right-up. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ArrowElbowRightUpPaths: IconPathData = {
  thin: [
    {
...
/** ArrowElbowRightUp icon in six Phosphor weights. Defaults to regular weight. */
export function ArrowElbowRightUpIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ArrowElbowRightUpPaths} {...props} />;
}

export const ArrowElbowRightUp = ArrowElbowRightUpIcon;
