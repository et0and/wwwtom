 ...
 * Source: @phosphor-icons/core globe-stand. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const GlobeStandPaths: IconPathData = {
  thin: [
    {
...
/** GlobeStand icon in six Phosphor weights. Defaults to regular weight. */
export function GlobeStandIcon(props: IconProps): JSX.Element {
  return <IconBase paths={GlobeStandPaths} {...props} />;
}

export const GlobeStand = GlobeStandIcon;
