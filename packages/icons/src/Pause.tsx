 ...
 * Source: @phosphor-icons/core pause. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Pause icon in six Phosphor weights. Defaults to regular weight. */
export function PauseIcon(props: IconProps): JSX.Element {
  return <IconBase paths={PausePaths} {...props} />;
}
