 ...
 * Source: @phosphor-icons/core textbox. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TextboxPaths: IconPathData = {
  thin: [
    {
...
/** Textbox icon in six Phosphor weights. Defaults to regular weight. */
export function TextboxIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TextboxPaths} {...props} />;
}
