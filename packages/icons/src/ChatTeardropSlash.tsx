 ...
 * Source: @phosphor-icons/core chat-teardrop-slash. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChatTeardropSlashPaths: IconPathData = {
  thin: [
    {
...
/** ChatTeardropSlash icon in six Phosphor weights. Defaults to regular weight. */
export function ChatTeardropSlashIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChatTeardropSlashPaths} {...props} />;
}

export const ChatTeardropSlash = ChatTeardropSlashIcon;
