 ...
 * Source: @phosphor-icons/core speaker-simple-low. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SpeakerSimpleLowPaths: IconPathData = {
  thin: [
    {
...
/** SpeakerSimpleLow icon in six Phosphor weights. Defaults to regular weight. */
export function SpeakerSimpleLowIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SpeakerSimpleLowPaths} {...props} />;
}

export const SpeakerSimpleLow = SpeakerSimpleLowIcon;
