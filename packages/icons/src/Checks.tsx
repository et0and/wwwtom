 ...
 * Source: @phosphor-icons/core checks. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ChecksPaths: IconPathData = {
  thin: [
    {
...
/** Checks icon in six Phosphor weights. Defaults to regular weight. */
export function ChecksIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ChecksPaths} {...props} />;
}

export const Checks = ChecksIcon;
