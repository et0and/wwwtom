 ...
 * Source: @phosphor-icons/core joystick. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const JoystickPaths: IconPathData = {
  thin: [
    {
...
/** Joystick icon in six Phosphor weights. Defaults to regular weight. */
export function JoystickIcon(props: IconProps): JSX.Element {
  return <IconBase paths={JoystickPaths} {...props} />;
}
