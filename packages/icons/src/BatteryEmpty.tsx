 ...
 * Source: @phosphor-icons/core battery-empty. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BatteryEmptyPaths: IconPathData = {
  thin: [
    {
...
/** BatteryEmpty icon in six Phosphor weights. Defaults to regular weight. */
export function BatteryEmptyIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BatteryEmptyPaths} {...props} />;
}

export const BatteryEmpty = BatteryEmptyIcon;
