 ...
 * Source: @phosphor-icons/core gender-nonbinary. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const GenderNonbinaryPaths: IconPathData = {
  thin: [
    {
...
/** GenderNonbinary icon in six Phosphor weights. Defaults to regular weight. */
export function GenderNonbinaryIcon(props: IconProps): JSX.Element {
  return <IconBase paths={GenderNonbinaryPaths} {...props} />;
}

export const GenderNonbinary = GenderNonbinaryIcon;
