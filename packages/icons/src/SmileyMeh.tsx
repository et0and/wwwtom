 ...
 * Source: @phosphor-icons/core smiley-meh. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const SmileyMehPaths: IconPathData = {
  thin: [
    {
...
/** SmileyMeh icon in six Phosphor weights. Defaults to regular weight. */
export function SmileyMehIcon(props: IconProps): JSX.Element {
  return <IconBase paths={SmileyMehPaths} {...props} />;
}

export const SmileyMeh = SmileyMehIcon;
