 ...
 * Source: @phosphor-icons/core layout. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const LayoutPaths: IconPathData = {
  thin: [
    {
...
/** Layout icon in six Phosphor weights. Defaults to regular weight. */
export function LayoutIcon(props: IconProps): JSX.Element {
  return <IconBase paths={LayoutPaths} {...props} />;
}
