 ...
 * Source: @phosphor-icons/core dots-six-vertical. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DotsSixVerticalPaths: IconPathData = {
  thin: [
    {
...
/** DotsSixVertical icon in six Phosphor weights. Defaults to regular weight. */
export function DotsSixVerticalIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DotsSixVerticalPaths} {...props} />;
}

export const DotsSixVertical = DotsSixVerticalIcon;
