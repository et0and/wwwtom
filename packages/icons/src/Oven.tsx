 ...
 * Source: @phosphor-icons/core oven. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Oven icon in six Phosphor weights. Defaults to regular weight. */
export function OvenIcon(props: IconProps): JSX.Element {
  return <IconBase paths={OvenPaths} {...props} />;
}

export const Oven = OvenIcon;
