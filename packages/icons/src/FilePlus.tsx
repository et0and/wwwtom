 ...
 * Source: @phosphor-icons/core file-plus. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FilePlusPaths: IconPathData = {
  thin: [
    {
...
/** FilePlus icon in six Phosphor weights. Defaults to regular weight. */
export function FilePlusIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FilePlusPaths} {...props} />;
}
