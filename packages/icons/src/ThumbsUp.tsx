 ...
 * Source: @phosphor-icons/core thumbs-up. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ThumbsUpPaths: IconPathData = {
  thin: [
    {
...
/** ThumbsUp icon in six Phosphor weights. Defaults to regular weight. */
export function ThumbsUpIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ThumbsUpPaths} {...props} />;
}
