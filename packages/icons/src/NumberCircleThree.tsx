 ...
 * Source: @phosphor-icons/core number-circle-three. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NumberCircleThreePaths: IconPathData = {
  thin: [
    {
...
/** NumberCircleThree icon in six Phosphor weights. Defaults to regular weight. */
export function NumberCircleThreeIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NumberCircleThreePaths} {...props} />;
}

export const NumberCircleThree = NumberCircleThreeIcon;
