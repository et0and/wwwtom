 ...
 * Source: @phosphor-icons/core number-nine. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const NumberNinePaths: IconPathData = {
  thin: [
    {
...
/** NumberNine icon in six Phosphor weights. Defaults to regular weight. */
export function NumberNineIcon(props: IconProps): JSX.Element {
  return <IconBase paths={NumberNinePaths} {...props} />;
}

export const NumberNine = NumberNineIcon;
