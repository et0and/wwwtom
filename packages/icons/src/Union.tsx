 ...
 * Source: @phosphor-icons/core union. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** Union icon in six Phosphor weights. Defaults to regular weight. */
export function UnionIcon(props: IconProps): JSX.Element {
  return <IconBase paths={UnionPaths} {...props} />;
}

export const Union = UnionIcon;
