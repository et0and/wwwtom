 ...
 * Source: @phosphor-icons/core text-h. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
/** TextH icon in six Phosphor weights. Defaults to regular weight. */
export function TextHIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TextHPaths} {...props} />;
}

export const TextH = TextHIcon;
