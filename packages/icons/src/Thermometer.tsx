 ...
 * Source: @phosphor-icons/core thermometer. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const ThermometerPaths: IconPathData = {
  thin: [
    {
...
/** Thermometer icon in six Phosphor weights. Defaults to regular weight. */
export function ThermometerIcon(props: IconProps): JSX.Element {
  return <IconBase paths={ThermometerPaths} {...props} />;
}
