 ...
 * Source: @phosphor-icons/core triangle. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const TrianglePaths: IconPathData = {
  thin: [
    {
...
/** Triangle icon in six Phosphor weights. Defaults to regular weight. */
export function TriangleIcon(props: IconProps): JSX.Element {
  return <IconBase paths={TrianglePaths} {...props} />;
}
