 ...
 * Source: @phosphor-icons/core dice-four. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const DiceFourPaths: IconPathData = {
  thin: [
    {
...
/** DiceFour icon in six Phosphor weights. Defaults to regular weight. */
export function DiceFourIcon(props: IconProps): JSX.Element {
  return <IconBase paths={DiceFourPaths} {...props} />;
}

export const DiceFour = DiceFourIcon;
