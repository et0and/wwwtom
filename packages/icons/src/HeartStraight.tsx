 ...
 * Source: @phosphor-icons/core heart-straight. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const HeartStraightPaths: IconPathData = {
  thin: [
    {
...
/** HeartStraight icon in six Phosphor weights. Defaults to regular weight. */
export function HeartStraightIcon(props: IconProps): JSX.Element {
  return <IconBase paths={HeartStraightPaths} {...props} />;
}

export const HeartStraight = HeartStraightIcon;
