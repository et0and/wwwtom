 ...
 * Source: @phosphor-icons/core currency-btc. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const CurrencyBtcPaths: IconPathData = {
  thin: [
    {
...
/** CurrencyBtc icon in six Phosphor weights. Defaults to regular weight. */
export function CurrencyBtcIcon(props: IconProps): JSX.Element {
  return <IconBase paths={CurrencyBtcPaths} {...props} />;
}

export const CurrencyBtc = CurrencyBtcIcon;
