 ...
 * Source: @phosphor-icons/core hard-drives. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const HardDrivesPaths: IconPathData = {
  thin: [
    {
...
/** HardDrives icon in six Phosphor weights. Defaults to regular weight. */
export function HardDrivesIcon(props: IconProps): JSX.Element {
  return <IconBase paths={HardDrivesPaths} {...props} />;
}

export const HardDrives = HardDrivesIcon;
