 ...
 * Source: @phosphor-icons/core folder-simple-minus. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const FolderSimpleMinusPaths: IconPathData = {
  thin: [
    {
...
/** FolderSimpleMinus icon in six Phosphor weights. Defaults to regular weight. */
export function FolderSimpleMinusIcon(props: IconProps): JSX.Element {
  return <IconBase paths={FolderSimpleMinusPaths} {...props} />;
}

export const FolderSimpleMinus = FolderSimpleMinusIcon;
