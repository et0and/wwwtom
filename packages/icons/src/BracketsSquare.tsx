 ...
 * Source: @phosphor-icons/core brackets-square. Regenerate with `pnpm --filter @tom/icons generate`.
 */
...
const BracketsSquarePaths: IconPathData = {
  thin: [
    {
...
/** BracketsSquare icon in six Phosphor weights. Defaults to regular weight. */
export function BracketsSquareIcon(props: IconProps): JSX.Element {
  return <IconBase paths={BracketsSquarePaths} {...props} />;
}

export const BracketsSquare = BracketsSquareIcon;
