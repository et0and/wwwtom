...
const uploadArtifactPin = "043fb46d1a93c77aae656e7c1c64a875d1fc6a0a"; // v7.0.1
...
export const actionPins = {
  ...
  uploadArtifact: `actions/upload-artifact@${uploadArtifactPin}`,
  // The opencode action publishes only moving tags; there is no SHA to pin.
  opencode: "anomalyco/opencode/github@latest",
} as const;
