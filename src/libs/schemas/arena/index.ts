...
export const ArenaChannelSchema = Schema.Struct({
	...
	metadata: Schema.NullOr(
		Schema.Struct({ description: Schema.NullOr(Schema.String) }),
	),
...
export const ArenaBaseBlockSchema = Schema.Struct({
	...
	visibility: Schema.optional(
		Schema.Union(Schema.Literal("private"), Schema.Literal("public")),
	),
	...
	connections: Schema.optional(
		Schema.Array(Schema.suspend(() => ArenaChannelSchema)),
	),
});
...
export const ArenaChannelContentsSchema: Schema.Schema<any, any, never> =
	Schema.suspend(() =>
	...
	Schema.extend(
		Schema.Struct({
			channels: Schema.Array(
				Schema.suspend(() => GetChannelsApiResponseSchema),
			),
		}),
	),
);
...
export const GetUserFollowingApiResponseSchema =
		...
		Schema.Struct({
			contents: Schema.NullOr(
				Schema.Array(
					Schema.Union(
						ArenaBlockSchema,
						ArenaChannelWithDetailsSchema.pipe(
							Schema.omit("contents"),
...
export const ChannelConnectChannelApiResponseSchema =
	ArenaChannelWithDetailsSchema.pipe(Schema.extend(ConnectionDataSchema));
...
export type ArenaUserWithDetails = Schema.Schema.Type<
	typeof ArenaUserWithDetailsSchema
>;
...
export type ArenaAttachmentBlock = Schema.Schema.Type<
	typeof ArenaAttachmentBlockSchema
>;
export type ArenaBlock = Schema.Schema.Type<typeof ArenaBlockSchema>;
export type ArenaCommentEntity = Schema.Schema.Type<
	typeof ArenaCommentEntitySchema
>;
export type ArenaBlockComment = Schema.Schema.Type<
	typeof ArenaBlockCommentSchema
>;
export type ConnectionData = Schema.Schema.Type<typeof ConnectionDataSchema>;
export type ArenaChannelContents = Schema.Schema.Type<
	typeof ArenaChannelContentsSchema
>;
export type ArenaChannelWithDetails = Schema.Schema.Type<
	typeof ArenaChannelWithDetailsSchema
>;
export type MeApiResponse = Schema.Schema.Type<typeof MeApiResponseSchema>;
export type GetUserApiResponse = Schema.Schema.Type<
	typeof GetUserApiResponseSchema
>;
...
>;
export type GetBlockApiResponse = Schema.Schema.Type<
	typeof GetBlockApiResponseSchema
>;
export type CreateBlockApiResponse = Schema.Schema.Type<
	typeof CreateBlockApiResponseSchema
>;
export type GetBlockChannelsApiResponse = Schema.Schema.Type<
	typeof GetBlockChannelsApiResponseSchema
>;
export type GetGroupApiResponse = Schema.Schema.Type<
	typeof GetGroupApiResponseSchema
>;
export type CreateChannelApiResponse = Schema.Schema.Type<
	typeof CreateChannelApiResponseSchema
>;
...
>;
export type GetChannelsApiResponse = Schema.Schema.Type<
	typeof GetChannelsApiResponseSchema
>;
export type GetConnectionsApiResponse = Schema.Schema.Type<
	typeof GetConnectionsApiResponseSchema
>;
export type PaginationAttributes = Schema.Schema.Type<
	typeof PaginationAttributesSchema
>;
export type SearchApiResponse = Schema.Schema.Type<
	typeof SearchApiResponseSchema
>;
