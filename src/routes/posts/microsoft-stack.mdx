...
<PageLayout title="Using a fully Office 365 stack - my thoughts" description="Having avoided Microsoft products for the past few years, going back to using them for work has been an interesting experience">
