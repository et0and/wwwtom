...
<PageLayout title="Status update" description="Yesterday I had the opportunity to speak with Piper Haywood, a designer and front-end developer based in the UK">
