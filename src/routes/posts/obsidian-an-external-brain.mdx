...
![Obsidian on a glossary of design terms page](https://cdn.tom.so/obsidian1.png)
...
![Obsidian in graph mode, showing connections like a spider web](https://cdn.tom.so/obsidian2.png)
...
![Obsidian files all stored locally as Markdown documents](https://cdn.tom.so/obsidian3.png)
