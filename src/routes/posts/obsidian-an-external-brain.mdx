...
<PageLayout title="Obsidian - an external rhizomatic brain" description="Earlier this week I started using Obsidian, an offline tool similar to Roam that links and networks ideas">
