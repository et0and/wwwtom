...
[TXTRNZ](https://txtrnz.tom.so) was a text-only site which served news items from the [RNZ](https://rnz.co.nz) website.

![Desktop view of TXTRNZ.](https://cdn.tom.so/txtrnz.webp)
...
Please note that this project is now superseded by [txtne.ws](https://news.tom.so), which serves news items from RNZ, NZ Herald and Stuff in text format using Cheerio.
