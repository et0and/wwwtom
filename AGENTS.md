...
- `tools/bundle-checker` — OCaml/Dune client bundle budget checker, built and run through a pinned Docker image.
...
- `pnpm check:bundles` — build client apps and enforce bundle budgets in the pinned OCaml container
