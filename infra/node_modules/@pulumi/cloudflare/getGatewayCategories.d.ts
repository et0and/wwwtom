 ...
 * ```
 */
export declare function getGatewayCategoriesOutput(args: GetGatewayCategoriesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGatewayCategoriesResult>;
/**
 * A collection of arguments for invoking getGatewayCategories.
 */
