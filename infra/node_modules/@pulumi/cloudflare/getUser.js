...
function getUser(opts) {
    ...
    return pulumi.runtime.invoke("cloudflare:index/getUser:getUser", {}, opts);
}
 ...
 * ```
 */
function getUserOutput(opts) {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("cloudflare:index/getUser:getUser", {}, opts);
}
