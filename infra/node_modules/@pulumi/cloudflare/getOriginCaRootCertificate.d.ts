 ...
 * ```
 */
export declare function getOriginCaRootCertificate(args: GetOriginCaRootCertificateArgs, opts?: pulumi.InvokeOptions): Promise<GetOriginCaRootCertificateResult>;
/**
 ...
 * ```
 */
export declare function getOriginCaRootCertificateOutput(args: GetOriginCaRootCertificateOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOriginCaRootCertificateResult>;
/**
 * A collection of arguments for invoking getOriginCaRootCertificate.
 */
