 ...
 * ```
 */
export declare function getDevicePostureRulesOutput(args: GetDevicePostureRulesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDevicePostureRulesResult>;
/**
 * A collection of arguments for invoking getDevicePostureRules.
 */
