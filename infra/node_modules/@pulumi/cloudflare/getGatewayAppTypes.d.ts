 ...
 * ```
 */
export declare function getGatewayAppTypesOutput(args: GetGatewayAppTypesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGatewayAppTypesResult>;
/**
 * A collection of arguments for invoking getGatewayAppTypes.
 */
